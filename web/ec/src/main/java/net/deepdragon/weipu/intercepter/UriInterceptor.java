...
public class UriInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		Member member = (Member) request.getSession().getAttribute(Global.CURRENT_MERMBER);
		boolean flag = true;
...
//		String[] urlMatchingArray = new String[] { "/static/", "/admin/", "/merchant/", "/member/", "/order/", "/payment/" };
