...
import net.deepdragon.weipu.timer.Timer;
...
public class StaticizeHtmlUtil {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(StaticizeHtmlUtil.class);
    ...
    public static boolean getStaticizeHtml(){
        try {
            ...
            param.put(Constant.PLATFORM_KEY,  Constant.PLATFORM_B2C );
