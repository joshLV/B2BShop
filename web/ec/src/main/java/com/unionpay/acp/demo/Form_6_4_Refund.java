...
public class Form_6_4_Refund extends DemoBase {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// 前台通知地址 ，控件接入方式无作用
		data.put("frontUrl", "http://117.34.72.80:8582/mcm/orderPayLog/unionpayFront.sh");
		// 后台通知地址
		data.put("backUrl", "http://117.34.72.80:8582/mcm/orderPayLog/unionpayBack.sh");
		// 接入类型，商户接入填0 0- 商户 ， 1： 收单， 2：平台商户
		data.put("accessType", "0");
		// 商户号码，请改成自己的商户号
		data.put("merId", "777290058118694");
		//原消费的queryId，可以从查询接口或者通知接口中获取
		data.put("origQryId", "201511271152533709288");
		// 商户订单号，8-40位数字字母，重新产生，不同于原消费
		data.put("orderId", "5112742768615200");
		// 订单发送时间，取系统时间
		data.put("txnTime", "20151130091942");
		// 交易金额
		data.put("txnAmt", "2290");
		// 交易币种
