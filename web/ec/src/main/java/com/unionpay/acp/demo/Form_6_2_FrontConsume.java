...
public class Form_6_2_FrontConsume extends DemoBase {
	...
	public static void main(String[] args) {
		...
		// 商户号码，请改成自己的商户号
		data.put("merId", "777290058118694");
		// 商户订单号，8-40位数字字母
...
//		Map<String, String> submitFromData = signData(data);
		...
		requestOrder.setFrontUrl("http://localhost:8080/ACPTest/acp_front_url.do");
		requestOrder.setBackUrl("http://222.222.222.222:8080/ACPTest/acp_back_url.do");
		requestOrder.setOrderId(DateUtils.dateToString(new Date(), "yyyyMMddHHmmss"));
		requestOrder.setTxnTime(DateUtils.dateToString(new Date(), "yyyyMMddHHmmss"));


		Map<String, String> submitFromData = UnionpayUtil.signData(requestOrder);
		// 交易请求url 从配置文件读取
