    ...
    public static String sign(String content, String privateKey) {
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(Base64
					.decode(privateKey));
			KeyFactory keyf = KeyFactory.getInstance(AlipayConfig.sign_type_RSA);
...
/**
	 ...
	 * 
	 */
	public static String getOrderInfo(String subject, String body, String orderSn, String price, String notify_url, String return_url) {
		...
		orderInfo.append('"');
		orderInfo.append(AlipayConfig.seller_id);
		orderInfo.append('"');

		// 商户网站唯一订单号
		orderInfo.append("&out_trade_no=");
		orderInfo.append('"');
		orderInfo.append(orderSn);
		orderInfo.append('"');
		...
		orderInfo.append('"');
		orderInfo.append(AlipayConfig.payment_type);
		orderInfo.append('"');
