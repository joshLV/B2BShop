...
<#include "app/gdnz/head.ftl">
    ...
    <style>
       ...
       .guess-you-like header .header-position .header-more span.arrow{width:7px; position:absolute; right:0;
           height: 7px;
           overflow: hidden;
           border-right: solid 2px #ea5313;
           border-top: solid 2px #ea5313;
           margin-right: 15px;
       ...
       .mui-bar .mui-input-row .mui-input-clear~.mui-icon-clear, .mui-bar .mui-input-row .mui-input-speech~.mui-icon-speech {
        ...
        .kf{ float: right; font-size: 14px; color: #fff; line-height: 34px; padding: 5px 0;}
        .kf a{ color: #ffffff;}
...
<header class="mui-bar mui-bar-nav" style="background: #e95412 !important;">
    <#--<div class="mui-pull-left fonts logo-font" style="width: 80px;" >
    &lt;#&ndash;<@spring.message "project_short_name"/>&ndash;&gt;&nbsp;&nbsp;&nbsp;

    </div>-->
    <div class="mui-pull-left"> <img src="${path}/images/zlogo.png" style="display:block;/* padding: 5px 0;*/ height: 37px; margin-top: 4px;"> </div>
    ...
    <div class="mui-pull-right">
        ...
        <span class="kf" style="font-size: 13px;">客服：<a href="TEL:0913-8123025">0913-8123025</a></span>
    </div>
</header>
 <div class="mui-content" id="topbar">
	...
	<#assign lastImg = adslides?last>
        <div class="mui-slider-item mui-slider-item-duplicate">
            <a href="${base}/${lastImg.appUrl}"><img src="${lastImg.mobilepic}@370w_155h_db.png" alt="${lastImg.description}"></a>
        </div>
	<#list adslides as slideitem>
        <div class="mui-slider-item mui-slider-item-duplicate">
            <a href="${base}/${slideitem.appUrl}"><img src="${slideitem.mobilepic}@370w_155h_db.png" alt="${slideitem.description}"></a>
        </div>
	</#list>
...
<div style="background: #fff;">
    <div class="mui-content-padded" style="margin: 0px 5px 0px 5px; padding-top: 15px;">
        <div class="mui-input-row mui-search">
            <input id="search"
                   style="min-width: 100px;text-align: left;margin: 5px 0px;border: 1px solid #dfdfdf;border-radius: 6px;"
                   type="search"
                   onkeydown="javascript:if(event.keyCode==13){ s(document.getElementById('search').value);return false;}"
...
<div class="f-cb ico-link fonts">
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['肥料'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_1.jpg"><br>肥料</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['农药'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_3.jpg"><br>农药</a></div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['种子'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_2.jpg"><br>种子</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['农膜'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_4.jpg"><br>农膜</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['饲料'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_5.jpg"><br>饲料</a> </div>
...
<#--<ul class="ms-tg">
    <li><a href="${base}/promotions/ms?whichclient=whichapp"><img src="${base}/static/app/gdnz/images/ms2.jpg"></a></li>
    <li><a href="${base}/promotions/tg?whichclient=whichapp"><img src="${base}/static/app/gdnz/images/tg2.jpg"></a></li>
</ul>-->
                ...
                <div class="seckill-item-price" style="padding:0">
                    <div style="border-bottom:1px dotted #dfdfdf">
                        <p style="margin-left:12px;font-size: 13px;color: #999; position: relative; margin-bottom:0;padding-bottom:5px; max-height:40px;overflow: hidden;">
                            <em style="float: left; font-style: normal; width: 68%;">${goods.fullName}</em>
                            <a style="padding-right: 0 !important; float: right; width: 30%;" goodsId="${goods.id}" shopId="${goods.shopId}" categoryId="${goods.categoryId}">
    ...
    <ul class="clearfix" id="ul_${child["catelog"].id}">
		<#list child["goodschildList"] as goodschild><#if (goodschild_index > 5) > <#break> </#if>
            <li>
                ...
                <div class="info">
                    <p style="position: relative;"><a href="${base}/item/whichapp/${goodschild.id}.html" style=" width: 80%; float: left;padding-right: 0 !important;
"> ${goodschild.name}</a>
                        <a style="padding-right: 0 !important; float: right; width: 20%;" class="add-gwc" goodsId="${goodschild.id}" shopId="${goodschild.shopId}" categoryId="${goodschild.categoryId}">
                            <img src="${path}/images/add_gwc.png" style="width: 25px;  display: inline; float: right;"></a>
                        </p>
...
<div class="foot">
    ...
    <div class="mll-footer-icp">陕西供销集团光大农资有限公司</div>
</div>
</div>
<div class="return">
