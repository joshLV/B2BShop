...
<div class="mui-content" id="content" style="padding-bottom:58px; padding-top:50px;">
        ...
        <ul class="category-toolbar" style="z-index:1;">
            ...
            <li><a <#if pager.orderBy=="scoreCount">style="color: red;" </#if>
                    href="${base}/search/s/${keyword}?whichclient=whichapp&orderBy=scoreCount&pageNumber=${pager.pageNumber}&order=<#if pager.orderBy=='' || pager.orderType='desc'>asc<#else>desc</#if>">评价<#if pager.orderBy=='scoreCount'><#if pager.orderType='desc'><img src="${path}/images/px_jt.jpg"><#else><img style="-webkit-transform: rotateZ(180deg);-moz-transform: rotateZ(180deg);-o-transform: rotateZ(180deg);-ms-transform: rotateZ(180deg);transform: rotateZ(180deg);" src="${path}/images/px_jt.jpg"></#if></#if></a></li>
        ...
        <div class="guess-you-like" style="margin-top: 6px;">
            ...
            <#list list as gl>
                <li>
                    ...
                    <div class="info">
                        <p style="position: relative;"><a  href="${base}/item/whichapp/${gl.id}.html" style="padding-right: 0; float: left; width: 79%;"> ${gl.name}</a>
                            <a href="#" style="padding-right: 0 !important;width: 20%; float: right;" goodsId="${gl.id}" class="add-gwc"> <img src="${path}/images/add_gwc.png" style="float: right;width: 25px;  display: inline;"></a>
                        </p>
...
function loadData(){
    ...
    var url ="${base}/search/getPageDateForJson?keyword=${keyword}&pageNumber="+pageNumber+"&orderBy=<#if pager.orderBy=='createDate' || pager.orderBy==''>createDate<#else>${pager.orderBy}</#if>&orderType=${pager.orderType}";
    jQuery.ajax({
        type: "post",
        url: url,
        data: {},
