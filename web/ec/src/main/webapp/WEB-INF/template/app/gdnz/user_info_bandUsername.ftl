...
<#--            <div class="mui-input-row">
        ...
        <div class="link-area" style="margin-top:80px;">
            <a id='reg' style="color:#ea5313;" href="javascript:void(0)" onclick="gotoRegiste();">注册账号</a> <span class="spliter">|</span>
            <a id='forgetPasswd' style="color:#ea5313;" href="javascript:void(0)" onclick="findpwd();">忘记密码</a>
        </div>
    </div>
