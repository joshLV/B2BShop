            ...
            <li>
                ...
                <div class="info">
                    <p style="position: relative;"><a  href="${base}/item/whichapp/${gl.id}.html" style=" padding-right: 0; float: left; width: 79%;"> ${gl.name}</a>
                        <a goodsId="${gl.id}" href="#" style="padding-right: 0 !important; width: 20%; float: right;" class="add-gwc">
                        <img src="${path}/images/add_gwc.png" style="width: 25px;  display: inline;float: right;"></a></p>
