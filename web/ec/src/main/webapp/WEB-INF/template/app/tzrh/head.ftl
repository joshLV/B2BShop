<#assign path="${base}/static/app/tzrh"/>
<#assign path_skin="${base}/static/app/tzrh/theme/red"/>
<#assign picloading="${base}/static/app/tzrh/images/picloading.png"/>
...
<script>
    var ismobile=true;
    //微信自动登录地址
    var weixinLoginUrl='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5143ffdce77e0102&redirect_uri=http://www.tianzerihua.com/ec/member/weixinAutoLogin&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
    /**
     *是否是微信浏览器
     */
    function isWeiXin(){
