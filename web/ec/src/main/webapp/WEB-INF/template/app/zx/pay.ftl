...
<div class="mui-content" style="margin-top:20px;">
    ...
    <form id="paymentInfo" method="POST" action="${base}/payment/show?whichclient=whichapp" style="display: none">
        <input id="orderSn" name="orderSn" type="text" value="${orderSn}" /><br>
        <input id="payType" name="payType" type="text" value="" />
    </form>
</div>
