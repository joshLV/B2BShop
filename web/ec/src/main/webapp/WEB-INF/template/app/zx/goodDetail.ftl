...
<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <#include "app/zx/head.ftl">
      <#--script type="javascript" src="/ec/static/app/zx/js/jquery.idTabs.min.js"></script-->
        ...
        <ul>
           <#-- <li style="position:relative;">
            ...
            <li>
                ...
                <div class="val">由${(shop.name?exists)?string("<a style='color: #55BCEE;' href='${base}/shop/${shop.urlAddress}?whichclient=whichapp'>${shop.name}</a>","本商城")}
                    发货并提供售后服务。发货并提供售后服务。预计送达时间：${goods.predictDay}
                </div>
            </li>
            <li>
            ...
            <div class="myorder">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <#list parameterMap?keys as key>
                        ...
                        <tr>
                            <td class="tdTitle" colspan="2"><b>${key}</b></td>
                        </tr>
                            <#list params as p>
                                <#list goodsParamList as gpm>
                                    <#if gpm.parameterId == p.id && gpm.content != "">
