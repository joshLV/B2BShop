...
<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <#include "app/tzrh/head.ftl">
      <#--script type="javascript" src="/ec/static/app/tzrh/js/jquery.idTabs.min.js"></script-->
...
.gz_icon{background: url(${base}/static/app/tzrh/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 0;}
.gz_icon_on{background: url(${base}/static/app/tzrh/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -25px;}
.car_icon{background: url(${base}/static/app/tzrh/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -50px; width: 25px;}
.user_icon{background: url(${base}/static/app/tzrh/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -75px;}
           ...
           <li onclick="showTab(this)" data-align="show">
               ...
               <div class="arrow" id="jt" style="margin-top: 7px;"></div>
                <div class="val" id="yfsm" style="padding-right: 12px;display: none;width: 95%">
                    <img style="width: 100%;margin-top: 12px;" src="${base}/static/app/tzrh/images/wlsm.png">
