...
<header class="mui-bar mui-bar-nav" style="background: #fff!important;">
    ...
    <div class="mui-pull-right">
        ...
        <span class="kf" style="font-size: 13px;">客服：<a href="TEL:029-84265316">029-84265316</a></span>
    </div>
</header>
 <div class="mui-content" id="topbar">
	...
	<#assign lastImg = adslides?last>
        <div class="mui-slider-item mui-slider-item-duplicate">
            <a href="${base}/${lastImg.appUrl}"><img src="${lastImg.mobilepic}@370w_155h_2e.png" alt="${lastImg.description}"></a>
        </div>
	<#list adslides as slideitem>
        <div class="mui-slider-item mui-slider-item-duplicate">
            <a href="${base}/${slideitem.appUrl}"><img src="${slideitem.mobilepic}@370w_155h_2e.png" alt="${slideitem.description}"></a>
        </div>
	</#list>
        <!-- 额外增加的一个节点(循环轮播：最后一个节点是第一张轮播) -->
        <div class="mui-slider-item mui-slider-item-duplicate">
		<#assign firstImg = adslides?first>
            <a href="${base}/${firstImg.appUrl}"><img src="${firstImg.mobilepic}@370w_155h_2e.png" alt="${firstImg.description}"></a>
        </div>
    </div>
...
<div class="f-cb ico-link fonts">
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['蒂花之秀'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_1.jpg"><br>蒂花之秀</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['强生'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_3.jpg"><br>强生</a></div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['大宝'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_2.jpg"><br>大宝</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['自然使者'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_4.jpg"><br>自然使者</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['云南白药'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_5.jpg"><br>云南白药</a> </div>
...
<div class="foot">
    ...
    <div class="mll-footer-icp">天泽日化</div>
</div>
</div>
<div class="return">
