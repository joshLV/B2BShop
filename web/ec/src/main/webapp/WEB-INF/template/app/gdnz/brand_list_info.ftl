        ...
        <ul>
            <#list recommendGoodsList as goods>
                ...
                <li><a href="${base}/item/whichapp/${goods.id}.html">
                    <div class="p-img"><img attr='lazyload' src="${picloading}" data-original="<#if (goods.pic?exists)>${goods.pic}_400x300.png}<#else >${picloading}</#if>"
        ...
        <ul>
            <#list pager.list as goods>
                <li class="goods"><a href="${base}/item/whichapp/${goods.id}.html">
                    <div class="p-img"><img src="${picloading}" data-original="<#if (goods.pic?exists)>${goods.pic}_400x300.png}<#else >${picloading}</#if>"
                ...
                success: function(data) {
                    ...
                    if(data.status == 'success'){
                        ...
                        jQuery.each(data.data, function(index, goods){
                            ...
                            var imgSrc = fullpath + "/static/app/gdnz/images/picloading.png";
                            if(goods.pic != "" && typeof(goods.pic) != "undefined"){
                                imgSrc =  goods.pic + "_400x300.png";
                            }
