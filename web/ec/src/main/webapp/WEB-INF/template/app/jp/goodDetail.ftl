...
<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <#include "app/jp/head.ftl">
      <#--script type="javascript" src="/ec/static/app/jp/js/jquery.idTabs.min.js"></script-->
...
.gz_icon{background: url(${base}/static/app/jp/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 0;}
.gz_icon_on{background: url(${base}/static/app/jp/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -25px;}
.car_icon{background: url(${base}/static/app/jp/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -50px; width: 25px;}
.user_icon{background: url(${base}/static/app/jp/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -75px;}
...
<#--新做-->
    <div class="goods_abstract">
        ...
        <#if promotions ?? && mt??>
            <div class="p-ad" style="font-size: 14px;"><#if promotionsGoods?? && promotionsGoods.description??>${promotionsGoods.description}</#if></div>
            <br>
        </#if>
           ...
           <#-- <#if (goods.description != "" && goods.description != null)>
            ...
            <li>
                <div class="pro_l" >
                    ...
                    <span style="color: #333;"><font id="__stock">${goods.stock}</font>&nbsp;${goods.unit}</span>
                </div>
            </li>
            <li>
                <div class="pro_l">
                ...
                <#else>
                    <#if mt??>
                        <#if mTPromotions.status == 'ing'>
                            <li id="summary-price" class="summary-ms">
                                <div style="height: 90px;width:548px;background-color:red;overflow:hidden">
                                    ...
                                    <div style="height: 70px;width:80px;float: left; font-size: 16px; border-right: 2px dotted #d12153; /*line-height: 90px; text-align: center;*/ color: #fff;">
                                        <div style="width: 70px; height: 70px;background: #fff280; line-height: 70px; text-align: center; color:#000;">
                                            <#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>
                                        </div>
                                    </div>
                                    <div style="width:425px;float: left; line-height: 20px;  font-size: 14px; padding-left: 5px; margin-top: 15px;color:#fff">
                                        <strong><#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>价：</strong>
                                        <span >￥${promotionsGoods.promotionsPrice?string("##0.00")}&nbsp;</span>
                                    </div>
                                    <div style="width:425px;float: left; line-height: 20px; font-size: 14px; padding-left: 5px;color:#fff">
                                        <strong style="font-width:200px;">距离<#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>结束</strong>
                                        <span class="endtime" value="${mTPromotions.intervalEndTime}" data-status="ing"></span>
                        ...
                        <#elseif mTPromotions.status == 'before'>
                            ...
                            <li id="summary-price" class="summary-ms">
                                <div style="height: 70px;width: 548px;background-color:red;overflow:hidden" >
                                    <div style="height: 70px;width:80px;float: left; font-size: 16px; border-right: 2px dotted #d12153; /*line-height: 90px; text-align: center;*/ color: #fff; ">
                                        <div style="width: 70px; height: 70px;background: #fff280; line-height: 70px; text-align: center; color: #DB0000;"><#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if></div>
                                    </div>
                                    <div style="width:425px;float: left; line-height: 20px;  font-size: 14px; padding-left: 5px; margin-top: 15px;color:#fff">
                                        <strong><#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>价：</strong>
                                        <span >￥${promotionsGoods.promotionsPrice?string("##0.00")}&nbsp;</span>
                                    ...
                                    <div style="width:425px;float: left; line-height: 20px; font-size: 14px; padding-left: 5px;color:#fff">
                                        <strong style="font-width:200px;">距离<#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>开始</strong>

                                        <span class="endtime" value="${mTPromotions.intervalStartTime}" data-intervalEndTime="${mTPromotions.intervalEndTime}" data-status="before"></span>
                                        <script type="text/javascript">
                                            $(function(){
                                                timer(parseInt($(".endtime").attr('value')));
                                            });
           ...
           <li onclick="showTab(this)" data-align="show">
               ...
               <div class="arrow" id="jt" style="margin-top: 7px;"></div>
                <div class="val" id="yfsm" style="padding-right: 12px;display: none;width: 95%">
                    <img style="width: 100%;margin-top: 12px;" src="${base}/static/app/jp/images/wlsm.png">
...
<#--点击商品评论链接到查看评论页面的评论-->
    ...
    -->
        ...
        <div class="sp_right">
            <div id="__rightBtn_hasStock">
                <#if ("${mt}"=="t"||"${mt}"=="m")>
                    <#if mTPromotions.status == 'ing'>
                        <a href="javascript:;void(0);" disabled="true" style="background-color: #FAFAFA;color: red"><#if ("${mt}"=="t"||"${mt}"=="m") && mTPromotions.status == 'ing' && validObj??>
                            起购${validObj.startNum}件,限购${validObj.limitNum}件
                        </#if></a>
                        <a href="javascript:openSpPanel('promotions');">立即抢购</a>
                    <#else>
            ...
            <div id="__rightBtn_noStock" style="display: none;">
            ...
            <div>
                ...
                <div style="width: 100%;float: left;">
                    ...
                    <div class="mui-numbox" style="width: 44px;height: 30px; margin-top: 10px;float: left;margin-bottom: 10px;">
                        <button class="mui-numbox-btn-minus" type="button" onClick="clickNum()" data-min="<#if promotionsId??><#if ("${mt}"=="t"||"${mt}"=="m") && mTPromotions.status=="ing">${validObj.startNum}<#else>1</#if><#else>1</#if>">-</button>
                        <input class="mui-numbox-input" type="number"  id="num" onchange="if(this.value><#if validObj.limitNum?? && validObj.limitNum gt 0>${validObj.limitNum}<#else>1000</#if>){popAlert('您最多可购买<#if validObj.limitNum?? && validObj.limitNum gt 0>${validObj.limitNum}<#else>1000</#if>件'); this.value=<#if validObj.limitNum?? && validObj.limitNum gt 0>${validObj.limitNum}<#else>1000</#if>;}else if(this.value<<#if promotionsId?? && validObj.startNum gt 0>${validObj.startNum}<#else>1</#if>){popAlert('您最少需购买<#if promotionsId?? && validObj.startNum gt 0>${validObj.startNum}<#else>1</#if>件'); this.value=<#if promotionsId?? && validObj.startNum gt 0>${validObj.startNum}<#else>1</#if>;}"  onBlur="checkNum2()" value="<#if promotionsId??><#if ("${mt}"=="t"||"${mt}"=="m") && mTPromotions.status=="ing">${validObj.startNum}<#else>1</#if><#else>1</#if>"/>
                        <button class="mui-numbox-btn-plus" type="button">+</button>
                    </div>
                    <div >
...
<script type="text/javascript">
    ...
    function timer(intDiff){
        window.setInterval(function(){
            ...
            <#--if(intDiff<0){-->
                <#--//data-intervalEndTime="${mTPromotions.intervalEndTime}" data-status="before"-->
                <#--if($('.endtime').attr("data-status")=='before'){//说明活动还没有开始，倒计时为0是换成距离结束-->
                    <#--//点亮立即抢购按钮-->
                    <#--$($(".sp_right").children()[1]).attr("href","javascript:openSpPanel('promotions');");-->
                    <#--$($(".sp_right").children()[1]).attr("style","");-->
                    <#--//修改距离开始为距离结束-->
                    <#--$('.endtime').prev().html($('.endtime').prev().html().replace("开始","结束"));-->
                    <#--//修改距离结束时间倒计时-->
                    <#--intDiff=$('.endtime').attr("data-intervalEndTime")-->
                    <#--if(intDiff > 0){-->
                        <#--day = Math.floor(intDiff / (60 * 60 * 24));-->
                        <#--hour = Math.floor(intDiff / (60 * 60)) - (day * 24);-->
                        <#--minute = Math.floor(intDiff / 60) - (day * 24 * 60) - (hour * 60);-->
...
//                                jumpto(path);
    ...
    function addCartOrBuyNow(goodsId, cnt, sp){
        ...
        }else if(type == 'buyNow'){//加入购物车跳转到购物车页面
            var path=fullpath+"/cart/add?gid=" + goodsId + "&cnt=" +cnt +"&sp=" +encodeURI(encodeURI(sp)) + "&backurl=" + window.location.href.split(".html")[0]+".html&whichclient=whichapp";
            jumpto(path);
        }else if(type == 'promotions'){//团购商品直接到订单提交页面
            $("#addCart").find("a").html("等待中...");
            $("#addCart").attr("disabled", true);
            //验证起购数量和限购数量
            $.ajax({
                type: 'post',
                async: false,
                url: fullpath+'/promotions/validMs/${promotionsId}?mt=${mt}',
                success: function(data) {
                    if( data.status == 'success' ){
                        $("#addCart").find("a").html("确定");
                        ...
                        if(("${mt}"=="t"||"${mt}"=="m") &&  "${mTPromotions.status}"=="ing") {
                            if(("${mt}"=="t"||"${mt}"=="m") && "${mTPromotions.status}"=="ing") {
                                ...
                                var buyNuma = $('#num');
                                var beBuy = parseInt($('#num').val()) + parseInt(quantity);

                                if(parseInt(limitNum)!=0) {
                                    if(parseInt(${goods.stock})<parseInt(startNum)) {
                                        popAlert("库存不足，当前库存为${goods.stock}");
                                        //$('#num').val("1");
                                        return;
                                    }
                                    if(parseInt(buyNuma.val())>parseInt(${goods.stock}) && parseInt(buyNuma.val())>parseInt(startNum)) {
                                        popAlert(" 库存不足，当前库存为${goods.stock}");
                                        $('#num').val("${goods.stock}");
                                        return;
                                    }
                                    if(parseInt(beBuy)>parseInt(limitNum)) {
                                        if((parseInt(limitNum)-parseInt(quantity))<=0) {
                                            popAlert("您的购买资格已使用完了");
                                            $("#num").val("${validObj.startNum}");
                                            return;
                                        } else {
                                            popAlert("您还可以购买"+ (parseInt(limitNum)-parseInt(quantity)) +"件商品");
                                            //$("#num").val(parseInt(limitNum)-parseInt(quantity));
                                            return;
                                        }
                                    }
                                    //如果限购数量符合条件就到订单提交页面
                                    var promotionId='${promotionsId}';
                                    var path=fullpath+"/promotions/ordercheck/"+promotionId+"/"+goodsId+"?dealNum="+cnt+"&sp="+encodeURI(encodeURI(sp))+"&to=orderCheck&whichclient=whichapp&&backurl=''";
                                    jumpto(path);
                                }else{
                                    if(parseInt(${goods.stock})<parseInt(startNum)) {
                                        popAlert("库存不足，当前库存为${goods.stock}");
    ...
    (function(mui, doc) {
        ...
        mui.ready(function () {
            ...
            jQuery.ajax({
                ...
                success: function(data) {
                    if( data.status == 'success' ){
                        jQuery("#__stock").html(data.stock);
                        if( parseInt(data.stock) <= 0 ){
                            $("#__rightBtn_hasStock").hide();
                            $("#__rightBtn_noStock").show();
                        }else{
                            $("#__rightBtn_hasStock").show();
                            $("#__rightBtn_noStock").hide();
                        }
                    }
                }
            });
