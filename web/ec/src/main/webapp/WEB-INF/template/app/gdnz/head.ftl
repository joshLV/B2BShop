<#assign path="${base}/static/app/gdnz"/>
<#assign path_skin="${base}/static/app/gdnz/theme/red"/>
<#assign picloading="${base}/static/app/gdnz/images/picloading.png"/>
...
<script>
    var ismobile=true;
    //微信自动登录地址
    var weixinLoginUrl='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx29d5378ecfaadb5f&redirect_uri=http://www.58baimuyuan.com/ec/member/weixinAutoLogin&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect';
    /**
     *是否是微信浏览器
     */
    function isWeiXin(){
