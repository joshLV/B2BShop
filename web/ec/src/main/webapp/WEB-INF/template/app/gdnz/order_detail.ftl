                        ...
                        <#else>
                            ...
                            <#if '${order.orderStatus}' == 'wait_buyer_pay'>
                                <button type="button" onclick="pay('${order.orderSn}', '${order.totalAmount}', '${order.id}')"
                                        style="height: 28px; font-size: 14px; line-height: 1.1; margin-top: -4px; font-weight: bold; background-color: #ea5313; color: white; border: none;">
                                    去付款
                                </button>
                                <!--<button type="button" onclick="pay('${order.orderSn}', '${order.totalAmount}', '${order.id}')"
                    ...
                    <div class="order-width">
                        ...
                        <#--新添加-->
                            ...
                            <div class="sh_info">
                                ...
                                <div class="val red" style="color: #ea5313;">￥${order.goodsTotalPrice?string('0.00')}</div>
                            </div>
                            <div class="sh_info">
                    ...
                    <div class="order-width">
                       ...
                       <#if gisList?exists && gisList?size gt 0>
                            ...
                            <div class="sh_info">
                                ...
                                <div class="val">${gis} <a class="mui-control-item red" href="javascript:void(0);" class="blue" id="getExpressLog" gis="${gis}"  orderId="${order.id}"   style="padding:5px 12px;  background: #ea5313;-webkit-border-radius: 3px; color: #fff;-moz-border-radius: 3px;border-radius: 3px;">获取物流详情</a></div>
                            </div>
                            </#list>
                            <div class="sh_info" style="border-bottom: 0;">
