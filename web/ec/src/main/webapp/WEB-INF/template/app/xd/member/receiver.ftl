...
<div class="mui-content">
    <form class="mui-input-group" id="receiverFrom" name="receiverFrom">
        ...
        <button id='showCityPicker' class="mui-btn mui-btn-block" type='button'  style="font-size: 14px; border: 1px solid #e6e6e6; background: #e2e2e2 ; width: 90%;margin-left: 22px;"><#if name?exists>${name}<#else>选择城市 ...</#if></button>
