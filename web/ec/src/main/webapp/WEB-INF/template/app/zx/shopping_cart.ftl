                ...
                <#list cartItemList  as map>
                    ...
                    <div class="shop-title customize-shtit" shopIdD="${map.shopId}" style="border-bottom: 1px dotted #d8d8d8; padding:2px 0;">
                        <div class="item">
                            ...
                            <div class="shop-title-content"> <a href="${base}/shop/${map.shopUrl}?whichclient=whichapp"> <span class="shop-title-name">${map.shopName}</span> <span class="shop-title-detail"> <span style="width: 30px;"> <img src="${base}/static/app/zx/images/icon-left.png"> </span> </span> </a> </div>
                            </li>
                        </div>
                    </div>
                            ...
                            <div class="mui-gwc-box" style="margin-left: 40px;">
                                ...
                                <div class="mui-media-body">
                                    ...
                                    <div class="mui-numbox" style="width: 35px;height: 25px; margin:0; float: left;padding:0 30px;">
                                        ...
                                        <input class="mui-numbox-input" style="width: 23px;padding:0 0px!important" type="input"  readonly="true"  id="num" name="num"  onchange="changEwpCartitemNum(this)" cartItemid="${cartItem.id}" onBlur="checkNum2()" value="${cartItem.quantity}"/>
