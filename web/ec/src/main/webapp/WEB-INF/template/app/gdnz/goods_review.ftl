...
<div class="mui-content" style="padding-bottom:50px;">
    <div class="myorder">
        ...
        <#list orderItemList as item>
            ...
            <tr>
                <td colspan="2">
                    订单编号:<a href="${base}/order/view/${item.orderSn}?whichclient=whichapp">${item.orderSn}</a>
                </td>
            ...
            <tr>
                <td>
                    <a href="${base}/item/whichapp/${item.goodsId}.html">
                        <img width="50" height="50" title="${item.goodsName}" data-img="1"
                             src="<#if item.pic??>${item.pic}_400x300.png</#if>" class="err-product">
                    </a>
                </td>
                <td>
                ...
                <td>
                    <#if '${item.isReview}'=='1'>
                        <div style="padding: 5px;"><a href="javascript:void(0);" id="fbpj_${item.goodsId}_${item_index}" alt="${item.goodsId}" title="查看评价"
                              style="cursor: pointer;color: #005ea7"
                              onclick="viewGoodsReviews(this,'${memberId}','${item.goodsId}','${item.orderSn}');">查看评价</a>

                            <#if item.unreadReviewCount gt 0><span id="fbpj_${item.goodsId}_${item_index}_units"  style="float: right;color:white;background-color: red; margin: 4px 5px 0 0; text-align: center;width: 15px;height: 15px;line-height: 15px;border-radius: 45%;">${item.unreadReviewCount}</span></#if>
                        ...
                        <div  style="padding: 5px;"><a href="javascript:void(0);" id="appendReview_${item.goodsId}" alt="${item.goodsId}" title="追加评价"
                           style="cursor: pointer;color: #005ea7;"
                           onclick="appendGoodsReviews(this,'${item.orderSn}','${item.goodsId}');">追加评价</a></div>
                    </#if>
                    <#if '${item.isReview}'=='0'>
                        <a href="javascript:void(0);" id="fbpj_${item.orderSn}" alt="${item.orderSn}" title="发表评价"
                              style="cursor: pointer;color: #005ea7"
                              onclick="showDialog(this,'${item.id}','${item.orderSn}','${item.goodsId}');">发表评价</a>
                    </#if>
                </td>
            </tr>
            </tbody>
