                ...
                <#list cartItemList  as map>
                    ...
                    <div class="shop-title customize-shtit" shopIdD="${map.shopId}" style="border-bottom: 1px dotted #d8d8d8; padding:2px 0;display: none;">
                        <div class="item">
                            ...
                            <div class="shop-title-content"> <a href="${base}/shop/${map.shopUrl}?whichclient=whichapp"> <span class="shop-title-name">${map.shopName}</span> <span class="shop-title-detail"> <span style="width: 30px;"> <img src="${base}/static/app/gdnz/images/icon-left.png"> </span> </span> </a> </div>
                            </li>
                        </div>
                    </div>
                            ...
                            <div class="mui-gwc-box" style="margin-left: 40px;">
                                ...
                                <div class="mui-media-body">
                                    ...
                                    <div class="cart-product-name" style="margin-top:15px;height: 2.8em;">
                                        <a href="${base}/item/whichapp/${cartItem.goodsId}.html" class="color-000"><span style="line-height:1.5em;height: 3.2em;"><font style="font-weight: bold;color: #ea5313;">[<#if cartItem.stock<=0>无货<#else>有货</#if>]</font>${cartItem.name!''}</span></a>
                                    ...
                                    <span style="display:block; float:left; font-size: 14px;color:#ea5313;line-height:30px; padding-left: 5px;">￥<font class="price">${cartItem.price}</font></span>
