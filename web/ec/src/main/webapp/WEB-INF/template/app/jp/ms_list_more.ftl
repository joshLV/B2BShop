...
<div class="mui-content" id="content" style="padding-bottom:58px; padding-top:50px;">
    ...
    <div class="ms_list">
        <ul>
            <li>
                <div class="face">
                    <a href="#"><img src="http://115.29.168.153/jp/M00/01/6B/cx2omVcCM76ANlnWAAHec9u570o684.png@205w_224h.png"></a>
                    <div class="time-item">
                        <i></i>
                ...
                <div class="info">
                    ...
                    <div class="pms_btn">
                        <a href="#" target="_blank">
                            <img src="${base}/static/app/jp/images/ms.png" alt="立即抢购" title="立即抢购">
                        </a>
                    </div>
                </div>
            </li>
            <li>
                <div class="face"><a href="#"><img src="http://115.29.168.153/jp/M00/00/CC/cx2omVbnxneAIUIdAAOHoaHeDSA590.jpg@205w_224h.png"></a>
                    <div class="time-item">
                        <i></i>
                        <span class="day_show">0天</span>
                        <strong class="hour_show">0时</strong>
                ...
                <div class="info">
                    ...
                    <div class="pms_btn">
                        <a href="#" target="_blank">
                            <img src="${base}/static/app/jp/images/ms_2.png" alt="即将开始" title="即将开始">
                        </a>
                    </div>
                </div>
            </li>
