        ...
        jQuery.ajax( {
            ...
            success : function(data) {
                if(data.status=="success"){
                    ...
                    jumpto(fullpath + "/member/receiver?whichclient=whichapp&to=${to}&o=${o}&paymentId=${paymentId}&deliveryId=${deliveryId}&promotionsId=${promotionsId}&goodsId=${goodsId}&dealNum=${dealNum}");
                }else{
