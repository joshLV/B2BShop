...
<#assign path_skin="${base}/static/app/gwq/theme/red"/>
<#assign picloading="${base}/static/app/gwq/images/picloading.png"/>
...
<script>
    var ismobile=true;
    //微信自动登录地址
    var weixinLoginUrl='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx73e7533b93059bdc&redirect_uri=http://www.ulife.sx.cn/ec/member/weixinAutoLogin&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect';
    /**
     *是否是微信浏览器
     */
    function isWeiXin(){
