...
<div class="mui-content" id="content" style="padding-bottom:58px; padding-top:50px;">
    ...
    <div class="guess-you-like" style="margin-top: 6px;">
        ...
        <#list goodslist as gl>
            <li>
                <div class="face">
                    <a href="${base}/item/whichapp/${gl.id}.html" title="${gl.name}">
                        <img attr="lazyload" src="${picloading}" data-original="${gl.pic}@200w_150h.png" alt="${gl.name}" >
                    </a>
                </div>
                <div class="info">
                    <p style="position: relative;"><a  href="${base}/item/whichapp/${gl.id}.html" style="width: calc(100% - 31px);"> ${gl.name}</a><a href="#" style="padding-right: 0 !important;" class="add-gwc">
        ...
        success: function(data) {
            ...
            if(data.status == 'success'){
                ...
                jQuery.each(data.data, function(index, goods){
                    var item='<li>'+
                            '<div class="face">'+
                            '<a href="${base}/item/whichapp/'+goods.id+'.html" title="'+goods.name+'">'+
