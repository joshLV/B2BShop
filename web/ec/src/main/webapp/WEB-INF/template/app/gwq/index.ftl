...
<header class="mui-bar mui-bar-nav" style="background: #fff!important;">
    ...
    <div class="mui-pull-right">
        ...
        <span class="kf" style="font-size: 13px;">客服：<a href="TEL:400-829-8366">400-829-8366</a></span>
    </div>
</header>
...
<div class="f-cb ico-link fonts">
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['GJMJ'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_1.jpg"><br>国际名酒</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['SPLY'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_3.jpg"><br>食品粮油</a></div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['MYWSYP'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_2.jpg"><br>母婴卫生</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['GHHZQJYP'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_4.jpg"><br>个护化妆清洁</a> </div>
    <div class="f-fl"> <a href="javascript:go('/list/whichapp/${parent_catelogs_map['JFJJ'].id}.html?orderBy=sales&orderType=desc')"><img src="${path}/images/fl_5.jpg"><br>轻奢名品</a> </div>
...
<ul class="ms-tg">
    <li><a href="${base}/promotions/ms?whichclient=whichapp"><img src="<#if msImge??>${msImge}<#else>${base}/static/app/gwq/images/ms2.jpg</#if>"></a></li>
    <li><a href="${base}/promotions/tg?whichclient=whichapp"><img src="<#if tgImge??>${tgImge}<#else>${base}/static/app/gwq/images/tg2.jpg</#if>"></a></li>
</ul>
