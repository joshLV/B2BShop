...
<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <#include "app/gdnz/head.ftl">
      <#--script type="javascript" src="/ec/static/app/gdnz/js/jquery.idTabs.min.js"></script-->
...
/*产品详细介绍样式*/
    ...
    .goods_abstract .goods_sell li .pro_l strong {color: #ea5313;}
    ...
    .goods_info01 ul li .val span a,.goods_info02 ul li .grade span{ padding:0 3px; color:#ea5313;}
...
.order_filter_02 li a.selected {
    border-bottom: solid 2px #ea5313;
}
...
.order_filter_02 li a em{ color:#ea5313; font-size:13px; padding-left:2px; font-style: normal;}
...
.lala li a.selected {
    ...
    background: #ea5313; color: #fff;-webkit-border-radius: 3px;
    -moz-border-radius: 3px;
    border-radius: 3px;
}
.lala li a {
...
.lala li a em{ color:#ea5313; font-size:13px; padding-left:2px; font-style: normal;}
...
.gz_icon{background: url(${base}/static/app/gdnz/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 0;}
.gz_icon_on{background: url(${base}/static/app/gdnz/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -25px;}
.car_icon{background: url(${base}/static/app/gdnz/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -50px; width: 25px;}
.user_icon{background: url(${base}/static/app/gdnz/images/z_icon.png) no-repeat;background-size: 100px 100px; background-position: 0 -75px;}
...
.sp_right a{ width: 50%; background-color: #ea5313; font-size: 14px; color: #fff; text-align:center;}
.sp_right a:hover{color: #fff;}
.sp_right a.hs{background-color: #498fca;}
...
<body style="padding-bottom:55px;">
    <header class="mui-bar mui-bar-nav bg_color_${catelogGrandfatherId}">
            ...
            <a  href="${base}/app_index" class="mui-right mui-btn-link mui-btn-nav mui-pull-right" style="margin-right:10px;">
                <img src="${path}/images/home_icon.png"/>
            </a>
        </header>
    <#if !goods??>
        <div id="refresh">
                                ...
                                <div style="height: 70px;width:548px;background-color:red;overflow:hidden">
                                    ...
                                    <div style="width:425px;float: left; line-height: 20px; font-size: 14px; padding-left: 5px;color:#fff">
                                        <strong style="font-width:200px;">距离<#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>结束</strong>
                                                    <span class="endtime" value="${mTPromotions.intervalEndTime}">
                                                    </span>
                                ...
                                <div style="height: 70px;width: 548px;background-color:red;overflow:hidden" >
                                    ...
                                    <div style="width:425px;float: left; line-height: 20px; font-size: 14px; padding-left: 5px;color:#fff">
                                        <strong style="font-width:200px;">距离<#if mt == 'm'>秒杀<#elseif mt == 't'>团购</#if>开始</strong>
                                                    <span class="endtime" value="${mTPromotions.intervalStartTime}">
                                                    </span>
                                        <script type="text/javascript">
                                            $(function(){
                                                timer(parseInt($(".endtime").attr('value')));
           ...
           <li onclick="showTab(this)" data-align="show">
               ...
               <div class="arrow" id="jt" style="margin-top: 7px;"></div>
                <div class="val" id="yfsm" style="padding-right: 12px;display: none;width: 95%">
                    <img style="width: 100%;margin-top: 12px;" src="${base}/static/app/gdnz/images/wlsm.png">
        ...
        <div style="padding:10px 10px 0px 10px;">
            <div>
                ...
                <div style="width: 100%;float: left;">
                    ...
                    <#if mt == 't' && mTPromotions.status == 'ing' && validObj??>
                        <div style="width: 80px;height: 30px; margin-top: 10px;float: left;margin-bottom: 10px;font-size: 12px;line-height: 30px;margin-left: 5px;color: red">限购${validObj.limitNum}件</div>
                    </#if>
                    <div >
            ...
            $.ajax({
                ...
                success: function(data) {
                    if( data.status == 'success' ){
                        ...
                        if("${mt}"=="t" && "${mTPromotions.status}"=="ing") {
                            if("${mt}"=="t" && "${mTPromotions.status}"=="ing") {
                                //验证团购活动用户可购买商品数量
                                ...
                                if(parseInt(limitNum)!=0) {
                                    ...
                                    if(parseInt(beBuy)>parseInt(limitNum)) {
                                        popAlert("亲, 您还可以购买"+ (parseInt(limitNum)-parseInt(quantity)) +"件商品", {icon:5});
                                        $('#num').val(parseInt(limitNum)-parseInt(quantity));
                                        return;
                                    }else{
                                        //如果限购数量符合条件就到订单提交页面
                                        var promotionId='${promotionsId}';
                                        var path=fullpath+"/promotions/ordercheck/"+promotionId+"/"+goodsId+"?dealNum="+cnt+"&sp="+encodeURI(encodeURI(sp))+"&to=orderCheck&whichclient=whichapp";
                                        jumpto(path);
                                    }
                                }
                            }
