...
<#--<div class="pro_select" id="panel" style="display: none">
    <dl class="pro_item_tit">
        <dt><img src="ec/static/app/xd/images/001.jpg" /></dt>
        <dd>
    ...
    <div class="pro_close"><img src="/ec/static/app/xd/images/colse.gif" /></div>
</div>-->
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == 'success') {
                    ...
                    html = html.replace('{{goods.name}}', data.goods.name);
