...
<#--世界名品列表-->
    <ul class="brand_list" id="top" style="margin-top: 45px;">
        ...
        <li>
            <div class="face">
                <a href="${base}/shop/${indexShop.urlAddress}.html?whichclient=whichapp">
                <#--gwq 适用<a href="${base}/search/sa?keyword=${indexShop.name}">-->
                ...
                success: function(data) {
                    if(data.status == 'success'){
                        ...
                        jQuery.each(data.data, function(index, shop){
                            ...
                            jQuery(domShop).find("a").prop('href', fullpath + "/shop/" + shop.urlAddress+ ".html?whichclient=whichapp");
