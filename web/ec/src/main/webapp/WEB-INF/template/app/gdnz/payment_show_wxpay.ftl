	...
	<#list orders as order>
        <li class="mui-table-view-cell" index="${order_index + 1}">
            <div class="mui-collapse-content">
                <p><span style="">订单：</span>${order.orderSn}<span class="f-fr2" style="color: #ea5313;">￥${order.totalAmount}元</span>
                </p>
            </div>
        </li>
	</#list>
        ...
        <li class="mui-table-view-cell">请支付 <span class="f-fr2" style="color:#ea5313; font-weight: bold;">￥${total}
            元</span></li>
