<#assign path="${base}/static/app/xd"/>
<#assign path_skin="${base}/static/app/xd/theme/red"/>
<#assign picloading="${base}/static/app/xd/images/picloading.png"/>
...
<script>
    var ismobile=true;
    //微信自动登录地址
    var weixinLoginUrl='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx645294e541a4443d&redirect_uri=http://www.xdsm58.com/ec/member/weixinAutoLogin&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
    /**
     *是否是微信浏览器
     */
    function isWeiXin(){
