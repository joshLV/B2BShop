...
.brandlist .mt{position:relative;height:32px; margin-top:15px;}
.brandlist .mt h2{width:150px;height:32px;line-height:32px;font-size:16px;font-weight:normal;}
.brandlist .mc{height:230px;padding:10px;border:2px solid #cccccc; border-top-color:#e4393c; margin-bottom: 10px; }
