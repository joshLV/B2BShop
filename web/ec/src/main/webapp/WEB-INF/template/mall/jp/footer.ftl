...
.r_menu ul{ height:250px; margin-bottom:10px; right:0px; position:relative; z-index:10; overflow:hidden; background:url(${base}/static/mall/jp/img/bg_0.8.png) repeat;
...
.r_menu ul .up i{ background:url(${base}/static/mall/jp/img/icons.png) -63px -150px no-repeat;}
.r_menu ul .qq i{ background:url(${base}/static/mall/jp/img/icons.png) -63px -20px  no-repeat;}
.r_menu ul .tel i{ background:url(${base}/static/mall/jp/img/icons.png) -63px -108px  no-repeat;}
.r_menu ul .wx i{ background:url(${base}/static/mall/jp/img/icons.png) -59px -66px  no-repeat;}
.r_menu ul .down i{ background:url(${base}/static/mall/jp/img/icons.png) -63px -190px  no-repeat;}
.r_menu .sliBox{ top:50px; right:-150px; width:150px; height:150px;border-radius:10px; background:url(${base}/static/mall/jp/img/bg_0.5.png) repeat;
...
.r_menu .telBox span em{ font-style: normal; font-size: 17px; font-weight: normal; color: #fff;}

.r_menu .close{ cursor:pointer; opacity:0.8; width:26px; height:26px; display:block; margin-left:15px; transition:transform 0.5s; background:url(${base}/static/mall/jp/img/icons.png) 0px -640px no-repeat;}
...
<div class="content">
	<div id="footer">
		...
		<div class="copyright">
			陕ICP备15014495号&nbsp;&nbsp;<br>
			&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2013-2014&nbsp;&nbsp;西安锦鹏国际酒店用品城&nbsp;&nbsp;版权所有<br>
		</div>
...
<script type="text/javascript" src="${base}/static/mall/jp/js/rightMenu.js"></script>
...
<div class="r_menu">
    ...
    <div class="sliBox qqBox" style="right: -150px;">
        <p><a href="http://wpa.qq.com/msgrd?v=3&uin=506151162&site=qq&menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:506151162:4" alt="客服QQ" align="absmiddle" /><em>客服一</em></a></p>
        <p><a href="http://wpa.qq.com/msgrd?v=3&uin=412293642&site=qq&menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:412293642:4" alt="客服QQ" align="absmiddle" /><em>客服二</em></a></p>
        <p><a href="http://wpa.qq.com/msgrd?v=3&uin=1354670067&site=qq&menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:1354670067:4" alt="客服QQ" align="absmiddle" /><em>客服三</em></a></p>
        <p><a href="http://wpa.qq.com/msgrd?v=3&uin=171979920&site=qq&menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:171979920:4" alt="客服QQ" align="absmiddle" /><em>客服四</em></a></p>
    ...
    <div class="sliBox telBox" style="right: -150px;">
		...
		<br><em>152 8928 8267</em>
		</span>
    </div>
    <div class="sliBox wxBox" style="right: -150px;">
        <p>
            <img src="${base}/static/mall/jp/img/weixin_app.png">
            锦鹏手机客户端
        </p>
     <#--   <p> <img src="${base}/static/mall/jp/img/weixin1.png">
            关注锦鹏官方微信
        </p>-->
    </div>
    <span class="close" style="background:url(${base}/static/mall/jp/img/icons.png) 0px -640px no-repeat;"></span>
</div>
<script>
    var _hmt = _hmt || [];
    (function() {
        var hm = document.createElement("script");
        hm.src = "//hm.baidu.com/hm.js?4d197a17a2ffb46c83008b59f250dcea";
