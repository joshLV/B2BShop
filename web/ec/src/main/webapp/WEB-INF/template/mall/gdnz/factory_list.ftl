...
#traderList .mt{height:35px;/*background:url(${base}/static/mall/img/bg-allsort.jpg) repeat-x 0 -162px;*/border-bottom:2px solid #C30000;line-height:35px;}
#traderList .mt h2{height:35px;padding:0 5px 0 20px;/*background:url(${base}/static/mall/img/bg-allsort.jpg) no-repeat 0 -191px;*/ color: #c00000;}
