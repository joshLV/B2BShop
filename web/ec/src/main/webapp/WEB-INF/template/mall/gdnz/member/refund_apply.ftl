...
<style>
    ...
    .processNav {BACKGROUND: #fff; FLOAT: left; COLOR: #404040; FONT-WEIGHT: 700; margin-top: 10px;}
    ...
    .refund-form{border: 1px solid #E8E8E8; border-top: 2px solid #ea5313; padding-top: 30px; padding-bottom: 30px;}
     .error{color:red;}
</style>
<div class="content">
