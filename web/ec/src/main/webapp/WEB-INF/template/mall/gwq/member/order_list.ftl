...
<div class="right">
    ...
    <div class="m" id="orderlist">
        <div class="mt">
            <ul class="taborder">
                <li>
                    <div class="tyies-t"><a href="${base}/order/list"><strong class="ftx-04">全部订单</strong></a><s></s><b></b></div>
                </li>
                                        ...
                                        <#list orderItemList as orderitem>
                                            ...
                                            <#--<#if orderitem_index gt 0>-->
                                                <a href="${base}/item/${orderitem.goodsId}.html" target="_blank"
                                                   class="img-box"><img src="${orderitem.pic}@70w_70h.png"
                                                                        title="${orderitem.goodsName}" height="70"
                                                                        width="70"></a>
                                            <#--</#if>-->
                                            </#if>
                                        </#list>
...
<#-- 分页条 -->
    <div class="m clearfix">
        <div class="pagin" style="float: right; margin-right: 10px;">
...
<div id="LoginBox">
    ...
    <div class="thickbox" id="" style="left: 246.5px; top: 276px; width: 762px; height: 543px;">
        <div class="thickwrap" style="width: 760px;">
            <div class="thicktitle" id="" style="width:640"><span id="oper">物流信息详情</span><a href="javascript:void(0)" title="关闭窗口" class="close_btn" id="closeBtn">×</a></div>
