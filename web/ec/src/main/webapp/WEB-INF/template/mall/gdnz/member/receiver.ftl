...
.m-tit{border: 1px solid #E8E8E8; height: 40px; line-height: 40px; padding-left: 10px; color: #333333; background: #F5F5F5;}
.o-m{ border: 1px solid #E8E8E8; overflow: hidden; border-top: none; padding-top: 40px; padding-bottom: 40px;}
...
input.bule_btn{background: #ea5313;font-size: 14px; border:0; color:#fff;font-weight: bold;cursor: pointer;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; height:36px!important; line-height:36px!important; border:0!important;cursor: pointer!important;}
input.bule_btn:hover{ background:#ea5313;color:#fff;}

/*******弹出层 common********/
#popupdiv{width:700px;height:420px;position:fixed;z-index:1000; background:#fff;}
        ...
        <div class="pop_win aptab_center_address">
            ...
            <ul class="newaddress">
                ...
                <li>
                    ...
                    <input type="text" name="consigneeParam.address" id="consignee_address" maxlength="26"  class="inputxt" style="width: 398px;" >
                </li>
                <li>
