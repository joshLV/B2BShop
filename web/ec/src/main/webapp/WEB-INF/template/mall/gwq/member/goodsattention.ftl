...
<style>
    ...
    .left {float: left;width: 195px; margin-bottom: -9999999px; padding-bottom: 9999999px; background: #ffffff; border-right: 1px solid #E8E8E8;}
    ...
    #mc .buton .buy img{padding-right: 3px;}
...
<div class="right" id="right">
    <div class="breadcrumb">
        <strong><a href="${base}/member/index">会员中心</a></strong><span>&nbsp;&gt;&nbsp;我的关注<span></span></span>
    </div><!--breadcrumb end-->
    <div class="mt">
    ...
    <div class="mc" id="mc">
                            ...
                            <div class="dity">
                                <div class="mod">
                                    ...
                                    <div class="i-it">
                                        ...
                                        <div class="buton">
                                        <#--Desc:判断是否为跨境商品 goodsAttention.crossBorder == '1' 是跨境商品 Auth:zhangqiang Time:2015-01-30  Start-->
                                            <#if goodsAttention.crossBorder == '1'>
                                                <a href="javascript:void(0);" onclick="addCart('${goodsAttention.goodsId}','1','1');" class="buy" ><img src="${base}/static/mall/img/gwc_icon.png">加入购物车</a>
                                            <#else>
                                                <a href="javascript:void(0);" onclick="addCart('${goodsAttention.goodsId}','1','0');" class="buy" ><img src="${base}/static/mall/img/gwc_icon.png">加入购物车</a>
                                            </#if>
                                        <#--Desc:判断是否为跨境商品 goodsAttention.crossBorder == '1' 是跨境商品 Auth:zhangqiang Time:2015-01-30  End-->
        ...
        <div class="mymoney_pages f-cb" >
            <div class="pagin fr" style="margin-top: 10px; margin-bottom: 10px; margin-right: 10px;">
