...
#recommendArticle dl {float: left;width: 217px;border: 1px solid #e2e2e2;margin-right: 11px;padding: 8px 10px 20px 10px;height: auto;}
#recommendArticle dt {position: relative;zoom: 1;border-bottom: 2px solid #666; padding-bottom: 8px;}
