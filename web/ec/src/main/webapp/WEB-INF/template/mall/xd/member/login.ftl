...
#login .btn-entry {width: 307px;height: 34px;font-family: "微软雅黑";line-height: 34px;/*text-indent: -9999px;*/background: #db0000;overflow: hidden; color: #ffffff; font-size: 16px; border-radius: 3px;}
...
<div id="login">
	<div class="mc">
		<div id="bg" style="width: 511px; height: 355px; position: absolute;">
	    	<img width="511" height="355" src="${base}/static/mall/xd/img/member_login.jpg">
	    </div>
	    <div class="form">
	    	<div class="title">
	    		<strong>会员登录</strong>
