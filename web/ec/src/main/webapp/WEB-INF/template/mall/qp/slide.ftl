...
/**********************news**********************/
.news{width: 208px;height:130px;margin:0 0 8px;border:1px solid #e6e6e6;background:#FFFFFF;float:right;overflow:hidden;position:relative;}
...
.news-list{overflow:hidden;height:136px;margin:0 10px;padding:5px 0 0;}
