...
#succeed .btn-pay{float:right;width:140px;height:36px;margin:0 25px 0 10px;line-height:36px; _margin-right:12px;background:#ea5313; border-radius: 3px; color: #ffffff; font-size: 18px; text-align: center;}
#succeed .btn-pay:hover{background: #ed4548;}
#succeed .btn-continue{float:right;width:120px;height:34px; color: #ea5313;  background:#ffeded; border: 1px solid #ea5313; border-radius: 3px; font-size: 18px; text-align: center; line-height: 34px;}
