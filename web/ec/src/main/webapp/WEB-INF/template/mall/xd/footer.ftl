...
.r_menu ul{ height:250px; margin-bottom:10px; right:0px; position:relative; z-index:10; overflow:hidden; background:url(${base}/static/mall/xd/img/bg_0.8.png) repeat;
...
.r_menu ul .up i{ background:url(${base}/static/mall/xd/img/icons.png) -63px -150px no-repeat;}
.r_menu ul .qq i{ background:url(${base}/static/mall/xd/img/icons.png) -63px -20px  no-repeat;}
.r_menu ul .tel i{ background:url(${base}/static/mall/xd/img/icons.png) -63px -108px  no-repeat;}
.r_menu ul .wx i{ background:url(${base}/static/mall/xd/img/icons.png) -59px -66px  no-repeat;}
.r_menu ul .down i{ background:url(${base}/static/mall/xd/img/icons.png) -63px -190px  no-repeat;}
.r_menu .sliBox{ top:50px; right:-150px; width:150px; height:150px;border-radius:10px; background:url(${base}/static/mall/xd/img/bg_0.5.png) repeat;
...
.r_menu .close{ cursor:pointer; opacity:0.8; width:26px; height:26px; display:block; margin-left:15px; transition:transform 0.5s; background:url(${base}/static/mall/xd/img/icons.png) 0px -640px no-repeat;}
...
<div class="content">
	<div id="footer">
		...
		<div class="copyright">
			&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2013-2014&nbsp;&nbsp;喜都云商城&nbsp;&nbsp;版权所有<br>
		</div>
...
<script type="text/javascript" src="${base}/static/mall/xd/js/rightMenu.js"></script>
...
<div class="r_menu">
    ...
    <div class="sliBox wxBox" style="right: -150px;">
        <p>
            <img src="${base}/static/mall/xd/img/weixin_app.png">
             喜都云商城手机客户端
        </p>
     <#--   <p> <img src="${base}/static/mall/xd/img/weixin1.png">
            关注喜都云商城官方微信
        </p>-->
    </div>
    <span class="close" style="background:url(${base}/static/mall/xd/img/icons.png) 0px -640px no-repeat;"></span>
</div>
...
<div id="wchat">
<!--<img src="${base}/static/mall/xd/img/qrcode.png" width="100" height="100" alt="机电商城" />
	<p>微信关注</p>
	<p>&nbsp;</p>&ndash;&gt;
    <img src="${base}/static/mall/xd/img/sjcode.png" width="100" height="100" alt="锦鹏商城" />
    <p>手机客户端</p>
</div><!--wchat end&ndash;&gt;-->
</#escape>