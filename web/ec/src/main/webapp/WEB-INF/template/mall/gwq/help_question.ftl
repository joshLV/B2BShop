...
.right {float: right;width:960px; border: 1px solid #E8E8E8; padding: 20px; background: #ffffff; margin-bottom: 10px;}

/*.widepage .right {width:960px; border: 1px solid #E8E8E8; padding: 20px;}*/
...
<div class="content">
	<div class="breadcrumb">
		<!--${base}/help-->
		<strong><a href="javascript:;">帮助中心</a></strong><span>&nbsp;&gt;&nbsp;<a href="${base}/help/question/${articles.id}.html" target="_self">${(articles.title)!}</a><span></span></span>
	</div><!--breadcrumb end-->
</div>
<div class="content">
	<div class="left">
		<#include "mall/gwq/help_menu.ftl"/>
	</div><!--left end-->
	<div class="right">
		<#if articles?? >
		${(articles.content)!}
