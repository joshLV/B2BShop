...
<style>
/*register*/
/*.register-line{width: 100%; height: auto; border-top: 2px solid #db0000; overflow: hidden; margin-top: 30px;}*/
#register {margin-bottom: 10px;width: 990px;padding: 0;margin: 0 auto;zoom: 1; border-top: 2px solid #db0000;margin-top: 30px;}
...
/*下箭头*/
.arrow-down{width:0;  height:0; border-left:100px solid transparent;  border-right:100px solid transparent;  border-top:20px solid #db0000; margin-left: 390px;margin-bottom: 30px;}
...
#register .tab .curr{position:relative;color:#ffffff;background:#db0000;height:45px;line-height:45px;font-weight:bold;margin-top:0;/*-moz-box-shadow:2px 0 2px #DDDDDD; -webkit-box-shadow:2px 0 2px #DDDDDD;box-shadow:2px 0 2px #DDDDDD;border-bottom: none;*/}
...
#register .error{color:#e4393c;line-height:36px;height:36px;position:absolute;top:0px;right:-275px;width:230px;padding:0 5px;background:url(${base}/static/mall/jp/img/register-tsbg.png) no-repeat; padding-left: 30px;}
...
#register .focus{}
.register-ts{width: 990px; text-align: center; margin-bottom: 20px; color: #db0000; font-size: 16px; background: #f7f7f7; height:50px; line-height: 50px;}
...
#register .btn-regist {width: 270px;height: 36px;color: #FFF;font-family: "微软雅黑";font-size: 16px;/*text-indent: -9999px;*/font-weight: 800;overflow: hidden;background:#db0000; border-radius: 3px;}
...
<#include "mall/jp/member/header.ftl"/>
		...
		<div class="form">
            ...
            <div class="item item-new">
                ...
                <div class="fl item-ifo">
                    ...
                    <label for="protocol">我已阅读并同意<a href="${base}/html/jp/protocol.html" class="blue" id="protocol">《会员注册协议》</a></label>
                    <span class="clr"></span>
...
<script src="${base}/static/mall/jp/js/jdValidate.js" type="text/javascript"></script>
