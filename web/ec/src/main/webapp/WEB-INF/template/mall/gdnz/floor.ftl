...
.floorList .floor .mt b{background: #ea5313; color: #ffffff;}
...
.widepage .floorList .floor .mc .con .pro-show li .p-img img,.products .pic img{
...
.widepage .floorList .floor .mc .con .pro-show li .p-img:hover img,.products .pic:hover img{ margin-left: -10px;}
...
.widepage .floorBottomAd img{width: 1210px;height: 70px;}
    ...
    /* 页面新样式 */
.ca-tit{width210px; height:82px; color:#ffffff; background: url(${base}/static/mall/gdnz/img/floor_bg1.png) no-repeat; float: left;}
.floor-number{font-size: 16px; margin-left:12px; padding-top: 10px; float: left;}
.floor-names{float:left; width: 210px; text-align: center; font-size: 20px; letter-spacing: 1px; margin-top: 5px;}
