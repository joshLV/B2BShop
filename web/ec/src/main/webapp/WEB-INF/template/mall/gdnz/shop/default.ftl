...
<style>
    ...
    .rank .mc .fore1 span,
    .rank .mc .fore2 span,
    .rank .mc .fore3 span{background-position:0 -50px;color:#ea5313;}
            ...
            <div class="mc list-h">
                ...
                <#list recommendGoodsList as goods>
                    <li style="text-align: center">
                        ...
                        <div class="p-price" sku="391653">社员价：
                ...
                <#if goods_index &lt; 3>
                    <ul class="tabcon" style="display: block;">
                        <li style="text-align: center">
                            ...
                            <div class="p-price" sku="${goods.sn}">社员价：<strong class="p-price">￥${goods.price}</strong></div>
                        </li>
                    </ul>
                <#else>
