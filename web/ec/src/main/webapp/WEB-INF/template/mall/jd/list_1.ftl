...
.products .price strong {display: inline-block;font-family: verdana;font-size: 12px;margin-right: 5px;height: 20px;line-height: 20px;overflow: hidden;vertical-align: middle;color: #e4393c;}
