...
<head>
    ...
    <link href="${base}/static/mall/jd/img/touchicon.png" rel="apple-touch-icon" />
...
<#include "mall/jd/slide.ftl"/>
<!--品牌旗舰店-->
<#include "mall/jd/index_shop.ftl"/>
<!--楼层展示-->
<#include "mall/jd/floor.ftl"/>
<!--知识区域-->
<#include "mall/jd/index_article.ftl"/>
