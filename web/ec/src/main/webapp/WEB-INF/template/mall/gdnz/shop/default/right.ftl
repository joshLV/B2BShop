...
.recommend .mt{height:38px;background:#f7f7f7; border-bottom: 1px solid #dfdfdf; overflow: hidden; width: 100%;}
 .recommend .mt h2{height:18px; line-height: 18px;text-indent:0.6em;margin:10px 0 0px 10px;color:#444; border-left: 4px solid #ea5313; font-size: 15px; float: left;}
...
.recommend .mc li:hover{border:solid 1px #ea5313;box-shadow: 0 0 8px #ccc;}
...
.recommend .mc .fore3{display: none;}
 ...
 .recommend .mc .item .goodsInfo .price {color: #ea5313; font-weight: bold;}
 .recommend .mc .item .goodsInfo .buynow {background: #ea5313; border-radius: 3px;}
 .recommend .mc .item .goodsInfo .rmb {font-family: verdana;font-style: normal;color: #ea5313; font-size: 14px; }
...
.goodsList .mt{height:38px;background:#f7f7f7; border-bottom: 1px solid #dfdfdf; overflow: hidden;}
 .goodsList .mt h2{height:18px; line-height: 18px;text-indent:0.6em;margin:10px 0 0px 10px;color:#444; border-left: 4px solid #ea5313; font-size: 15px; float: left;}
...
.goodsList .mc li:hover{border:solid 1px #ea5313;box-shadow: 0 0 8px #ccc;}
...
.goodsList .mc .item .pic {overflow: hidden;position: relative;height:208px;background: rgba(0, 0, 0, 0) url("${base}/static/mall/gdnz/img/default_logo.jpg") no-repeat scroll 50% 50%; }
...
.goodsList .mc .item .goodsInfo .price {font-size: 14px;font-weight: bold;color: #ea5313;}
