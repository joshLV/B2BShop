...
<style>
    ...
    .processNav .extra {BACKGROUND: url(${base}/static/mall/gdnz/img/cartscbgv.png) no-repeat 0px 0px}
    .processNav { BACKGROUND: #fff; FLOAT: left; COLOR: #404040; FONT-WEIGHT: 700;margin-bottom: 25px; margin-top: 2px;}
    ...
    .processNav .on {BACKGROUND: #ea5313; COLOR: #fff}
    ...
    .btn {width: 250px;height: 36px;color: #ffffff;font-size:15px;font-weight: 800;overflow: hidden; background: #db0000; border: none; border-radius: 3px;}
    .btn:hover{background: #ed4548}
    .refund-form{border: 1px solid #E8E8E8; border-top: 2px solid #ea5313;}
</style>
<div class="content">
