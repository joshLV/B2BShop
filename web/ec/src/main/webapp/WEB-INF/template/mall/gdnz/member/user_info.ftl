...
<head>
  <title>账户信息</title>
    ...
    <style>
        ...
        #memberinfo .tab{height:40px;line-height:40px;overflow:visible; border: 1px solid #e8e8e8; background: #F5F5F5;/* border-bottom: none; border-bottom: 2px solid #C30000;*/}#memberinfo .tab li{/*border-right:1px solid #EED97C;*/cursor:pointer}#memberinfo .tab li h2{float:left;height:30px;padding:0 8px;color:#999;}
        #memberinfo .tab .curr h2{position:relative;height:31px; color:#333;/* color: #ea5313;*/}#memberinfo .mc{padding:5px 8px;}#memberinfo .mc .extra{margin-top:10px;}#memberinfo th strong{display:block;padding-bottom:3px;margin-bottom:5px;border-bottom:1px solid #DBDBDB;text-align:left;}*html #memberinfo .tab{overflow:hidden;}
        /**账户基本信息**/
        .user-form{border: 1px solid #E8E8E8; border-top: none;}
        .user-form .item{display:inline-block;display:block;margin-bottom:20px;line-height:30px; }.user-form .item span.label{float:left;height:18px;line-height:18px;padding:6px 0;width:100px;text-align:right;font-size:12px}.user-form em{color:#ea5313}.fl{float:left}.user-form .itxt-succ{background:url(${base}/static/img/succ-ico.png) right center no-repeat}.user-form .text{height:18px;width:127px;padding:5px 23px 5px 5px}.user-form .itxt,.user-form .selt,.user-form .sele,.user-form .area{line-height:18px;border:1px solid #ccc;padding:5px;float:none}.user-form input{font-size:12px}input{-webkit-rtl-ordering:logical;-webkit-user-select:text;cursor:auto}.clr{display:block;overflow:hidden;clear:both;height:0;line-height:0;font-size:0}.user-form .item:after{content:".";display:block;height:0;clear:both;visibility:hidden}.user-form .jdradio{float:left;margin:8px 3px 10px 18px;padding:0}.user-set .birthday-info{width:397px;overflow:hidden}.user-form .selt1{width:70px}.user-form .selt{line-height:18px;border:1px solid #ccc;padding:5px;float:none}.user-form select{font-size:12px}select{-webkit-appearance:menulist;box-sizing:border-box;align-items:center;white-space:pre;-webkit-rtl-ordering:logical;color:black;background-color:white;cursor:default;margin:0;font:-webkit-small-control;letter-spacing:normal;word-spacing:normal;text-transform:none;text-indent:0;text-shadow:none;display:inline-block;text-align:start;-webkit-writing-mode:horizontal-tb}.user-form .birthday-info label{float:none;font-size:12px}.ml5{margin-left:5px}.mr5{margin-right:5px}.user-form .itxt1{width:305px}.user-form .selt,.user-form .sele{width:100px}
        .btn-5{border-radius:3px;display:inline-block;height:18px;line-height:18px;background:#ea5313;padding:2px 14px 3px}.btn-5:link,.btn-5:visited{color:#ffffff;text-decoration:none}
        .btn-5:hover{background:#ed4548;}
...
<div class="content">
    ...
    <div class="right">
        ...
        <div class="clr"></div>
        <!--基本信息-->
        <div class="user-form" style="display: block;"><br><form id="baseInfoFrm">
            <div class="item">
            ...
            <#--<div class="item">-->
                ...
                <#--<div class="fl">-->
                    <#--<input type="text" class="itxt" maxlength="18" name="iDCode" disabled id="iDCode" value="11111${member.iDCode}" style="margin-left: 0">-->
                    <#--&lt;#&ndash;<div class="clr"></div>&ndash;&gt;-->
                    <#--&lt;#&ndash;<div class="prompt-05"><span id="mobile_msg"></span></div>&ndash;&gt;-->
                <#--</div>-->
            <#--</div>-->
