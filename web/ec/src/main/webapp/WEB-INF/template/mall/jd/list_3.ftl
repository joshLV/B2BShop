                            ...
                            <div class="v-tabs">
                                ...
                                <#list brandList as brand>
                                    <div id="brand_id_19570" rel="y" more="false">
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?brand=${brand.id}&page=1"
                    ...
                    <div class="attr">
                        ...
                        <div class="a-values">
                            <div class="v-fold">
                                <ul class="f-list">
                                    <li>
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?price=M0L199&page=1">0-199</a>
                                    </li>
                                    <li>
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?&price=M200L899&page=1">200-899</a>
                                    </li>
                                    <li>
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?price=M900L2399&page=1">900-2399</a>
                                    </li>
                                    <li>
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?price=M2400L3799&page=1">2400-3799</a>
                                    </li>
                                    <li>
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?price=M3800L6999&page=1">3800-6999</a>
                                    </li>
                                    <li>
                                        <a href="${base}/list/${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?price=M7000L20099&page=1">7000-20099</a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="fore1">
                <dl class="order">
                    ...
                    <dd <#if pager.orderBy=="sales">class="curr"</#if> >
                    	<a href="${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?orderBy=sales&pageNumber=${pager.pageNumber}">销量</a><b></b>
                    </dd>
                    <dd <#if pager.orderBy=="price">class="curr"</#if>>
                        <a href="${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?orderBy=price&pageNumber=${pager.pageNumber}">价格</a><b></b>
                    </dd>
                    <dd <#if pager.orderBy=="scoreCount">class="curr"</#if>>
                        <a href="${grandCatelog.id}<#if parentCatelog.id??>-${parentCatelog.id}</#if><#if catelog.id??>-${catelog.id}</#if>.html?orderBy=scoreCount&pageNumber=${pager.pageNumber}">评论数</a><b></b>
                    </dd>
                </dl>
            <#if parentCatelog.id??>
                <#assign pageurl='-'+parentCatelog.id/>
            </#if>
            <#if catelog.id??>
                <#assign pageurl='-'+parentCatelog.id + '-'+catelog.id />
            </#if>
                <div class="pagin pagin-m hide">${pageurl}
                    <span class="text"><i>1</i>/152</span>
                    <span class="prev-disabled">上一页<b></b></span>
                    <a href="${base}/list/${grandCatelog.id}${pageurl}.html?page=2"
