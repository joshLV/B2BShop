...
<style>
    ...
    .breadcrumb strong a{color: #005ea7;}
    .breadcrumb span {/*font-family: "\5b8b\4f53"*/}
    .g-0{float:left;width:100%;}.c-3-5{margin-left:196px;}
     .main{border-left: 1px solid #E8E8E8; border-right: 1px solid #E8E8E8;}
    .mod-comm{/*padding:10px 20px 20px; margin-left: 20px;*/}
    .mod-main{background:#fff;margin-bottom:10px;/* margin-top: 5px; */margin-bottom: -9999999px; padding-bottom: 9999999px;}
    .extra-main .mt{padding-left:0;}
    .mod-comm .mt{ background: #F9F9F9; height: 40px; line-height: 40px;}
    .mt,.smt{cursor:default;overflow:hidden;zoom:1;}
    .mod-comm .mt h3{font-size:12px;color:#333333;font-family:'\5b8b\4f53';line-height:40px; margin-left: 10px;}
    ...
    .mod-main .mc{overflow:visible;/* border-bottom: 1px solid #E8E8E8; border-top: none;*/padding-top: 20px;}
    .tb-void{line-height:18px;text-align:center;border:1px solid #E8E8E8;/*border-top:0; border-right:0;*/ color:#333;width:98%; margin-left: 1%; }
    table{border-collapse:collapse;empty-cells:show;display:table;border-color:gray;border-spacing:2px;}
    colgroup{display:table-column-group;}
    thead{display:table-header-group;vertical-align:middle;border-color:inherit; }
    tr{display:table-row;vertical-align:inherit;border-color:inherit;}
    .tb-void th{background:#f5f5f5;height:32px;line-height:32px;padding:0;font-weight:400;border-bottom: 1px solid #E8E8E8;}
    td,th{display:table-cell;vertical-align:inherit;}
    tbody{display:table-row-group;vertical-align:middle;border-color:inherit;}
    .tb-line td{border:0;/*border-bottom:1px solid #f2f2f2;  border-right: 1px solid #E8E8E8;*/}
    .tb-void td{padding:10px 5px;}
    .pro-info{display:block;/* width: 970px;*/ border-bottom: 1px dashed #E8E8E8;}
    ...
    .comment-box{background:#fcfffa;border:1px solid #e8e8e8; border-top:1px solid #dbebd1;padding:20px 0 10px 30px;margin:-1px -6px 5px;text-align:left;position:relative;zoom:1;}
    ...
    .form .item{display:block;margin-bottom:10px;line-height:30px; width: 705px; margin-left: 100px;}
    .form .item:after{content:".";display:block;height:0;clear:both;visibility:hidden;}
    .form .item span.label{float:left;height:18px;line-height:18px;padding:6px 0;width:90px;text-align:right; color: #555;}
    ...
    .comment-box .cont{float:left;width:602px; line-height: 1.7; font-size: 13px; color: #999;word-wrap: break-word;}.comment-box .area01{color:#ccc;}.comment-box .area{width:605px;height:88px;}
    .form .area{line-height:18px;border:1px solid #cae1b8;padding:5px;float:none;
        -webkit-border-radius: 5px;
        -moz-border-radius: 5px;
        border-radius: 5px; margin-bottom: 8px;}
    .form textarea{font-size:12px;}textarea{font-family:monospace;-webkit-appearance:textarea;background-color:white;-webkit-rtl-ordering:logical;-webkit-user-select:text;flex-direction:column;resize:auto;cursor:auto;white-space:pre-wrap;word-wrap:break-word;margin:0em;font:-webkit-small-control;letter-spacing:normal;word-spacing:normal;text-transform:none;text-indent:0px;text-shadow:none;display:inline-block;text-align:start;-webkit-writing-mode:horizontal-tb;}.comment-box .msg-text{float:right;}
    .btn-5:link{color:#323333;text-decoration:none;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#f5fbef',endColorstr='#eaf6e2',GradientType='0');-ms-filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#f5fbef',endColorstr='#eaf6e2');background-image:linear-gradient(to top,#f5fbef 0,#eaf6e2 100%);-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;display:inline-block;height:25px;line-height:25px;border:1px solid #bfd6af;padding:2px 14px 3px; font-size: 13px;}
                            ...
                            <tr>
                                <td colspan="4">
                                    <ul class="pro-info" oid="1743395318">
                                        ...
                                        <li class="fore1" style="width: 370px;">
                                        ...
                                        <li class="fore2" style="text-align: center; width: 100px;"><span class="ftx03">${item.createDate?string('yyyy-MM-dd')}</span></li>
                                        <li class="forem" style="text-align: center; width: 260px;">
                                            <#if '${item.isReview}'=='1'>
        ...
        <#-- 分页条 -->
            <div class="m clearfix">
                <div class="pagin fr" style="margin-right: 10px;">
                    <#if pager??><#if pager.list??>
                        <#if pager.list?size &gt; 0>
                            <#import "mall/gwq/pager.ftl" as p>
                            <@p.pager pager = pager baseUrl = "/order/review.html" /></#if></#if>
                    </#if>
                    <#if !pager??><#if pager.list??><#if pager.list?size = 0 >
                        <div class="noRecord">你还没有订单！</div></#if></#if>
                    </#if>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    <#--$("#FiveId$"${item.id}).addClass('active');-->
    <#--$("#FiveId$"${item.id}).siblings().removeClass('active');-->
    <#--$('#commentStar').val('5');-->
    }
    /**
     * 控制评价框显示/隐藏效果
