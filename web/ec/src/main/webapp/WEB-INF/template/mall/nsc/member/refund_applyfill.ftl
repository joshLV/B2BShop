...
<style>
    ...
    .processNav .step1 {Z-INDEX: 3; WIDTH: 290px}
    .processNav .step2 {Z-INDEX: 2; WIDTH: 290px}
    .processNav .step3 {Z-INDEX: 1; WIDTH: 290px}
    .processNav .step4 {Z-INDEX: 0; WIDTH: 290px}
    .processNav .on {BACKGROUND: #2f970f; COLOR: #fff}
    ...
    .myform {width: 1190px;overflow: hidden;padding-left: 0; border: 1px solid #cccccc;}
