...
<div class="content">
	...
	<div class="form-group">
		<div class="fg-line search-ext">
			<div class="fg-line-value"><span>相关搜索：</span><a href="${base}/search/s/金杯" class="fore">金杯</a><b>|</b><a href="${base}/search/s/比亚迪">比亚迪</a><b>|</b></div>
		</div>
	</div>
    <div class="selector">
		<div class="s-title">
			...
			<div class="sl-value">
				...
				<div class="sl-v-list">
					<ul class="J_valueList">
						<li id="" data-initial="p">
							<a href="${base}/search/s/江铃汽车" title="江铃汽车"><i></i>江铃汽车</a>
						</li>
						<li id="" data-initial="p">
							<a href="${base}/search/s/东风" title="东风"><i></i>东风</a>
						</li>
						<li id="" data-initial="p">
							<a href="${base}/search/s/比亚迪" title="比亚迪"><i></i>比亚迪</a>
						</li>
						<li id="" data-initial="p">
							<a href="${base}/search/s/金杯" title="金杯"><i></i>金杯</a>
						</li>
						<li id="" data-initial="p">
							<a href="${base}/search/s/迪拉克" title="迪拉克"><i></i>迪拉克</a>
						</li>
					</ul>
				</div>
			</div>
		</div>
		<div id="" class="J_selectorLine s-category">
		<div class="sl-wrap">
			<div class="sl-key"><span>相关分类：</span></div>
			<div class="sl-value">
				<div class="sl-v-list">
					<ul class="J_valueList v-fixed">
						<li>
							<a title="重卡" href=""><i></i>重卡</a>
						</li>
						<li>
							<a title="轻卡" href=""><i></i>轻卡</a>
						</li>
						<li>
							<a title="皮卡" href=""><i></i>皮卡</a>
						</li>
						<li>
							<a title="客车" href=""><i></i>客车</a>
						</li>
						<li>
							<a title="工程车" href=""><i></i>工程车</a>
						</li>
						<li>
							<a title="乘用车" href=""><i></i>乘用车</a>
						</li>
						<li>
							<a title="商务车" href=""><i></i>商务车</a>
						</li>
						</ul>
				</div>
		...
		<div class="sl-wrap">
			...
			<div class="sl-value">
				<div class="sl-v-list">
					<ul class="J_valueList v-fixed">
						<li>
							<a title="0-199" href=""><i></i>0-199</a>
						</li>
						<li>
							<a title="200-899" href=""><i></i>200-899</a>
						</li>
						<li>
							<a title="900-2399" href=""><i></i>900-2399</a>
						</li>
						<li>
							<a title="2400-3799" href=""><i></i>2400-3799</a>
						</li>
						<li>
							<a title="3800-6999" href=""><i></i>3800-6999</a>
						</li>
						<li>
							<a title="7000-20099" href=""><i></i>7000-20099</a>
						</li>
					</ul>
				</div>
			</div>
	    ...
	    <div class="fore1">
	        <dl class="order">
                ...
                <dd <#if pager.orderBy=="sales">class="curr"</#if>>
                    <a href="javascript:void(0)"  onclick="s('${keyword}','orderBy=sales&pageNumber=${pager.pageNumber}')">销量</a><b></b>
                </dd>
                <dd <#if pager.orderBy=="price">class="curr"</#if>>
                    <a href="javascript:void(0)"  onclick="s('${keyword}','orderBy=price&pageNumber=${pager.pageNumber}')">价格</a><b></b>
                </dd>
                <dd <#if pager.orderBy=="scoreCount">class="curr"</#if>>
                    <a href="javascript:void(0)"  onclick="s('${keyword}','orderBy=scoreCount&pageNumber=${pager.pageNumber}')">评论数</a><b></b>
                </dd>
            </dl>
