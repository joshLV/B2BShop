...
#login .btn-entry {width: 149px;height: 34px;font-family: "微软雅黑";line-height: 34px;/*text-indent: -9999px;*/background: #ea5313;overflow: hidden; color: #ffffff; font-size: 16px; border-radius: 3px;}
#login .btn-register{width: 149px;height: 34px;font-family: "微软雅黑";line-height: 32px;/*text-indent: -9999px;*/background: #ffeded;overflow: hidden; color: #ea5313; font-size: 16px; border-radius: 3px; border: 1px solid #ea5313; margin-left:10px;}
