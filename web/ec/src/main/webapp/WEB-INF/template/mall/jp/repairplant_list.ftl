...
<html>
<head>
    <title>${keyword} - 维修厂 --- <@spring.message "project_name"/>-<@spring.message "project_description"/></title>
...
<div class="content">
    ...
    <div class="searchbox1">
        ...
        <input type="submit"onclick="s();return false;" name="ctl00$ContentPlaceHolder1$SearchManuBtn" value="搜维修厂" id="ContentPlaceHolder1_SearchManuBtn" class="sinput_btn">
    </div>
    <div class="search">
