...
<style>
/*register*/
/*.register-line{width: 100%; height: auto; border-top: 2px solid #ea5313; overflow: hidden; margin-top: 30px;}*/
#register {margin-bottom: 10px;width: 990px;padding: 0;margin: 0 auto;zoom: 1; border-top: 2px solid #ea5313;margin-top: 30px;}
...
/*下箭头*/
.arrow-down{width:0;  height:0; border-left:100px solid transparent;  border-right:100px solid transparent;  border-top:20px solid #ea5313; margin-left: 390px;margin-bottom: 30px;}
#register .mc{padding:0 0 20px;border:solid #dddddd;border-width:0px 1px 1px; }
...
#register .tab .curr{position:relative;color:#ffffff;background:#ea5313;height:45px;line-height:45px;font-weight:bold;margin-top:0;/*-moz-box-shadow:2px 0 2px #DDDDDD; -webkit-box-shadow:2px 0 2px #DDDDDD;box-shadow:2px 0 2px #DDDDDD;border-bottom: none;*/}
...
/*
#register .focus,#register .error{color:#ea5313;line-height:36px;height:36px;position:absolute;top:0px;right:-275px;width:260px;padding:0 5px;background:#FFEBEB;border:1px solid #ffbdbe;}
*/
#register .focus{color:#ea5313;line-height:36px;height:36px;position:absolute;top:0px;right:-275px;width:260px;padding:0 5px;background: none;}
#register .error{color:#ea5313;line-height:36px;height:36px;position:absolute;top:0px;right:-275px;width:230px;padding:0 5px;background:url(${base}/static/mall/gdnz/img/register-tsbg.png) no-repeat; padding-left: 30px;}
...
#register .focus{}
.register-ts{width: 990px; text-align: center; margin-bottom: 20px; color: #ea5313; font-size: 16px; background: #f7f7f7; height:50px; line-height: 50px;}
...
#register .btn-regist {width: 270px;height: 36px;color: #FFF;font-family: "微软雅黑";font-size: 16px;/*text-indent: -9999px;*/font-weight: 800;overflow: hidden;background:#ea5313; border-radius: 3px;}
#register .hover-btn {background:#ed4548;}
...
<#include "mall/gdnz/member/header.ftl"/>
	...
	<div class="mc">
		...
		<div class="form">
			<div class="item" id="select-regName">
				<span class="label"><b class="ftx04">*</b>手机号(登录名)：</span>
            ...
            <#--<div class="item" id="select-iDcode">
                ...
                <div class="fl item-ifo">
                    <input type="text" id="iDcode" name="iDcode" class="text" tabindex="1"  value="" />
                    <i class="i-name"></i>
            ...
            <div class="item item-new">
                ...
                <div class="fl item-ifo">
                    ...
                    <label for="protocol">我已阅读并同意<a href="${base}/html/gdnz/protocol.html" class="blue" id="protocol">《会员注册协议》</a></label>
                    <span class="clr"></span>
...
<script src="${base}/static/mall/gdnz/js/jdValidate.js" type="text/javascript"></script>
...
//             $("#iDcode").jdValidate(validatePrompt.iDcode, validateFunction.iDcode, false);
