            ...
            <div class="mod-main mod-comm extra-main" id="evalu01">
                <div class="mt">
                    ...
                    <div class="extra-l ftx03 ml10">
                        <span id="tip-num">(<span class="num-comment">${reviewedGoodsCount}</span>个待评价)</span>
                    </div>
                </div>
                <div class="mc">
                            ...
                            <tr>
                                <td colspan="3">
                                    <ul class="pro-info" oid="1743395318">
                                        ...
                                        <li class="fore2" style="text-align: center;"><span class="ftx03">${goods.createDate?string('yyyy-MM-dd')}</span></li>
                                    ...
                                    <div class="comment-box hide" id="${goods.id}">
                                        ...
                                        <div class="form" tagflag="true" isconspros="0" pid="1131836">
                                            ...
                                            <div class="item item02">
                                                ...
                                                <div class="fl">
                                                    <a href="#none" class="btn btn-5 mr20" id="btnDoReview" onclick="doReview('${goods.id}','${goods.orderSn}')"><s></s><span>评价并继续</span></a>
...
<script type="text/javascript">
     ...
     * 提交评价
     */
    function doReview(goodsId,orderSn) {
        var _data = {
            orderSn:orderSn,
