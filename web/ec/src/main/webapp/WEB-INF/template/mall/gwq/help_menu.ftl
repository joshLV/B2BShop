...
#leftMenu .mc{border:solid #E6E6E6;border-width:1px 1px 1px;overflow:hidden; border-top: 2px solid #e4393c;  background: #ffffff;}
...
#leftMenu dd .item:hover{background: #f7f7f7; border-left: 4px solid #db0000;}
