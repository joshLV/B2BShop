...
.goodsList .mc .item .pic {overflow: hidden;position: relative;height:208px;background: rgba(0, 0, 0, 0) url("${base}/static/mall/xd/img/default_logo.jpg") no-repeat scroll 50% 50%; }
