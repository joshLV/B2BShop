    ...
    <div class="right">
        ...
        <div class="m clearfix">
            ...
            <#if pager!false && pager.list?size &gt; 0>
                ...
                <@p.pager pager = pager baseUrl = "/order/list.html?year=${currYear}&status=${currStatus}" />
            <#else>
...
<script type="text/javascript">
    ...
    $(function () {
        $(".cancleOrder").colorbox({iframe:true, innerWidth:520, innerHeight:300, opacity: 0.15});
        ...
        $("#orderState").change(function () {
            /*var st = $(this).val();
            var sd = $("#submitDate").val();
            location.href = "${base}/order/list?status=" + st + "&year="+sd;*/
            searchOrder();
        });
