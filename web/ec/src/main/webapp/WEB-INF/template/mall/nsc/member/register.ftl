...
#register .tab .curr{position:relative;color:#2f970f;background:#ffffff;height:32px;line-height:32px;font-weight:bold;margin-top:0;-moz-box-shadow:2px 0 2px #DDDDDD; -webkit-box-shadow:2px 0 2px #DDDDDD;box-shadow:2px 0 2px #DDDDDD;border-bottom: none;}
...
#register .btn-regist {width: 270px;height: 36px;color: #FFF;font-family: "微软雅黑";font-size: 16px;text-indent: -9999px;font-weight: 800;overflow: hidden;background: url(${base}/static/mall/nsc/img/register-btn.png) no-repeat;}
#register .hover-btn {background: url(${base}/static/mall/nsc/img/register-hover-btn.png) no-repeat;}
