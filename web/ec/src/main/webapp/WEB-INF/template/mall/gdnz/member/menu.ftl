...
<style>
/*leftMenu*/
#leftMenu .mt{height:40px;padding:0 6px;background-color:#fff6f6;border-top:2px solid #ea5313;line-height:40px;color:#fff; border-left: 1px solid #E8E8E8;  border-bottom: 1px solid #E8E8E8; border-right: 1px solid #E8E8E8;}
#leftMenu .mt h2{float:left;background:none;padding-top:0;height:auto;line-height:40px; padding-left: 5px;}
#leftMenu .mt a{color:#ea5313;}
...
#leftMenu .mc{border:1px solid #E8E8E8; border-top: none;}
...
#leftMenu dd .item:hover{ border-left: 4px solid #ea5313;width: 189px;}
...
#leftMenu dl dd a:hover,.selectedMenu a{color:#ea5313; background: #F5F5F5;}
.selectedMenu a{font-weight: bold; color: #ea5313!important;}
</style>
<link href="${base}/static/mall/gdnz/css/fix.css" rel="stylesheet" type="text/css" media="all"/>
