...
<style>
    ...
    #orderstate .btn{width:46px;height:25px;margin:0 4px;background:#86c226;color:#fff; border-radius: 3px;}
    .btn-img{cursor:pointer;margin:0;padding:0;border:0;text-align:center;}#orderstate .mc{padding:10px 8px;}.toolbar .btn-40 {display: inline-block;padding: 0 13px 0 13px;background-color: #FFBA01;background: url(${base}/static/img/btn_bg.png) no-repeat;background-position: -20px;color: white;border-radius: 3px;}
    /**进度条**/
    ...
    /**跟踪、付款信息**/
    #ordertrack{border-top:1px solid #e8e8e8;/*padding:0 5px;*/position:relative;border-bottom:1px solid #e8e8e8; margin-left: 10px; margin-right: 10px;}#ordertrack td{vertical-align:top}#ordertrack .i-ordertrack s,.post01 .fore .fr s{float:left;width:9px;height:16px;font-size:0;line-height:0;margin-right:5px;background:url(i/od-icon.png)}.post01 .fore .fr s{margin-top:4px}#ordertrack .i-ordertrack a{color:#005AA0}
    ...
    #ordertrack .tab{/*border-bottom: 2px solid #C30000;*/}
    #ordertrack .tab .curr h2{position:relative;height:31px;color:#333333;}
    #ordertrack .mc{padding:5px 0; line-height: 30px;}#ordertrack .mc .extra{margin-top:10px;}#ordertrack th strong{display:block;padding-bottom:3px;margin-bottom:5px;border-bottom:1px solid #DBDBDB;text-align:left;}*html #ordertrack .tab{overflow:hidden;}
    /**订单信息**/
    #orderinfo{/*border:1px solid #DADADA;*/overflow:visible;}
    #orderinfo .mt{padding:0 10px;height:40px;line-height:40px;font-size:14px; color: #333333;}
    #orderinfo .mc{padding:5px 8px;background:#fff;overflow:visible; line-height: 30px;}
    #orderinfo .mc dl{padding:10px 5px;border-top:1px solid #EDEDED; float: left; width: 1190px;}
                ...
                <#-- <img width="46" height="25" style="display:inline;" src="${base}/static/img/btn_pay.gif">-->支付
                    ...
                    <div class="fr">
                        ...
                        <#--<input type="button" class="btn-img btn" id="btn_Cancel"
                            ...
                            <a href="${base}/order/popupcancel/${order.id}" title="订单取消申请" class="pay-button"  id="btn_Cancel">取消</a>
                        </div>
                    </div>
                </#if>
