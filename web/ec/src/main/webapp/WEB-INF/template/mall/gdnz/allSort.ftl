...
#allsort .mt{height:35px;/*background:url(${base}/static/mall/img/bg-allsort.jpg) repeat-x 0 -162px;*/border-bottom:1px solid #E8E8E8;line-height:35px; background: #F5F5F5;}
