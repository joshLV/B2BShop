...
<style>
    ...
    .btn-confirm-pay {background:#ea5313;width: 134px;height: 37px;display: none; text-align:center; line-height: 37px; color: #ffffff; border-radius: 3px; font-size: 16px;overflow: hidden;display: inline-block;border: none;vertical-align: middle;}
    ...
    <div class="m orderbody">
        <div class="mc">
            <div style="loat: left;overflow: hidden;width: 100%;margin-left: -26px;;">
                ...
                <div class="pay-total" style="float: right;">总支付金额：<strong class="ftx-01">￥${total}</strong>元<br></div>
            </div>
