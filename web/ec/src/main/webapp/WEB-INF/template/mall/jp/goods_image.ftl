...
<head>
    ...
    <link href="${base}/static/mall/jp/img/touchicon.png" rel="apple-touch-icon" />
        ...
        <div class="flexslider">
            ...
            <#if goodsImagesList?? && goodsImagesList?size &gt; 0>
                <#list goodsImagesList?sort_by("orderNo") as img>
                    <li>
                        <div class="img"><img alt="${img.title}" src="${img.pic}" /></div>
                    </li>
                </#list>
            </#if>
            </ul>
...
<script defer src="${base}/static/mall/jp/js/slider.js"></script>
<script type="text/javascript">
    $(function(){
...
<!--知识区域-->
<#include "mall/jp/index_article.ftl"/>
