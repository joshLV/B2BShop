...
#categorys .fatheritem1 {height: 130px;}
#categorys .fatheritem2 {height: 235px;}
#categorys .fatheritem3 {height: 135px;border-bottom: 0px;}
...
<div id="headerDiv">
	<div class="content" id="header">
		...
		<div id="search">
			...
			<div id="hotwords">
				<strong>热门搜索：</strong>
				<a href="${base}/search/s/传感器" target="_blank" style="color:#ff0000">传感器</a>
				<a href="${base}/search/s/制动系统" target="_blank">制动系统</a>
				<a href="${base}/search/s/工具设备" target="_blank">工具设备</a>
				<a href="${base}/search/s/维修保养" target="_blank">维修保养</a>
				<a href="${base}/search/s/配件" target="_blank">配件</a>
				<a href="${base}/search/s/机油" target="_blank">机油</a>
			</div>
		</div>
		<!--search end-->
		...
		<div id="nav">
			<div id="categorys">
				...
				<div id="_ALLSORT" class="mc" >
    				...
    				<#if grandfather_index==2><#break></#if>
					</#list>
					<div class="extra">
			...
			<ul id="navitems">
				<#list middlenavigationList as middlenavigation>
	               <li class="fore" id="nav-home"><a href="${base}/${middlenavigation.url}">${middlenavigation.name}</a></li>
	            </#list>
			</ul><!--navitems end-->
		</div><!--nav end-->
	</div>
