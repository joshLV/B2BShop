...
<style>
    ...
    .processNav {MARGIN:0px; BACKGROUND: #fff; FLOAT: left; COLOR: #404040; FONT-WEIGHT: 700;/*margin-bottom: 30px*/}
    ...
    .processNav .step1 {Z-INDEX: 3; WIDTH: 400px}
    .processNav .step2 {Z-INDEX: 2; WIDTH: 400px}
    .processNav .step3 {Z-INDEX: 1; WIDTH: 400px}
    ...
    .mc{/*padding:0 30px 20px 20px;*//*border:solid #dddddd;border-width:0px 1px 1px; */ margin-top:20px; margin-bottom: 30px;}
    ...
    .btn {width: 250px;height: 36px;color: #ffffff;font-size:15px;font-weight: 800;overflow: hidden; background: #86c226; border: none; border-radius: 3px; margin-left: 40px;}
    .btn:hover{background: #86c226}
    .refund-form{border: 1px solid #E8E8E8; border-top: 2px solid #86c226; padding-top: 30px; padding-bottom: 30px; background: #ffffff;}
    .error{color:red;}
</style>
