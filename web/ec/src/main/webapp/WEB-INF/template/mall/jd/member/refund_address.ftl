...
<style>
    ...
    .text {width: 220px;height: 10px;padding: 10px 25px 10px 5px;border: 1px solid #cccccc;float: none;font-size: 14px;font-family: arial,"宋体";color: #999;}
    .btn {display: border: 0 none;font-size: 20px;font-weight:bold;text-align: center;color: #FF0000;}
    .btn {width: 210px;height: 36px;color: #000000;font-size:20px;font-weight: 800;overflow: hidden;}
    .error{color:red;}
</style>
<div class="content">
