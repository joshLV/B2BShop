...
<style>
    ...
    .hot-region-nav li.cur{none;padding:0; color:#ea5313; font-weight:bold; border-bottom:2px solid #ea5313; padding-top: 1px;height: 37px;}
    ...
    .products .price strong {display: inline-block;font-family: verdana;font-size: 12px;margin-right: 5px;line-height: 18px;overflow: hidden;vertical-align: middle;color: #ea5313;}
    ...
    .news-list li{overflow:hidden;height:24px;padding:0 0 0 5px;line-height:24px;/*background:url(${base}/static/mall/gdnz/img/dian.gif) 0 11px no-repeat;*/}
    .news-list li a:hover{ color: #ea5313; text-decoration: none;}
    ...
    .sy_login h1 {width: 100%; text-align: center;font-size:16px; padding:2px 0 10px 0;color:#ea5313; font-weight:bold;}
    ...
    .i_uname{ background:#fff url(${base}/static/mall/gdnz/img/i_uname.gif) 7px 6px no-repeat;}
    .i_upass{ background:#fff url(${base}/static/mall/gdnz/img/i_upass.gif) 7px 6px no-repeat;}
    ...
    .sy_sub{ width:85px; height:28px; background:url(${base}/static/mall/gdnz/img/dl.gif) no-repeat; cursor:pointer; border:none;}
    ...
    .sy_login h3 a.hai{ color: #ea5313;font-size: 15px;}
    ...
    .user_qk a:hover{ text-decoration:none;color: #ea5313; }
    .user_qk a strong{height: 18px;display: block;
        font-size: 14px;
        color: #ea5313;   text-align: center;}
/*zyf  3-24*/
  ...
  .slide-bottom{ position: absolute; z-index: 90;
        height: 3px;
        left: 0;
        right: 0;
        top: 447px;background:url(${base}/static/mall/gdnz/img/bg_topslide.png) left bottom repeat-x;}
    ...
    <div class="w11210">
			...
			<li><a href="${base}/play/${notice.id}.html" target="_blank"><strong><span <#if notice.isTop==1>style="color:red;"</#if>><b>${notice.title}</b></span></strong></a></li>
                ...
                <div class="sy_login" id="login">
                    <h1>会员登录</h1>
                    <div class="user_img">
                        <img src="${base}/static/mall/gdnz/img/user_img.jpg">
                        <p>hi! 你好<br>欢迎来到 58百亩园</p>
                    </div>
                ...
                <div class="sy_login" id="loginAfter" style="margin-bottom: 0;">
                    <div class="user_img" style="height: 80px;">
                      <img src="${base}/static/mall/gdnz/img/user_img.jpg" style="margin-top:10px;">

                        <p> <a class="hai" id="lg_nickeName" style="color: #ea5313; font-weight: bold;"></a><br>欢迎来到 58百亩园<br>
