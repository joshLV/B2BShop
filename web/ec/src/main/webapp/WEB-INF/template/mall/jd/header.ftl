...
#search {float: left;width: 610px;padding: 4px 86px 0 0}
.widepage #search .i-search {width: 594px !important;}
...
#navitems li a {width: auto;text-align: center;color: #fff;font: 700 15px/40px "microsoft yahei";text-decoration: none; display:block;}
