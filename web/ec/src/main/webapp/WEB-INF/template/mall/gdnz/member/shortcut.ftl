...
<div id="shortcut">
	<div class="content">
		<ul class="fl lh">
			<li class="favorite ld" ><b></b><a href="javascript:addToFavorite()" rel="sidebar" title="<@spring.message "project_short_name"/>">收藏<@spring.message "project_short_name"/></a></li>
		</ul>
		<ul class="fr lh">
			<li id="loginInfo"><span id="welcome">您好！欢迎来到<@spring.message "project_name"/>！</span><a href="${base}/mall/member/login">[登录]</a>&nbsp;<a href="${base}/mall/member/register">[免费注册]</a></li>
			<li class="ld">
				<s></s>
				<a href="${base}/order/list">我的asdfsdf订单</a>
			</li>
