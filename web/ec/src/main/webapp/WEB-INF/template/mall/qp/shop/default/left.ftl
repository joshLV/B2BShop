...
.shopInfo .mt{width:100%;padding-top:5px;text-align:center;}
.shopInfo .mt .h2{margin-bottom:5px;}
...
.catelog .mc .twoLevel, .catelog .mc .noChild {font-size: 14px;height: 30px;line-height: 30px;overflow: hidden;clear: both;border-bottom: solid 1px #ddd;background: #f7f7f7;cursor: default;}
...
.catelog .mc .threeLevel li {height: 24px;line-height: 24px;overflow: hidden;}
.catelog .mc .threeLevel a {display: block;padding: 0 10px 0 46px;}
</style>
<div class="catelog m">
	<div class="mc">
		<div class="oneLevel">
			<a href="javascript:void(0);">查看店内所有商品</a>
		</div>
