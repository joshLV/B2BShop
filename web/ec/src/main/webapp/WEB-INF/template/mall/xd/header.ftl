...
/**汽配城显示3个分类样式重写**/
#categorys .item {background:url(${base}/static/mall/xd/img/bg.png) left bottom repeat-x;}
...
#categorys .fatheritem2 {height: 90px;
    ...
    '#90000000',endColorstr = '#90000000');background:url(${base}/static/mall/xd/img/bg.png) left bottom repeat-x;}
#categorys .fatheritem3 {height: 90px;background:url(${base}/static/mall/xd/img/bg.png) left bottom repeat-x;}
#categorys .fatheritem4 {height: 90px;background:url(${base}/static/mall/xd/img/bg.png) left bottom repeat-x;border-bottom:0;}
...
<body class="widepage">
<div id="headerDiv">
	<div class="content" id="header" style="width: 1280px;">
		<div id="logo" class="ld">
			<a href="${base}/index"><b></b><img src="${base}/static/mall/xd/img/logo.png" alt="<@spring.message "project_name"/>"></a>
		</div><!--logo end-->
		<div id="search">
...
<script type="text/javascript" src="${base}/static/mall/xd/js/allSort_head.js"></script>
