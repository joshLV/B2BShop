...
#leftMenu .mc{border:solid #E6E6E6;border-width:1px 1px 1px;overflow:hidden; border-top: 2px solid #ea5313;}
#leftMenu dl dt{position:relative;margin-bottom:-1px;height:35px;padding:0 12px;font-weight:bold;line-height:35px;cursor:pointer;color:#333333;background-color:#F9F9F9}
#leftMenu dl dt b{display:block;position:absolute;top:12px;left:170px;width:9px;height:5px;background:url(${base}/static/mall/img/left.png) -64px 0;font-size:0;line-height:0;overflow:hidden}
...
#leftMenu dd .item{padding:2px 0 2px 24px; height: 35px; line-height: 35px;}
#leftMenu dd .item:hover{background: #f7f7f7; border-left: 4px solid #ea5313;}
#leftMenu dd .curr{font-weight:bold;}
#leftMenu dl dd a:link,#leftMenu dl dd a:visited{color:#333333}
#leftMenu dl dd a:hover{color:#ea5313}
