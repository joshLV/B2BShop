...
#register .error{color:#e4393c;line-height:36px;height:36px;position:absolute;top:0px;right:-275px;width:230px;padding:0 5px;background:url(${base}/static/mall/xd/img/register-tsbg.png) no-repeat; padding-left: 30px;}
...
<#include "mall/xd/member/header.ftl"/>
		...
		<div class="form">
            ...
            <div class="item item-new">
                ...
                <div class="fl item-ifo">
                    ...
                    <label for="protocol">我已阅读并同意<a href="${base}/html/xd/protocol.html" class="blue" id="protocol">《会员注册协议》</a></label>
                    <span class="clr"></span>
...
<script src="${base}/static/mall/xd/js/jdValidate.js" type="text/javascript"></script>
