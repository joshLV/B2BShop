...
#succeed .btn-pay,#succeed .btn-continue,#succeed .btn-append{background:#ccc url(${base}/static/mall/img/cart.png) no-repeat;line-height:100px;overflow:hidden;display:block;}
