...
<style>
#login {width: 890px;background: #e8e8e8;-moz-border-radius: 3px;-webkit-border-radius: 3px;border-radius: 3px;padding: 5px;margin: 30px auto 25px;position: relative;}
...
.form .item {height: 64px;line-height: 26px;overflow: visible;position: relative;width: 320px;z-index: 1; margin-top: 15px;}
...
#login .btn-entry:hover {background: #ed4548;}
#login .btn-entry {width: 307px;height: 34px;font-family: "微软雅黑";line-height: 34px;/*text-indent: -9999px;*/background: #ea5313;overflow: hidden; color: #ffffff; font-size: 16px; border-radius: 3px;}
...
<div id="login">
	<div class="mc">
		<div id="bg" style="width: 511px; height: 355px; position: absolute;">
	    	<img width="511" height="355" src="${base}/static/mall/gdnz/img/member_login.jpg">
	    </div>
	    <div class="form">
	    	<div class="title">
	    		<strong>会员登录</strong>
...
<script type="text/javascript" src="${base}/static/mall/js/jquery.cookie.js"></script>
<script type="text/javascript">
