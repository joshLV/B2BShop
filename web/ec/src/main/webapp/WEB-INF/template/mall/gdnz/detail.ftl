...
<style>
    ...
    /*jqzoom*/
    .jqzoom{ width:420px; height:360px; /*border:1px solid #e6e6e6;*/ position:relative;overflow:hidden; background: url("${base}/static/mall/gwq/img/default_img.jpg") no-repeat center;}
            ...
            <div id="preview">
                ...
                <div id="spec-n1" class="jqzoom"><!-- onclick="window.open('${firstImg.pic}')" -->
                    <img data-img="1" width="350" height="350" class="cloudzoom" style="border: 1px solid #ddd"
                         ...
                         alt="${firstImg.title}"
                         jqimg="${firstImg.pic}@350w_350h.png"/>
                </div>
                </a>
                <#else>
                ...
                <div id="spec-n5">
                    ...
                    <div id="spec-list" style="margin-top: 5px">
                        <ul class="list-h" style="width: 180px; overflow: hidden;">
                            <#list goodsImagesList?sort_by("orderNo") as img>
                                <li><img alt="${img.title}" src="${img.pic}@350w_350h"></li>
                            </#list>
                        </ul>
                    </div>
