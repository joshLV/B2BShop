...
<head>
    ...
    <link href="${base}/static/mall/gdnz/img/touchicon.png" rel="apple-touch-icon" />
...
<#include "mall/gdnz/slide.ftl"/>
<!--品牌旗舰店-->
<#include "mall/gdnz/index_shop.ftl"/>
<!--楼层展示-->
<#include "mall/gdnz/floor.ftl"/>
<!--知识区域-->
<#include "mall/gdnz/index_article.ftl"/>
