...
<style>
/*brandlist*/
.brandlist{width:1190px !important; background: #fef1eb; padding:5px 10px 0 10px; margin-top: 10px; margin-bottom: 10px; overflow: hidden;}
.brandlist .mt{position:relative;height:40px;}
.brandlist .mt h2{width:1180px;height:40px;line-height:40px;font-size:20px;font-weight:normal; color:#ea5313; text-align: center; float: left; padding-left: 10px;}
...
<div class="content">
    <div class="brandlist">
        <div class="mt">
            <h2>厂家专区<a href="${base}/brandFlagshipStore.html" target="_blank">更多&gt;</a></h2>
        </div>
        <div class="mc" style="display: block;">
			<ul>
				<#list indexShopList as indexShop>
				<li class="fore${brand_index}">
                    <a href="${base}/shop/${indexShop.urlAddress}.html?pageSize=20" title="${indexShop.name}" target="_blank"><img src="${indexShop.pic}" alt="${indexShop.name}@225w_100h.png"></a>
                </li>
