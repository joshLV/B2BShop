...
#khfw.hover .dd div {padding-left: 6px;line-height: 22px}
	...
	.tlogo{width:144px; height:24px; float: left; margin-top: 3px;}
...
<div id="shortcut">
	<div class="content">
		...
		<div style="float: right;">
            <div class="tlogo"> <img src="${base}/static/mall/jp/img/tlogo.png" width="144" height="24"> </div>
		<ul class="fr lh">
			<li id="offline">
			...
			<li class="ld">
				<s></s>
				<a href="${base}/order/list" style="color: #E4393C;font-weight:bold;">我的订单</a>
			</li>
			<#--<li class="ld menu" id="khfw" data-widget="dropdown">
				<s></s>
				<span class="outline"></span>
				<span class="blank"></span>
				<font style="color: #E4393C; font-weight:bold;">客户服务</font>
				<b></b>
				<div class="dd">
