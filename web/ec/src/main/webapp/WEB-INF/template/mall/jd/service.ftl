<#escape x as x?html>
<style>
	.service{width: 100% !important; border-top: 2px solid #e4393c; background: #F1F1F1; overflow: hidden; height: auto; }
#service dl b {background-image: url(${base}/static/mall/img/shortcut_bg.png);background-repeat: no-repeat}
#service {padding: 10px 20px;  width: 1210px; margin: 0 auto; padding-bottom: 20px;}
