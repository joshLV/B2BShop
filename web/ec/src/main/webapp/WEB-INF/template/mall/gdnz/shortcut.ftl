...
#shortcut {width: 100%;border-bottom: 1px solid #eee;line-height: 34px; height: 34px;}

#shortcut li {height: 34px;padding: 0 11px 0 12px}
...
#khfw.hover .dd div {padding-left: 6px;line-height: 22px}
	...
	.tlogo{width:144px; height:24px; float: left; margin-top: 5px;}

</style>
<div id="shortcut">
	<div class="content">
		<ul class="fl lh">
			<li class="favorite ld" ><b></b><a href="javascript:void(0);" onclick="addToFavorite();" rel="sidebar" title="<@spring.message "project_short_name"/>">收藏<@spring.message "project_short_name"/></a></li>
		</ul>
		<div style="float: right;">
            <div class="tlogo"> <img src="${base}/static/mall/gdnz/img/tlogo.png" width="144" height="24"> </div>
		<ul class="fr lh">
			<li id="offline">
				<span id="welcome">您好</span>！
				<!--<span id="useroff"></span>-->
				欢迎来到<@spring.message "project_name"/>！
				<a href="javascript:login();">[登录]</a>&nbsp;
				<a href="javascript:regist();">[免费注册]</a></li>
			<li id="online" style="display:none;">
				<span id="welcome">您好</span>
				<span id="userline"></span>！
				欢迎来到<@spring.message "project_name"/>！
				</span><a href="${base}/member/logout">[退出]</a></li>
			<li class="ld">
				<s></s>
				<a href="${base}/order/list" style="color: #ea5313;font-weight:bold;">我的订单</a>
			</li>
			<#--<li class="ld menu" id="khfw" data-widget="dropdown">
				<s></s>
				<span class="outline"></span>
				<span class="blank"></span>
				<font style="color: #ea5313; font-weight:bold;">客户服务</font>
				<b></b>
				<div class="dd">
