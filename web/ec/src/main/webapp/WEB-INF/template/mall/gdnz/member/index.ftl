...
.nocont-box b {display: inline-block;vertical-align: middle;background: url(${base}/static/mall/img/nocont-icons.png) no-repeat;overflow: hidden;margin-right: 20px;}
	.points{color: #ea5313; width: 120px; text-align: center; font-size:30px; font-family: arial; margin-top:5px;}
</style>
...
<style>
    ...
    /* 支付 */
    .btn{display: block; width: 76px; height: 24px; line-height: 24px; background: #ea5313;border-radius: 3px;color: #ffffff !important; margin-left:52px;}
...
<div class="content">
	...
	<div class="right">
		...
		<#include "mall/gdnz/member/index_order.ftl"/>
	    <div class="clr"></div>
	</div><!--right end-->
</div>
