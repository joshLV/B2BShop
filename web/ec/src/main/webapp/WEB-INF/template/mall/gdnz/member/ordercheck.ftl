...
<script src="${base}/static/assets/jquery/jquery.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="${base}/static/mall/gdnz/js/Validform_v5.3.2.js"></script>
...
.checkout-steps .step-current {margin:-1px; border:1px solid #e02d2d; position:relative; margin-top: 2px;}
...
.checkout-buttons .checkout-submit b{position:absolute;left:0;top:0;width:135px;height:36px;background:#ea5313;cursor:pointer;overflow:hidden; border-radius: 3px;}
...
.checkout-buttons .checkout-submit-disabled b{position:absolute;left:0;top:0;width:135px;height:36px;background:#ea5313;cursor:not-allowed; border-radius: 3px;}
.checkout-buttons .total {padding-right: 18px;float: right;line-height: 50px;font-size: 14px;font-weight: 700;}
.checkout-buttons .total strong {color: #ea5313;font-size: 20px;vertical-align: middle;font-weight: normal;}
...
#order-cart .review-thead {width:100%;  border-top:2px solid #ea5313;  border-right:1px solid #e8e8e8; border-left:1px solid #e8e8e8; }
...
.order-summary .statistic em {color: #ea5313;}
...
#order-cart .p-detail .p-tip {width:60px; float:left; color:#ea5313;}
...
#consignee .message .error,.invoice-form .error{height:26px;padding-left:6px;float:left;color:#ea5313;line-height:26px}
...
/*收货地址*/
.del_adr{background: url(${base}/static/mall/gdnz/img/ico_01.png) no-repeat;}
.mod_address_book .adr_list .li_add_addr .btn_add_addr i{    background: url(${base}/static/mall/gdnz/img/ico_01.png) no-repeat;}
...
.membercenter_pop i,
.pop_close {background:url(${base}/static/mall/gdnz/img/ico_address.png) no-repeat;}
...
/*******弹出层 common********/
#popupdiv{width:698px;height:420px;position:fixed;z-index:1000; background:#fff; }
.pop_win { width: 700px; background-color: #fff;   line-height: 1.5; color: #666; margin-top:0; }
.title_div { background-color: #ea5313; color: #fff; font-size: 14px; font-weight: bold; width:100%; line-height: 35px; float:left;}
...
.Validform_right{
    color:#71b83d;
    padding-left:20px;
    background:url(${base}/static/mall/gdnz/img/right.png) no-repeat left center;
}
.Validform_wrong{
    color:red;
    /*padding-left:20px;*/
    white-space:nowrap;
    /*background:url(${base}/static/mall/gdnz/img/error.png) no-repeat left center;*/
}
.Validform_loading{
    padding-left:20px;
    background:url(${base}/static/mall/gdnz/img/onLoad.gif) no-repeat left center;
}
.Validform_error{
