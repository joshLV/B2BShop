    ...
    <div class="m" id="orderlist">
        <div class="mc">
            <div class="tb-order">
                ...
                <#list distinctOrderList as distinctOrder>
                    <tr class="tr-th">
                        <td colspan="9">
                                        <span class="tcol1">
                                        订单编号:
                                        <a name="orderIdLinks" id="idUrl${distinctOrder.orderSn}" target="_blank"
                                           href="${base}/orderRejected/listRejected/${distinctOrder.id}.html">${distinctOrder.orderSn}</a>
                                        </span>
                        </td>
                    </tr>
                    <#list goodsRejectedList as goodsRejected>
                        <#if distinctOrder.orderSn==goodsRejected.orderSn>
                        <#list orderList as order>
                            <#if goodsRejected.rejectedSn==order.rejectedSn>
                                <tr class="tr-th">
                                    <td colspan="9">
                                    <span class="tcol1">
                                        退货单号:
                                        ${goodsRejected.rejectedSn}
                                        <#--订单编号:-->
                                ...
                                <#list orderItemList as orderitem>
                                    <#--<#list orderItemList as orderitem>-->
                                    <#if goodsRejected.rejectedSn == orderitem.rejectedSn>
                                        <tr id="track${order.id}" oty="0,4" class="tr-td">
                                            <td>
                                                <div class="img-list" style="width: 128px;">
                                                    <#--${order.orderSn} == ${orderitem.orderSn}-->
                                            ...
                                            <td id="operate${order.orderSn}" class="order-doi" width="100">
                                                ...
                                                <#elseif orderitem.rejectedStatus=="businessApproveFail" || orderitem.rejectedStatus=="mallApproveFail" || orderitem.rejectedStatus=="businessApproveFail_done" || orderitem.rejectedStatus=="mallApproveFail_done">
                                                    <a class="btn btn-4" style="background: #DDD none repeat scroll 0% 0%" href=""><s></s>审批失败</a>
                                                    <#if orderitem.rejectedStatus=="businessApproveFail_done" || orderitem.rejectedStatus=="mallApproveFail_done">
                                                        已过期
                                                    <#else>
