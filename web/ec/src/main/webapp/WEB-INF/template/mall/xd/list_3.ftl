...
<head>
    ...
    <#--右側上部頁碼-->
        ...
        .showattention{ padding-top:5px; padding-bottom:5px; color: #DB0000 !important; padding-left:35px; padding-right: 15px; border: 1px solid #DB0000; /*text-decoration: underline;*/ background: url(${base}/static/mall/xd/img/search.ele.png) no-repeat 10px -430px;}
        ...
        .list-more i{width: 18px; height: 7px; margin-top: 6px; margin-left: 3px;  background: url(${base}/static/mall/xd/img/search.ele.png) no-repeat; float: left;}
        .list-less{float: left; border: 1px solid #E8E8E8; padding:3px 6px 3px 10px;}
        .list-less a{display: block; float: left;}
        .list-less i{width: 18px; height: 7px; margin-top: 6px; margin-left: 3px;  background: url(${base}/static/mall/xd/img/search.ele.png) no-repeat 0 -34px; float: left;}
...
<div class="content m">
	<div class="left">
        ...
        <div class="left" style="float: left">
            ...
            <div class="m m2" style="border: 1px solid #dfdfdf; border-top: 0;">
                <div class="mt" style="border: 0;border-top: 2px solid #E4393C;">
                    <h2>大家还买了</h2>
                </div>
            <#list goodsFirstList as gl>
            <div class="kyk">
                <a target="_blank" href="${base}/item/${gl.id}.html">
                    <img width="192" height="192" alt="${gl.fullName}" data-img="1" class="err-product" src="${gl.pic}" title="${gl.fullName}"/>
                </a>
                <a target="_blank" href="${base}/item/${gl.id}.html" title="${gl.fullName}">${gl.name}<font style="color: #ff0000;" name="${gl.id}" class="adwords"></font></a>
                <#if gl.price == '0'>
...
<#include "mall/xd/spfl.ftl"/>
<#include "mall/xd/service.ftl"/>
<#include "mall/xd/footer.ftl"/>

<link rel="stylesheet" type="text/css" href="${base}/static/mall/xd/css/jydz.css">
