...
<style>
    ...
    .processNav .extra {BACKGROUND: url(${base}/static/mall/nsc/img/cartscbgv.png) no-repeat 0px 0px}
    ...
    .processNav .step1 {Z-INDEX: 3; WIDTH: 390px}
    .processNav .step2 {Z-INDEX: 2; WIDTH: 390px}
    .processNav .step3 {Z-INDEX: 1; WIDTH: 390px}
    .processNav .on {BACKGROUND: #2e970f; COLOR: #fff}
    ...
    .form {width: 1010px;overflow: hidden;margin: 0 auto;padding-left: 100px;}
    .btn-entry {width: 68px;height: 25px;line-height: 25px;background: url(${base}/static/mall/nsc/img/bg-btn-entry.jpg) no-repeat;font-size: 14px;font-weight: bold;}
    .item {padding-top: 5px;height: 55px;line-height: 26px;}
    .label {width: 140px;text-align: right;font-size: 14px;float: left;}

    .mc{padding:30px 0 20px;border:solid #dddddd;border-width:1px 1px 1px; }
    .select {width:600px;height: 25px;border: 1px solid #cccccc;float: none;font-size: 14px;font-family: arial,"宋体";color: #999;}
    .text {width:570px;height: 40px;padding: 10px 25px 10px 5px;border: 1px solid #cccccc;float: none;font-size: 14px;font-family: arial,"宋体";color: #999; overflow: hidden;}
     .btn {display: border: 0 none;font-size: 20px;font-weight: bold;text-align: center;color: #FF0000;}
     .btn {width: 600px;height: 36px;color: #000000;font-size:20px;font-weight: 800;overflow: hidden; margin-left: 35px;}
    ...
    <form id="myform" action="">
        ...
        <input type="hidden" name="amount" value="${order.totalAmount}"/>
            <div class="form" id="a">
                ...
                <div class="item" id="img"style="height:150px">
                    <span class="label">预览图：</span>
                    <div class="fl" >
                        <img id="image" width="200" height="150"   onLoad="onLoadImage()"/>
                        <img id="image2" width="200" height="150"   onLoad="onLoadImage()"/>
                        <img id="image3" width="200" height="150"   onLoad="onLoadImage()"/>
                        <span class="clr"></span>
                    </div>
                </div>
                ...
                <div class="item" style="padding-left: 100px;padding-right: 100px; padding-top: 20px;">
