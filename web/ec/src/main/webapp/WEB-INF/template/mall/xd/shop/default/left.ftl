...
.shopInfo .mt h2{ line-height: 43px; height:45px; font-size: 15px; color: #444; margin-bottom:15px;background:url("${base}/static/mall/xd/img/dp_bg.gif") left top repeat-x; overflow: hidden;}
