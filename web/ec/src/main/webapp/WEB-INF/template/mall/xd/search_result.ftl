                ...
                <li index="0" sku="${gl.id}" selfservice="0">
                    <div class="lh-wrap">
                        <div class="p-img">
                            ...
                            <img width="218" height="218" alt="${gl.name}" data-img="1" class="err-product" src="${gl.pic}@218w_218h.png" title="${gl.name}"></a>
                        </div>
                        <div class="p-name">
	...
	<div class="m clearfix">
	    <div class="pagin fr">
 			<#if (pager.list?size > 0)>
 				...
 				<@p.pager pager = pager baseUrl = "/search/s/${keyword}?order=${order}" />
 			<#else>
			<div class="noRecord">
                    <#--尚未发布任何信息!-->
			</div>
