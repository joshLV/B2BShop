...
<script src="${base}/static/assets/jquery/jquery.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="${base}/static/mall/xd/js/Validform_v5.3.2.js"></script>
...
/*收货地址*/
.del_adr{background: url(${base}/static/mall/xd/img/ico_01.png) no-repeat;}
.mod_address_book .adr_list .li_add_addr .btn_add_addr i{    background: url(${base}/static/mall/xd/img/ico_01.png) no-repeat;}
...
.membercenter_pop i,
.pop_close {background:url(${base}/static/mall/xd/img/ico_address.png) no-repeat;}
...
.Validform_right{
    color:#71b83d;
    padding-left:20px;
    background:url(${base}/static/mall/xd/img/right.png) no-repeat left center;
}
.Validform_wrong{
    color:red;
    /*padding-left:20px;*/
    white-space:nowrap;
    /*background:url(${base}/static/mall/xd/img/error.png) no-repeat left center;*/
}
.Validform_loading{
    padding-left:20px;
    background:url(${base}/static/mall/xd/img/onLoad.gif) no-repeat left center;
}
.Validform_error{
												...
												<tbody>
													<tr >
														...
														<td class="p-promotion">
                                                            ...
                                                            <li>等级优惠：${(cartItem.price?number * memberRankScale?number)?string('currency')}</li>
                                                            </ul>
                                                        </td>
