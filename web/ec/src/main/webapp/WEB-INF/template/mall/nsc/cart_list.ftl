...
<style>
    ...
    .cart h2 {height: 20px;margin-bottom: 15px;line-height: 100px;overflow: hidden;background: url(${base}/static/mall/img/cart_title.png) no-repeat left top;}
    ...
    .cart-thead .t-goods {width: 309px;}
    ...
    .cart-tbody .p-goods {width: 359px;overflow:hidden;}
    ...
    .cart-button a.checkout {width: 135px;height: 36px;float: right;display: block;overflow: hidden;line-height: 100px;background: url(${base}/static/mall/nsc/img/btn_check.png) no-repeat #7abd54;font-family: "\5FAE\8F6F\96C5\9ED1";font-size: 18px;font-weight: bold;line-height: 32px;_line-height: 36px;text-indent: 33px;color:#fff;position: relative;}
    .cart-button a.checkout:hover{background-position:0 -36px;box-shadow:0 1px 1px rgba(0,1,1,0.3);background-color:#7abd54;text-decoration: none;}
    .cart-button a.checkout b{position: absolute;left: 0;top: 0;width: 100%;height: 100%;background: url(${base}/static/mall/nsc/img/btn-check.png) no-repeat;}
...
<div class="content m header clearfix">
    <div id="logo">
        <a href="${base}"><img src="${base}/static/mall/nsc/img/logo.png" title="返回商城首页" alt="返回商城首页"></a>
    </div><!--logo end-->
    ...
    <div id="show" style="display:none;">
        ...
        <div class="cart-inner" id ="cartinner">
            <div class="cart-thead clearfix">
                ...
                <div class="column t-inventory">&nbsp;</div>
				...
				<#list cartItemList as cartItem>
                    ...
                    <div id="product_${cartItem.id}" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            <div class="cell p-checkbox"><input class="checkbox" type="checkbox" name="cartId" value="${cartItem.id}"></div>
                            ...
                            <div class="cell p-price"><span class="price">¥${cartItem.price}</span></div>
                            ...
                            <div class="cell p-remove"><a id="remove-${cartItem.id}" data-name="${cartItem.name}" class="cart-remove" onclick="javascript:del('${cartItem.id}','${cartItem.price}');" href="javascript:void(0);">删除</a>
                            </div>
                        </div>
            ...
            <div class="cart-toolbar clearfix">
                ...
                <div class="total fr">
                    <p><span id="totalSkuPrice">¥<span id ="totalPrice1">${totalPrice}</span></span>总计：</p>
                    <p><span id="totalRePrice">- ¥0.00</span>折扣：</p>
                </div>
                <div class="amout fr"><span id="selectedCount">${total}</span> 件商品</div>
            </div><!-- cart-toolbar end -->
            <div class="cart-total clearfix">
                <div class="total fr"><span id="finalPrice" data-bind="360.80">¥<span id ="totalPrice2">${totalPrice}</span></span>总计（不含运费）：</div>
            </div><!-- cart-total end -->
        </div><!-- cart-inner end -->

        <div class="cart-button clearfix">
            <a class="btn continue" href="${(backurl)!"${base}"}" id="continue"><span class="btn-text">继续购物</span></a>
            <a class="checkout" id="toSettlement">去结算<b></b></a>
...
<script type="text/javascript">
    ...
    function del(cartItemid,cartItemPrice) {
        clickAllow = "false";
        var buyNum = $('#'+cartItemid);
        var buyCount = $('#selectedCount');
        var buyPrice1 = $('#totalPrice1');
