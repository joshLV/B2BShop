...
<style>
    ...
    #login .btn-entry {width: 307px;height: 34px;font-family: "微软雅黑";line-height: 34px;/*text-indent: -9999px;*/background: #86c226;overflow: hidden; color: #ffffff; font-size: 16px; border-radius: 3px;}
    ...
    <div id="login">
        <div class="mc">
            <div id="bg" style="width: 511px; height: 355px; position: absolute; border-right: 1px solid #E8E8E8;">
                <img width="511" height="355" src="${base}/static/mall/gwq/img/member_login.jpg">
            </div>
            <div class="form">
                <div class="title">
                    <strong>会员登录</strong>
                ...
                <div class="item" id="autoentry">
                    <div class="item-ifo">
                        ...
                        <label class="mar"><a href="${base}/findPwd">忘记密码?</a></label>
                        <div class="clr"></div>
                    </div>
                </div>
