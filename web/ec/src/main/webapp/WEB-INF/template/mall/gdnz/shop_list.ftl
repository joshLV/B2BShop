...
<head>
    ...
    <title>县城商家</title>
    <meta name="description" content="县城商家">
    <meta name="Keywords" content="县城商家">
...
<div class="brands-content">
    <h3 class="link_tit">县城商家</h3>
    <div class="nch-brand-list">
        <ul>
        <#list list as indexShop>
            <li>
                <dl>
                    <dt>
                        <a href="${base}/shop/${indexShop.urlAddress}.html" title="${indexShop.shopName}" target="_blank" >
                            <img src="${indexShop.pic}" alt="${indexShop.name}" style="width: 300px;height: 500px;">
                        </a>
                    </dt>
                    <dd >
