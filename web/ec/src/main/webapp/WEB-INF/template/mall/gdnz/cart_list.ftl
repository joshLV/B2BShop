...
.cart .cart-hd h2 {width: 100px;float: left; /*border-bottom: 2px solid #ea5313;*/ font-size: 16px; margin-top: 5px;  font-weight: normal;}
...
.cart-inner {border: 1px solid #ddd;border-top:2px solid #ea5313;}
...
.cart-empty {height: 98px;border: 1px solid #ddd;border-top: 2px solid #ea5313;}
...
.cart-toolbar .amout span {color: #ea5313;font-family: Verdana,Arial;}
...
.cart-total .total span {float: right;color: #ea5313;font-size: 20px;font-weight: 400;font-family: Verdana,Arial;}
...
a:hover {color: #ea5313;text-decoration: underline;}
...
.cart-button a.checkout b{position: absolute;left: 0;top: 0;width: 100%;height: 100%;/*background: url(${base}/static/mall/img/btn-check.jpg) no-repeat;*/ background: #ea5313; border-radius: 3px; color: #ffffff;}
...
<div class="content m header clearfix">
	<div id="logo">
		<a href="${base}/index"><img src="${base}/static/mall/gdnz/img/logo.png" title="返回商城首页" alt="返回商城首页"></a>
	</div><!--logo end-->
...
<div class="content cart">
	<div class="cart-hd">
		<img src="/ec/static/mall/gdnz/img/shop_cart.png"> <h2>我的购物车</h2>
	...
	<div id="show" style="display:none;">
		...
		<div class="cart-inner" id ="cartinner">
		    <div class="cart-thead clearfix">
		        ...
		        <div class="column t-price">社员价</div>
