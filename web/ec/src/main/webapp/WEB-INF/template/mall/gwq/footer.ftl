...
<div class="content">
	<div id="footer">
		...
		<div class="copyright">
			陕ICP备11011220号&nbsp;&nbsp;<br>
			&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2013-2014&nbsp;&nbsp;通联支付网络服务股份有限公司&nbsp;&nbsp;版权所有<br>
		</div>
...
<!--div id="wchat">
	<img src="${base}/static/mall/gwq/img/qrcode.png" width="100" height="100" alt="机电商城" />
	<p>微信关注</p>
	<p>&nbsp;</p>
    <img src="${base}/static/mall/gwq/img/sjcode.png" width="100" height="100" alt="机电商城" />
    <p>手机客户端</p>
</div--><!--wchat end-->
</#escape>