...
.recommend .mt{height:40px;background:#f7f7f7; border-bottom: 2px solid #C30000;}
.recommend .mt h2{height:40px;padding-left:10px;font:normal 15px/40px \5fae\8f6f\96c5\9ed1;color:#c00000;}
...
.recommend .mc .item{width:212px;height:295px;}
.recommend .mc .item .pic {overflow:hidden;position: relative;}
.recommend .mc .item .pic img{width:212px;height:212px;}
...
.recommend .mc .item .goodsInfo {padding-right: 10px;text-align: left;}
...
.goodsList .mt{height:40px;background:#f7f7f7; border-bottom: 2px solid #C30000;}
.goodsList .mt h2{height:40px;padding-left:10px;font:normal 15px/40px \5fae\8f6f\96c5\9ed1;color:#c00000;}
.goodsList .mc{color: #666;height:auto;/*border-top:2px solid #C30000;*/ padding-top: 20px; padding-bottom: 10px;}
...
.goodsList .mc li{border: 1px solid #FFFFFF;background: none repeat scroll 0 0 #FFFFFF;float: left;overflow: hidden;padding: 8px;margin-left:10px;z-index: 1;border:solid 1px #ddd;}
