...
<header>
    <div class="top">
        <div>
<span style=" letter-spacing: 0;font-size: 13px;  padding-right: 10px;">客服电话：<em style="color: #e52c32; font-family: '微软雅黑', '宋体';font-size: 16px;  font-weight: normal;">400-829-8366</em></span>
            <span id="offline">
    ...
    <div class="f-cb navbar">
        <div class="logo"><a href="${base}/index" style="float:left;"><img src="${base}/static/mall/gwq/img/gwqlogo.jpg" width="200" height="100"></a></div>
