...
<style>
    ...
    #orderlist .mc {
        /*border-top:1px solid #e6e6e6; border-top:none; border-bottom:1px solid #e6e6e6;*/
    }

    #orderlist .tb-order {
        overflow: hidden; /*margin-right:-1px;margin-left:-1px;margin-bottom:-1px;*/
        width: 98%;
        margin-left: 1%;
        padding-top: 20px;
        margin-bottom: 10px;
        ...
        <div class="mc">
            <div class="tb-order">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <thead>
                    <tr>
                        <th width="150" style="text-align: center;">订单编号</th>
                        <th width="70">退款金额</th>
                ...
                success: function (data) {
                    if (data != null && data != "") {
                        ...
                        $.each(data, function (i, o) {
                            ...
                            var t="";
                            if(type == 'commit'){
                                t= "<strong>退款原因 :</strong> ";
                            }else if(type == 'confirmed'|| type == 'unrefund' || type == 'returned'){
                                t= "<strong>商家受理意见: </strong>";
                            }else if(type == 'refunded'){
                                t= "<strong>商城受理意见: </strong>";
                            }
                            if (i == 0) {
