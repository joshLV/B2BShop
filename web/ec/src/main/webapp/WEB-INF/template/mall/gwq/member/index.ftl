...
<style>
    .breadcrumb {height: 20px;padding: 10px 0 10px 10px;margin-bottom: 10px;overflow: hidden;/*line-height: 20px;*/vertical-align: baseline; border-bottom: 1px solid #E8E8E8;}
    .breadcrumb strong, .breadcrumb h1 {display: inline;font-weight: normal;/*line-height: 20px;*/font-size: 14px;font-family: "microsoft yahei"; color: #333333;}
    .main{border-left: 1px solid #E8E8E8; border-right: 1px solid #E8E8E8;}
    .left {float: left;width:195px;/*margin-right: 10px;*/ background: #ffffff;margin-bottom: -9999999px; padding-bottom: 9999999px; overflow: hidden; border-right: 1px solid #e8e8e8;}
    .right {float: right;width: 1024px; background: #ffffff; }

    .widepage .right {width: 1014px; border-left: 1px solid #E8E8E8; margin-bottom: -9999999px; padding-bottom: 9999999px; overflow: hidden;}
    .m{margin-bottom: 0;}
    /*user-info*/
    #user-info {overflow: hidden;background-color: #fff;padding: 10px 10px;/*border-bottom: 1px solid #E8E8E8;*/}
    ...
    #user-info .acco-info-2 li {/*background-color: #fafafa;*/border-right: 1px dotted #ddd;float: left;padding-top: 36px;height: 90px;width: 125px;text-align: left;line-height: 26px;}
    #user-info .acco-info-2 li.fore1 {width: 140px; text-align: center;}
    ...
    .points{color: #c00000; /*font-weight: bold;*/ font-size: 26px; margin-top: 5px;}

</style>
<style>
    /*order-list相关*/
    .mod-main {/*padding: 10px;*/background: #fff;margin-bottom: 10px;}
    .mod-main .mt {display: inline-block;display: block;padding: 10px 25px 10px 28px; /*border-bottom: 1px solid #E8E8E8;*/ background:#F9F9F9;}
    .mod-main .mt h3 {float: left;font-family: "microsoft yahei";font-size: 16px;color:#333333;line-height: 20px; font-weight: normal;}
    ...
    #order-list { /*border-bottom: 1px solid #E8E8E8;*/}
    #order-list .tb-order {height: 278px; margin-left: 15px; margin-right: 15px;}
    ...
    .tb-order .img-list a{display: block; width: 70px; height: 70px; float: left; background: url(${base}/static/mall/gwq/img/default_img.jpg) no-repeat center; background-size: 100%; border: 1px solid #E8E8E8;}
...
<div class="right">
    ...
    <div class="m" id="user-info">
        ...
        <ul class="acco-info-2">
            ...
            <li class="fore1">
                <div class="mt">
                <#--0.00<!--<a href="${base}/member/finance/recently.action" id="BalanceCount">0.00</a>&ndash;&gt;-->
                    <label>评论回复：</label><div class="points"><a href="${base}/order/review.html">${unreadGoodsReviewCount}</a></div>
                </div>
            <#--<label>11111111优惠券：</label>-->
            <#--0<!--<a href="${base}/member/quan" id="CouponCount">1</a>&ndash;&gt;-->
            </li>
    ...
    <#include "mall/gwq/member/index_order.ftl"/>
    <div class="clr"></div>
</div><!--right end-->
