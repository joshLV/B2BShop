...
<title>${articles.title}_<@spring.message "project_name"/></title>
<meta name="description" content="${articles.seoDescription}">
<meta name="Keywords" content="${articles.seoKeywords}">
