...
<style>
/*leftMenu*/
#leftMenu .mt{height:40px;padding:0 6px;background-color:#fff6f6;border-top:2px solid #e4393c;line-height:40px;color:#fff; border-left: 1px solid #E8E8E8;  border-bottom: 1px solid #E8E8E8; border-right: 1px solid #E8E8E8;}
#leftMenu .mt h2{float:left;background:none;padding-top:0;height:auto;line-height:40px;}
...
<link href="${base}/static/mall/xd/css/fix.css" rel="stylesheet" type="text/css" media="all"/>
