...
#login .item-ifo .i-name {background: url(${base}/static/mall/nsc/img/login-all-bg.png) no-repeat -373px -111px #fff;width: 16px;height: 16px;top: 8px;}
...
#login .succeed {background: url(${base}/static/mall/nsc/img/sucess.png) no-repeat #ffffff;}
#login .item-ifo .i-pass {background: url(${base}/static/mall/nsc/img/login-all-bg.png) no-repeat -346px -108px #fff;width: 14px;height: 19px;top: 8px;}
...
#login .btn-entry:hover {background: url(${base}/static/mall/nsc/img/login-all-bg.png) no-repeat 0 -95px;}
#login .btn-entry {width: 307px;height: 34px;font-family: "微软雅黑";line-height: 100px;text-indent: -9999px;background: url(${base}/static/mall/nsc/img/login-all-bg.png) no-repeat 0 -61px;overflow: hidden;}
...
<#include "${path}/member/header.ftl"/>
<div class="g-bd">
<form id="formlogin" method="post" >
<div id="login">
	<div class="mc">
		<div id="bg" style="width: 511px; height: 355px; position: absolute;">
	    	<img width="511" height="355" src="${base}/static/mall/nsc/img/member_login.png">
	    </div>
	    <div class="form">
	    	<div class="title">
	    		<strong>会员登录</strong>
