...
.checkout-steps .sbox {width:900px; overflow:hidden;}
...
.checkout-buttons .checkout-submit{background-color:#7abd54;position:relative;line-height:36px;overflow:hidden;color:#fff;font-weight:bold;font-size:16px;}
.checkout-buttons .checkout-submit b{position:absolute;left:0;top:0;width:135px;height:36px;background:url(${base}/static/mall/nsc/img/btn-submit.png) no-repeat;cursor:pointer;overflow:hidden;}
.checkout-buttons .checkout-submit:hover{background-color:#7abd54;}
...
#order-cart .order-table {width:900px;border-collapse: collapse;border-spacing: 0;}
