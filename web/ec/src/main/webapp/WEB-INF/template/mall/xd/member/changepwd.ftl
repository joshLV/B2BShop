...
.left {float: left;width: 195px;/*margin-right: 10px;*/margin-bottom: -9999999px; padding-bottom: 9999999px; border-right: 1px solid #E8E8E8; }
.right {float: right;width: 820px; margin-bottom: -9999999px; padding-bottom: 9999999px;}
