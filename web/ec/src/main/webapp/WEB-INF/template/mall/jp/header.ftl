...
#search .button {width: 78px;background: #ee2d30;font-size: 14px;font-weight: 700;color: #fff}
...
<style>
#nav {position: relative;z-index: 6;height: 40px;/*padding-left: 210px;margin-bottom: 10px;*/border-bottom:2px solid #E4393C;}
...
#navitems .curr,#navitems .hover {z-index: 1; color: #DB0000;}
...
#categorys .item .i-mc {display: none;position: absolute;left: 198px;top:0px;width: 705px;border: 2px solid #e4393c;background: #fff;overflow: visible;/*-moz-box-shadow: 0 0 10px #DDD;-webkit-box-shadow: 0 0 10px #DDD;box-shadow: 0 0 10px #DDD;*/}
...
#categorys .hover .con {border:2px solid #e4393c; border-right: none !important; border-left: none !important;/*border-width: 2px 0;*/background-color: #fff;overflow: hidden;/*-moz-box-shadow: 0 0 8px #DDD;-webkit-box-shadow: 0 0 8px #DDD;box-shadow: 0 0 8px #DDD;*/}
...
/**汽配城显示3个分类样式重写**/
#categorys .item {background:url(${base}/static/mall/jp/img/bg.png) left bottom repeat-x;}
...
#categorys .fatheritem2 {height: 90px;
    ...
    '#90000000',endColorstr = '#90000000');background:url(${base}/static/mall/jp/img/bg.png) left bottom repeat-x;}
#categorys .fatheritem3 {height: 90px;background:url(${base}/static/mall/jp/img/bg.png) left bottom repeat-x;}
#categorys .fatheritem4 {height: 90px;background:url(${base}/static/mall/jp/img/bg.png) left bottom repeat-x;border-bottom:0;}
...
.all_fl{float: left; line-height: 40px; width: 210px; background: #ee2d30; text-align: center; margin-top: 2px;}
...
<div id="headerDiv">
	<#--<#if topad??>-->
	<div class="content"><a href="${base}/static/shijing/index.html" target="_blank"><img src="${base}/static/mall/jp/img/banner_ad.jpg" width="1210" height="80" ></a></div>
	<#--</#if>-->
	<div class="content" id="header" style="width: 1210px;">
		<div id="logo" class="ld">
			<a href="${base}/index"><b></b><img src="${base}/static/mall/jp/img/logo.png" alt="<@spring.message "project_name"/>"></a>
		</div><!--logo end-->
		<div id="search">
...
<script type="text/javascript" src="${base}/static/mall/jp/js/allSort_head.js"></script>
