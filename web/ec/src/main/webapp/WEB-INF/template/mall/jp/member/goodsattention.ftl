...
<meta name="Keywords" content="我的关注">
            ...
            <div class="item">
                ...
                <li id="${goodsAttention.id}" order="0">
                	<div class="dity">
	                    <div class="mod">
	                        <div class="p-img">
	                            <a href="${base}/item/${goodsAttention.goodsId}.html" target="_blank"><img width="130" height="130" src="${goodsAttention.image}" class="err-product"></a>
	                        </div>
	                        <div class="i-it">
	                            ...
	                            <div class="p-price">
									...
									<font>
										<#if goodsAttention.price == '0.00'>
                                            价格面议
										<#else>
                                            ￥${goodsAttention.price}
										</#if>
									</font>
									<#if goodsAttention.marketPrice != '0.00'>
                                        <strong>市场价：</strong>
