<%@ page contentType="text/html; charset=UTF-8" language="java" pageEncoding="UTF-8"
         import="java.util.*,com.allinpay.ets.client.SecurityUtil,java.net.*,java.io.*,com.allinpay.ets.client.SecurityUtil,com.allinpay.ets.client.StringUtil,org.apache.commons.httpclient.methods.PostMethod,org.apache.commons.httpclient.*,com.allinpay.ets.client.PaymentResult"
         errorPage="" %>
...
//        out.print("responseCode=" + responseCode);
        response.getWriter().print("responseCode=" + responseCode);
...
<div style="padding-left:40px;">
    <div>订单是否成功：<%=isSuccess %>
    </div>
    <div>查询处理结果：<%=resultMsg %>
    </div>
    <div>订单详细信息：<br/>
