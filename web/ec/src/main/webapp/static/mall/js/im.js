		...
		'<div id="instantMessagingMain" class="instantMessagingMain">'+
			...
			'<div class="middle clearfix">'+
				'<dl>'+
					'<dt>在线客服</dt>'+
					'<dd>'+
						'<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1354670067&site=qq&menu=yes" >'+
							'<img src="http://wpa.qq.com/pa?p=2:1354670067:45" alt="客服QQ" align="absmiddle" /> 客服QQ'+
						'</a>'+
					'</dd>'+
					'<dd>'+
					'<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=171979920&site=qq&menu=yes">'+
						'<img src="http://wpa.qq.com/pa?p=2:171979920:45" alt="客服QQ" align="absmiddle" /> 客服QQ'+
					'</a>'+
				'</dd>'+
				'</dl>'+
			'</div>'+
