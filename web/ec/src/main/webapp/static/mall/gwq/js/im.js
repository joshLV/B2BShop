		...
		'<div id="instantMessagingMain" class="instantMessagingMain">'+
			...
			'<div class="middle clearfix">'+
				'<dl>'+
					'<dt>在线客服</dt>'+
					'<dd>'+
						'<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2133005439&site=qq&menu=yes" >'+
							'<img src="http://wpa.qq.com/pa?p=2:2133005439:45" alt="客服QQ" align="absmiddle" /> 客服QQ'+
						'</a>'+
					'</dd>'+
					'<dd>'+
					'<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2256190453&site=qq&menu=yes">'+
						'<img src="http://wpa.qq.com/pa?p=2:2256190453:45" alt="客服QQ" align="absmiddle" /> 客服QQ'+
					'</a>'+
				'</dd>'+
				'<dd>'+
					'<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=981917239&site=qq&menu=yes">'+
						'<img src="http://wpa.qq.com/pa?p=2:981917239:45" alt="客服QQ" align="absmiddle" /> 客服QQ'+
					'</a>'+
				'</dd>'+
				'<dd>'+
				'<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3356572530&site=qq&menu=yes">'+
				'<img src="http://wpa.qq.com/pa?p=2:3356572530:45" alt="客服QQ" align="absmiddle" /> 客服QQ'+
				'</a>'+
				'</dd>'+
				'</dl>'+
			'</div>'+
