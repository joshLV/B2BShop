(function ($) {
    ...
    var homePageTitle = "主页", homePageHref = null, navMenuList = "#navMenu_list",
        ...
        btnFullScreen = "#btnFullScreen", btnExit = "#btnExit", btnEditPassword = "#btnEditPassword";
    ...
    window.mainpage.loadMenu = function (id) {
        ...
        $.get(base+"admin/index/navmenu/"+id+"/data", function (menus) {
    ...
    window.mainpage.loadNavMenus = function (callback) {
        ...
        $.get(base+"admin/index/navmenu", function (menus) {
    ...
    window.mainpage.loadFavoMenus = function () {
        ...
        $(favoMenuTree).tree("load", base+"admin/index/favomenu/data");
    };
    ...
    window.mainpage.bindToolbarButtonEvent = function () {
        ...
        $(btnExit).click(function () {
            $.easyui.messager.confirm("操作提醒", "您确定要退出当前程序吗？", function (c) {
                if (c) { 
                	...
                	window.location.href=base+"admin/account/logout"; 
                }
            });
        });
        ...
        $(btnEditPassword).click(function () {
        	$.easyui.showDialog({
        		...
        		modal: true,
                topMost: false,
                href: base+"admin/account/editPassword",
                saveButtonText: "保存",
                closeButtonText: "取消",
                ...
                onSave: function (d) {
                    ...
                    if (validate) {
                    	$.ajax({
                    		type:"POST",
                    		async: true,
                    		url: base+"admin/account/updatePasswd",
                    		data: d.form("getData"),
                    		dataType:"json",
    ...
    window.mainpage.mainTabs.refreshLeftTab = function () {
        var t = $(mainTabs), index = t.tabs("getSelectedIndex") - 1;
    ...
    window.mainpage.mainTabs.loadHash = function (hash) {
        ...
        $.get(base+"admin/index/navmenu/data/all", function (menus) {
    ...
    window.mainpage.favo.removeFavo = function (id) {
        ...
        if (!node) {
        	...
        	$.ajax({
        		type:"POST",
        		async: true,
        		url: base+"admin/favomenu/delete",
