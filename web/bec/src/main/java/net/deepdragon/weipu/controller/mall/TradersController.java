...
public class TradersController extends BaseMallController {
	...
	public String list(Model model) {
		...
		model.addAttribute("middlenavigationList",
				cacheData.getMiddleNavigation(getParamMap()));
		model.addAttribute("bottomnavigationList",
				cacheData.getBottomNavigation(getParamMap()));
