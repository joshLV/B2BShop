    ...
    private Map<String, Object> saveOrderRefund(OrderRefund orderRefund, HttpServletRequest request, String info) {
        ...
        try {
            ...
            if(orderType!=null && orderType.equals("1")){
                orderRefund.setOrderType(1);//退款单类型：0_一般退款单，1_众筹退款单
            }else{
                orderRefund.setOrderType(0);
            }
...
//            if(!areaPath.equals("")&&areaPath!=null){
...
//        map.put("reship_part", "部分退货");
    ...
    private Map<String, String> initRefundStatus(Model model) {
        ...
        refundStatusMap.put("shipped",      "等待卖家收货");
        refundStatusMap.put("unrefund",     "等待退款");
