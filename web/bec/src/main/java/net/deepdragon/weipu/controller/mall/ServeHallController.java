...
public class ServeHallController extends BaseMallController{
    ...
    public String show(Model model){
        ...
        model.addAttribute("question", getArticles(getParamMap(), "problem"));
        model.addAttribute("answer", getArticles(getParamMap(), "answer"));

        return Global.TEMPLATE_MALL+PATH+"/serveHallIndex";
    }

    public List<Map<String, Object>> getArticles(Map<String, Object> paramMap, String sign){
