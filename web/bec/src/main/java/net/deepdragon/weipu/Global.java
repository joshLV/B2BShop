...
public class Global {
	...
	public static final String WHICH_PC = "whichpc";
	...
	//设置商城端访问路径
	public static final String MALL = "bec";
	...
	//采购商操作员Session Key
	public static final String CURRENT_OPERATOR = APP_SIGN + "_CURRENT_OPERATOR";

	//登录标识 采购商 操作员
	public static final String CURRENT_LOGIN_TYPE = APP_SIGN + "_CURRENT_LOGIN_TYPE";
	//操作员角色
	public static final String CURRENT_ROLE = APP_SIGN + "_CURRENT_ROLE";
