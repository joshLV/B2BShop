                    ...
                    <dd>
                        ...
                        <div class="tools">
                            <#--<a href="javascript:void(0);" onclick="addCart('${his.goodsId}');" class="JS_order_btn " style="background:#DB0000;color:#fff;border-color:#DB0000;"><img src="${base}/static/mall/img/gwc_icon.png" style="margin-right: 5px;">加入购物车</a>-->
                                    ...
                                    <a href="javascript:void(0);" onclick="addCart('${his.goodsId}','${his.name}','${his.id}');" class="JS_order_btn " style="background:#DB0000;color:#fff;border-color:#DB0000;"><img src="${base}/static/mall/img/gwc_icon.png" style="margin-right: 5px;">加入购物车</a>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    html += '<div style="width: 100%;float: left;">' +
                            ...
                            '     <a id="addCartA' + id + '" style="color: #fff">确定</a>' +
                            '  </button>' +
                            '</div>';
                    html += '</div></div></div>';
