...
<#include "app/gwq/head.ftl">
    ...
    <style>
        ...
        .mui-input-group{background: #F5F5F5;}
    </style>
</head>
...
<div class="mui-content" style="padding:30px 0 0 0;">
    <form class="mui-input-group" action="${base}/enquiry/save" id="enquiryForm" >
        <div class="mui-input-row" style="background: #ffffff;">
            <label <#--style="font-size: 20px; font-weight: bold;"-->>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题:<span style="color:red">*</span></label>
        ...
        <div class="mui-input-row"  style="background: #ffffff; margin-top: 0px;">
        ...
        <div class="mui-input-row" style="background: #ffffff;">
            <label style="float: left; font-size: 20px; font-weight: bold; width: 200px;">询价产品:</label>
            ...
            <div class="mui-input-row" id="goodList">
                ...
                <#list goods as good>
                    <div id="div_${good_index}" style="height: 220px;">
                        ...
                        <button id='catelog' style="max-width: 55%;overflow: hidden;white-space:nowrap;text-overflow:ellipsis;" data-align="${good_index}" onclick="choseCLog(this)"  type="button" data-options='' class="btn mui-btn-picker ">${good.categoryName}</button>
                        ...
                        <input id="goodsName_${good_index}" name="goods[${good_index}].goodsName" value="${good.goodsName}" type="text" data-max="30" required class="mui-input-clear mui-input" style="width: 68%;" placeholder="请输入产品名称">
                        <div style="clear: both"></div>
                        ...
                        <div class="mui-numbox" style="width: 35px;height: 25px;float: left;padding:0 30px;margin-top:5px;">
                            ...
                            <input class="mui-numbox-input" style="width: 23px;padding:0 0px!important" type="tel" pattern="[0-9]*"  readonly="true"   min="1"  max="1000" id="goodsNum_${good_index}" name="goods[${good_index}].goodsNum" value="${good.goodsNum}" />
                        ...
                        <input  style="width: 50px;float: left;padding-right:0px;" type="text" id="goodsUnit_${good_index}" name="goods[${good_index}].goodsUnit" required value="${good.goodsUnit}" data-max="8" class="mui-input-clear mui-input" placeholder="单位">

                        <label style="float: left;">产品描述:</label>
                        <textarea id="goodsAccessory_${good_index}" name="goods[${good_index}].goodsAccessory" type="text" class="mui-input-clear mui-input" data-max="50" style="border:solid 1px #808080; border-radius:5px; resize:none;width: 67%;margin-top: 5px;margin-right: 5px;" placeholder="请输入产品描述">${good.goodsAccessory}</textarea>
               ...
               <#else >
                    <div id="div_0" style="height: 250px;">
                        ...
                        <label style="float: left;">所属分类:<span style="color:red">*</span></label>
                       <button style="max-width: 55%;overflow: hidden;white-space:nowrap;text-overflow:ellipsis;" id='catelog' onclick="choseCLog(this)" data-align="0" type="button" data-options='' class="btn mui-btn-picker ">选择商品分类</button>
                       <input type="hidden" style="margin-top: -36px;width: 40%;float: left;" class="xj-hy" id="categoryName_0" name="goods[0].categoryName" readonly required="required" value="" />
                       ...
                       <label style="float: left;">产品名称:<span style="color:red">*</span></label>
                       <input id="goodsName_0" name="goods[0].goodsName" type="text" value="" data-max="30" required class="mui-input-clear mui-input" style="width: 68%;" placeholder="请输入产品名称">
                       <div style="clear: both"></div>
                       <label style="float: left;">数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量:<span style="color:red">*</span></label>
                       <div class="mui-numbox" style="width: 35px;height: 25px;float: left;padding:0 30px;margin-top:5px;">
                           <button class="mui-numbox-btn-minus" style="width: 30px;" type="button"  op="-">-</button>
                           <input class="mui-numbox-input" style="width: 23px;padding:0 0px!important" type="tel" pattern="[0-9]*" id="goodsNum_0" name="goods[0].goodsNum" min="1" max="1000" value="1" onchange="ckNum(this)" />
                       ...
                       <input  style="float: left;padding-right:0px;" type="text" id="goodsUnit_0" name="goods[0].goodsUnit" value="" class="mui-input-clear mui-input" required data-max="8" data-min="1" placeholder="件、吨">
                       <div style="clear: both"></div>
                       <label style="float: left;">产品描述:</label>
                       <textarea id="goodsAccessory_0" name="goods[0].goodsAccessory" type="text" value="" class="mui-input-clear mui-input" style="border:solid 1px #CCCCCC; border-radius:5px; resize:none;width: 67%;margin-top: 5px;margin-right: 5px;" placeholder="请输入产品描述"></textarea>
                    </div>
                </#if>
            </div>
        </div>
        <div class="mui-input-row" style="background: #ffffff;">
            <label style="float: left; font-size: 20px; font-weight: bold; width: 100%;">采购要求:</label>
            <div class="mui-input-row">
                <label style="float: left;">报价截止时间:<span style="color:red">*</span></label>
                <button id='datetimeButton' type="button" data-options='{"beginYear":"${(.now?date)?string("yyyy")}","beginMonth":"${(.now?date)?string("MM")}","beginDay":"${(.now?date)?string("dd")}","beginHour":"${(.now?date)?string("HH")}","beginMinute":"${(.now?date)?string("mm")}"}' style="padding: 6px 6px" class="btn mui-btn-picker ">${enquiry.offerEndDateTime?string("yyyy年MM月dd日HH时mm分")}</button>
                ...
                <button id='dateButton' type="button" style="padding: 6px 6px" data-options='{"type":"date","beginYear":"${(.now?date)?string("yyyy")}","beginMonth":"${(.now?date)?string("MM")}","beginDay":"${(.now?date)?string("dd")}"}' class="btn mui-btn-picker "><#if enquiry.expectReceivDate??>${enquiry.expectReceivDate?string("yyyy年MM月dd日")}<#else>选择期望收货日期</#if></button>
                ...
                <input id="recAddress" type="text" name="recAddress" value="${enquiry.recAddress}" class="mui-input-clear mui-input" style="width: 68%;" data-max="50" required placeholder="请输入详细地址">
                <div style="clear: both"></div>
            </div>
        </div>
        <div class="mui-input-row" style="background: #ffffff;">
            <label style="float: left;width: 160px; font-size: 20px; font-weight: bold;">对供应商要求:</label>
            <div class="mui-input-row">
                ...
                <div style="clear:none;" class="mui-input-row mui-radio mui-left f-cb" >
                    ...
                    <div id="otherTradeLabe2" style="width: 100%;padding: 0;margin-right: 0;<#if enquiry.tradeExchange != 2>display: none;</#if>float: left;">
                        <input class="mui-input-clear mui-input" type="text" id="otherTrade" name="otherTrade" value="${enquiry.otherTrade}" style="width:100%; float: left; margin-top: 10px;" placeholder="请输入其他交易方式">
                    </div>
                </div>
                </div>
                <div style="clear: both"></div>
                ...
                <textarea name="manageArea" id="manageArea"  class="mui-input-clear mui-input" style="border:solid 1px #CCCCCC; border-radius:5px; resize:none;width: 67%;margin-top: 5px;margin-right: 5px;" data-max="100" placeholder="请输入经营地址">${enquiry.manageArea}</textarea>
                <div style="clear: both"></div>
                ...
                <textarea id="certification" name="certification" type="text" value="" class="mui-input-clear mui-input" style="border:solid 1px #CCCCCC; border-radius:5px; resize:none;width: 67%;margin-top: 5px;margin-right: 5px;" maxlength="300"  placeholder="请输入证照要求">${enquiry.certification}</textarea>
                <div style="clear: both"></div>
                ...
                <textarea id='replenishExplain' name="replenishExplain" type="text" value="" data-max="300" class="mui-input-clear mui-input" style="border:solid 1px #CCCCCC; border-radius:5px; resize:none;width: 67%;margin-top: 5px;margin-right: 5px;" placeholder="请输入证照要求"></textarea>
                <div style="clear: both"></div>
        ...
        <div class="mui-input-row" style="background: #ffffff;">
            <label style="float: left;width: 220px; font-size: 20px; font-weight: bold;">询价方式及隐私设置:</label>
            <div class="mui-input-row">
                ...
                <li class="mui-input-row mui-radio mui-left f-cb" >
                    ...
                    <textarea id="merchantNames" name="merchantNames" type="text"  readonly="readonly" class="mui-input-clear mui-input" style="/*border:solid 1px #808080; border-radius:5px;*/ resize:none;width:50%; float: left; margin-top: 5px;margin-right: 5px;<#if enquiry.enquiryMode != 2>display: none;</#if>" placeholder="请选择供应商">${enquiry.merchantNames}</textarea>
                    <a href="#xzgys" id="buyerMerchant" style="font-size:12px;display: block; width:70px;float: left; height: 28px; line-height: 28px; padding-right:3px;padding-left:3px; margin-right: 5px; margin-top:10px; color: #0171bb;<#if enquiry.enquiryMode != 2>display: none;</#if>">选择供应商</a>
                    </div>
                </li>
                </div>
                <div style="clear: both"></div>
                ...
                <input id="linkman" name="linkman" type="text" value="${enquiry.linkman}" class="mui-input-clear mui-input" data-max="30" style="width: 68%;" placeholder="请输入联系人">
                <div style="clear: both"></div>
        ...
        <div class="mui-content-padded" >
            <input type="submit" id="submit"  style="margin-bottom: 10px; border-radius: 5px;" class="mui-btn mui-btn-block mui-btn-primary" value="确定发布"></input>
        </div>
    </form>
</div>
<!--选择供应商开始-->
...
<!--选择供应商结束-->
<#include "app/gwq/member/yhxy.ftl"/>
    ...
    (function(mui, doc) {
        ...
        jQuery("#datetimeButton").bind("tap",function(){
            ...
            picker.show(function(rs) {
                ...
                //收货日期大于报价截止时间
                var data_options='{"type":"date","beginYear":"'+ rs.y.text+'","beginMonth":"'+rs.m.text+'","beginDay":"'+rs.d.text+'"}';
                $("#dateButton").attr("data-options",data_options);
            });
        });
        //选择期望收货日期
        ...
        jQuery("#addNewColumn").bind("tap",function(){
            ...
            if($("#categoryPath_"+(colIndex-1)).val()==''){
...
//                                '<div style="clear: both; padding: 10px 0; border-bottom: 1px dotted #d8d8d8; margin-bottom: 15px;"></div>'+
                                '<label style="float: left;">所属分类:<span style="color:red">*</span></label>'+
                                '<button id="catelog'+colIndex+'" style="max-width: 55%;overflow: hidden;white-space:nowrap;text-overflow:ellipsis;" onclick="choseCLog(this)"  name="catelogButton" data-align="'+colIndex+'" type="button" data-options="" class="btn mui-btn-picker ">选择商品分类</button>'+
                                ...
                                '<div style="clear: both"></div>'+
                                '<label style="float: left;">产品名称:<span style="color:red">*</span></label>'+
                                '<input id="goodsName_'+colIndex+'" name="goods['+colIndex+'].goodsName" type="text" data-max="30" value="" required class="mui-input-clear mui-input" style="width: 68%;" placeholder="请输入产品名称">'+
                                '<label style="float: left;">数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量:<span style="color:red">*</span></label>'+
                                '<div class="mui-numbox" style="width: 35px;height: 25px;float: left;padding:0 30px;margin-top:5px;">'+
                                '<button class="mui-numbox-btn-minus" style="width: 30px;" type="button" onClick="add_subtract(this)" op="-" >-</button>'+
                                '<input class="mui-numbox-input" style="width: 23px;padding:0 0px!important" type="tel" pattern="[0-9]*"  id="goodsNum_'+colIndex+'" name="goods['+colIndex+'].goodsNum" min="1" max="1000" value="1" onchange="ckNum(this)"/>'+
                                ...
                                '<div style="clear: both"></div>'+
                                '<label style="float: left;">单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位:<span style="color:red">*</span></label>'+
                                '<input id="goodsUnit_'+colIndex+'" name="goods['+colIndex+'].goodsUnit" style="float: left;padding-right:0px;" required type="text" value="" data-max="8" class="mui-input-clear mui-input" placeholder="件、吨">'+
                                '<label style="float: left;">产品描述:</label>'+
                                '<textarea id="goodsAccessory_'+colIndex+'" data-max="50" name="goods['+colIndex+'].goodsAccessory" type="text" value="" class="mui-input-clear mui-input" style="border:solid 1px #cccccc; border-radius:5px; resize:none;width: 67%;margin-top: 5px;margin-right: 5px;" placeholder="请输入产品描述"></textarea>'+
                                '</div>';
