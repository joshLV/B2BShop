...
<div class="mui-content" style="padding-bottom:58px; padding-top:50px;">
   <#--   <div class="r_px"><span>排序方式:</span>
        ...
        <#list goodslist as gl>
            <li>
                ...
                <div class="info">
                    ...
                    <#--<span>${gl.marketPrice?string(priceCurrencyFormat)}</span>--></div>
                </div>
            </li>
        </#list>
        </ul>
    ...
    <div class="checkout_btn">
        <a id="loadmore" class="gray_btn" class="mui-control-item" href="javascript:;">点击加载更多</a>
    </div>
    <div id="buttom"></div>
...
<script>
    ...
    (function (mui, doc) {
        ...
        //动态加载数据
        jQuery("#loadmore").bind('tap', function(){
                    ...
                    if(data.status == 'success'){
                        ...
                        jQuery.each(data.data, function(index, goods){
                            ...
                            var item='<li>'+
                                    ...
                                    '<div class="extra"><strong>'+price+'</strong></div>'+
                                    '</div>'+
                                    '</li>';
