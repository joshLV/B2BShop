...
<div class="mui-content wrap">
    ...
    <section class="order-con">
        <ul class="order-list">
            <li>
                <h4 class="merchant_title">标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题&nbsp;&nbsp;<a href="javascript:void(0);" onclick="return false;">${enquiry.title}</a></h4>
                <#--<h3 style="padding-top: 15px;"><a href="javascript:void(0);" onclick="return false;">${enquiry.title}</a><sup class="detail">&lt;#&ndash;<sup>title</sup>&ndash;&gt;</sup></h3>-->
...
<div id="${good.id}" class="mui-popover" style="height: 60%;width: 80%;display: none;z-index: 999">
    ...
    <div style="line-height: 45px;text-align: center;width: 88%;float: left;font-weight: bold">&nbsp;&nbsp;产品描述</div>
