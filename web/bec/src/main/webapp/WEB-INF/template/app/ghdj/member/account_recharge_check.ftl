...
<div class="mui-content" style="padding-bottom:0px; overflow: hidden; margin-top:32px;">
    <div style="background: #fff; overflow: hidden;">
        <form class="mui-input-group" id="paymentInfo" method="POST" action="${base}/account/rechargeInto">
            ...
            <div class="mui-input-row">
                <label>充值金额：</label>
                <span class="bzj_info"> <input id='czje' name='account' type="text" style="width:68%; padding: 5px 0; height:40px;" placeholder="请输入充值金额" class="reg-inputs mui-input-clear"></span>
            </div>
