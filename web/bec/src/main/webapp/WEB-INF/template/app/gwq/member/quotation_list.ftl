    ...
    <#--新做订单列表-->
            ...
            <ul class="order-list">
                ...
                <li>
                    <div class="order-box" style=" padding: 0px 0px;">
                        <div style="text-align: left;border-bottom:solid 1px #d8d8d8;line-height: 45px;font-weight: bold;font-size: 16px;background-color:#d7d7d7;">&nbsp;&nbsp;询价单</div>
        ...
        <div class="viewport" id="tabs" style=" padding-left: 0!important; padding-right:0!important; width: 100%!important;">
            ...
            <div id="order01" class="order_list01">
                <div style="text-align: left;border-bottom:solid 1px #d8d8d8;line-height: 45px;font-weight: bold;font-size: 16px;background-color:#d7d7d7;">&nbsp;&nbsp;报价单(共${countTotal}个)</div>
            <#list quotationList as quotation>
                <dl>
                    <div class="bh">
                        <p style="color:#888;font-size: 14px;"><label>报价供应商：</label><label style="font-weight: bold;" onclick="jumpto(fullpath + '/shop/${quotation.urlAddress}?whichclient=whichapp')">${quotation.merchantName}</label></p>
                        <#--<div style="float:left;color: #888;width:30%;">报价供应商：</div>
                        <div style="padding-right:15px;"><a class="offer-name" target="_blank" href="${base}/shop/${quotation.urlAddress}" title="${quotation.merchantName}" style="color: #888;padding-left: 0">${quotation.merchantName}</a></div>-->
                    </div>
                    <dt>
                        <p style="color:#888;font-size: 14px;"><label>报&nbsp;价&nbsp;总&nbsp;&nbsp;额：</label><label class="releaseTime">${quotation.totalCost?string("currency")}(含运费:${quotation.freightTotalCost?string("currency")})</label></p>
                    </dt>
                    <dt>
                        <p style="color:#888;font-size: 14px;"><label>报&nbsp;价&nbsp;时&nbsp;&nbsp;间：</label><label class="releaseTime">${quotation.createDate?string("yyyy-MM-dd HH:mm:ss")}</label></p>
                    </dt>
                    <dt>
                        <p style="color:#888;font-size: 14px;"><label>有&nbsp;效&nbsp;期&nbsp;&nbsp;至：</label><label class="offerEndTime">${quotation.quotationPeriod?string("yyyy-MM-dd HH:mm:ss")}</label></p>
                    </dt>
                    <#if quotation.isEnd >
                        <dt>
        ...
        (function (mui, doc) {
            ...
            closeReturnQuotationDialog = function (id, type){
                ...
                if(type == '1'){
                    ...
                    if(otherRea!=''){
                        if(otherRea.length>100){
                            popAlert("补充说明字符超过限制0-100字符")
                            return false;
                        }
                    }
