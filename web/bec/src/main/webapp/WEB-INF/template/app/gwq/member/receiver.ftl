...
<div class="mui-content">
    <form class="mui-input-group" id="receiverFrom" name="receiverFrom">
        ...
        <#--<div class="mui-input-row">
            <label>邮箱:</label>
            <input id='email' name="email" type="text" value="${receiver.email!''}" class="mui-input-clear mui-input" placeholder="请输入收货人邮箱">
        </div>-->
        <div class="mui-input-row">
            <label>邮编:</label>
