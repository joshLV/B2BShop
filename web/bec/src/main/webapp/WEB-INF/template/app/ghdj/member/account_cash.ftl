...
<header>
    ...
    <div class="user">
        <button type="button" id="jxgw" onclick="javascript:jumpto(fullpath + '/account/cashList?whichclient=whichapp');" class="mui-btn  mui-btn-link mui-btn-nav mui-pull-right" style="margin-right:0px; padding-left: 6px; color: #fff; margin-top:0; font-size: 15px;">
            <span class="mui-icon mui-icon-right-nav"></span>提现记录
        </button>
...
<div class="login_box mt0">
    <div>
        <input type="submit" onclick="jumpto(fullpath + '/account/rechargeCheck?whichclient=whichapp');" class="input_style no-on" id="reg_btn"  value="充值">
    </div>
    <div>
        <input type="submit" onclick="jumpto(fullpath + '/account/cashCheck?whichclient=whichapp');" class="input_style on" id="reg_btn"  value="提现">
    </div>
</div>
