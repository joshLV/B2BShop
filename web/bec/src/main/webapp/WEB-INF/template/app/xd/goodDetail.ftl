...
<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <#include "app/xd/head.ftl">
      <#--script type="javascript" src="/ec/static/app/xd/js/jquery.idTabs.min.js"></script-->
...
.shop-ghs {
    ...
    padding-bottom: 3px;
    padding-right: 5px;
    background: #fef7db url("${base}/static/bec/project/xd/img/ghs_icon.png") no-repeat 2px center;
    padding-left: 23px;
}
</style>
        ...
        <ul class="goods_sell">
            <li>
                <div class="pro_l">
                    ...
                    <div class="key" style="margin-top: 5px;color:black; ">商品条码：${goods.barcode}</div>
                </div>
            </li>
        </ul>
    </div>
        ...
        <ul>
           <#-- <li style="position:relative;">
            ...
            <li>
                ...
                ${(shop.name?exists)?string("${shop.name}","本商城")}
                    <#--西安港进出口商品交易中心-->
...
<#--                <td valign="top" align="center">
                ...
                <td>
                    ...
                    <button  class="mui-btn mui-btn-primary mui-pull-right mui-gwc" onclick="addGoodsAttention('${goods.id}');" >
                        <a  href="javascript:void(0);" id="_gssp">关注商品</a>
                    </button>
                </td>
            </tr>
        </table>
