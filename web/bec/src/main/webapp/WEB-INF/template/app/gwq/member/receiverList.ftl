                   ...
                   <#-- <p>邮箱地址：${receiver.email}</p>-->
                    ...
                    <ul class="tools">
                        <li style="width: 100%">
                            ...
                            <#if to != ''>
                                <a href="javascript:window.location.href='${base}/member/ordercheck?whichclient=whichapp&receiverId=${receiver.id}&o=${o}&paymentId=${paymentId}&deliveryId=${deliveryId}&platform=${platform}&quotationId=${quotationId}';" >选择</a>
                            </#if>
        ...
        jQuery.ajax( {
            ...
            success : function(data) {
                if(data.status=="success"){
                    ...
                    jumpto(fullpath + "/member/receiver?whichclient=whichapp");
                }else{
