...
<#include "app/ghj/head.ftl">
    ...
    <style>
        ...
        /*新加样式  12-31*/
        .logo a.ltext{float:left;text-indent:-9999px;width:13px; height:21px; background-size:13px
        21px;margin-top:5px;}
        .state_list li{
            width: 25%!important;
        }
...
<div class="user_pic" style="margin-top: 28px;" onclick="go('/member/info?whichclient=whichapp')">
    ...
    <#if '${loginType}' == 'operator'>
         <span>${mp.userName}[${mp.realName}]</span>
    <#else>
...
<ul class="navi_list clearfix">
    ...
    <li><em><img src="${path}/images/inquirys.png"></em><a href="javascript:go('/enquiry/list?whichclient=whichapp')">询价单</a></li>
