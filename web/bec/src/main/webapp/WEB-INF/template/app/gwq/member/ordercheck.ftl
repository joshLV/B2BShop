...
<#include "app/gwq/head.ftl">
    <style>
       ...
       .mui-sh-box{ width: 100%;
        ...
        .items .radioitem{padding:5px 10px; height: 18px; line-height: 18px; margin-top: 3px;border: #fff solid 1px;}
...
<div class="mui-content" style="padding-bottom:50px; margin-top:14px;">
                ...
                <div id="payment-ship" style="position: static;">
                    ...
                    <div id="delivery-time">
                        ...
                        <div class="middle">
                            ...
                            <div class="item" style="height: 28px;">
                                <div class="label">
                                    <input style="position: absolute; margin-left: 2px; margin-top: 1px;"  id="delivery-t3" name="delivery-t" <#if deliveryTime_index==0>checked</#if> payname="${deliveryTime.introduce}" payid="${deliveryTime.id}" value="${deliveryTime.id}" type="radio" onclick="$('#order_deliveryTime').val('${deliveryTime.introduce}');">
    ...
    <form id="orderGoodsForm">
        <div class="order-list">
                ...
                <dd>
                    <div class="order-goods" style="padding-bottom: 15px;">
                        ...
                        <div class="info"> <a href="${base}/item/whichapp/${cartItem.goodsId}.html">${cartItem.name}</a>
                           ...
                           <h4>¥${cartItem.price}<span style="padding-left: 10px; font-size: 13px; color: #999; font-weight: normal; ">优惠：¥0.00</span></h4>
            ...
            <div style="height: 15px;background-color: #d8d8d8"></div>
            </#list>
            </#list>
        </form>
        </div>
