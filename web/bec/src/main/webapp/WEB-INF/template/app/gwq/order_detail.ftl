            ...
            <li>
                <div class="order-box">
                    <div class="order-width">
                        ...
                        <p>订单金额：${(order.goodsTotalPrice?number+order.deliveryFee?number)?string(priceCurrencyFormat)}</p>
                        ...
                        <ul class="book-list">
                            <li>
                                ...
                                <a href="${base}/item/whichapp/${goods.id}.html">
                                    <div class="order-msg">
                                        <img src="${goods.pic}_300x300.png" class="img_ware" />
                                    </div>
                                        <div class="order-info2">
                                           ...
                                           <p class="title" style="height:19px;overflow: hidden;padding-bottom: 5px;">
                                            ...
                                            <p class="price">${goods.price?string(priceCurrencyFormat)}</p>
                    ...
                    <div class="order-width">
                        ...
                        <#--新添加-->
                            ...
                            <div class="sh_info">
                                ...
                                <div class="val red" style="color: #E4393C;">${order.goodsTotalPrice?string(priceCurrencyFormat)}</div>
                            </div>
                            <div class="sh_info">
                                <div class="key">运费：</div>
                                <div class="val red">${order.deliveryFee?string(priceCurrencyFormat)}</div>
                            </div>
                            <#--
                            <div class="sh_info">
                                <div class="key">商品优惠：</div>
                                <div class="val red">0.00</div>
                            </div>-->
                            <div class="sh_info" style="border-bottom: 0;">
                                <div class="key">应支付金额：</div>
                                <div class="val red">${(order.goodsTotalPrice+order.deliveryFee)?string(priceCurrencyFormat)}</div>
                            </div>
                    </div>
                </div> </li>
            <li>
                    ...
                    <div class="order-width">
                        ...
                        <#if orderDistribution??>
                            ...
                            <div class="sh_info">
                                ...
                                <div class="val">${orderDistribution.logisticsNo}</div>
                            </div>
                            <div class="sh_info" style="border-bottom: 0;">
                                <div class="key">物流详情：</div>
                                <div class="val"><a class="mui-control-item red" href="javascript:void(0);" class="blue" id="getExpressLog" orderid="${order.id}" style="padding:5px 12px;  background: #E4393C;-webkit-border-radius: 3px; color: #fff;-moz-border-radius: 3px;border-radius: 3px;">获取物流详情</a></div>
                                <ul id="expressLog"></ul>
                            </div>
