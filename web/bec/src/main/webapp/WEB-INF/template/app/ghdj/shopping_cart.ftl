                ...
                <#list cartItemList  as map>
                    ...
                    <div class="shop-title customize-shtit" shopIdD="${map.shopId}" style="border-bottom: 1px dotted #d8d8d8; padding:2px 0;display: none;">
                        <div class="item">
                            ...
                            <div class="shop-title-content"> <a href="${base}/shop/${map.shopUrl}?whichclient=whichapp"> <span class="shop-title-name">${map.shopName}</span> <span class="shop-title-detail"> <span style="width: 30px;"> <img src="${base}/static/app/ghdj/images/icon-left.png"> </span> </span> </a> </div>
                            </li>
                        </div>
                    </div>
                        ...
                        <li  id="product_${cartItem.id}" class="mui-input-row mui-checkbox mui-left" style="padding-bottom:15px;">
                            ...
                            <div class="mui-gwc-box" style="margin-left: 40px;">
                                ...
                                <div class="mui-media-body">
                                    ...
                                    <span style="font-size:14px;">共<span id="goodsNum${cartItem_index}">${cartItem.quantity/cartItem.packageModulus}</span>件</span>
