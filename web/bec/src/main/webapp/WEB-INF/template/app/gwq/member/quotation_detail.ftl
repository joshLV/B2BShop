...
<style>
    ...
    .checkQuitation:active{color: #fff}
</style>
</head>
<body>
        ...
        <ul class="order-list">
            ...
            <li>
                <div class="order-box" style="padding: 15px 0px 5px 0px">
                    <div class="order-width" style="width: 95%;">
                ...
                <div style="font-size: 10px;background: #FFF;border-bottom: 1px solid #d8d8d8;color: #888;margin-top: -11px;">
                    ...
                    <#list quotationDetailsList as quoDetList>
                        ...
                        <span style="color: #ff8212">￥${quotation.totalCost}.00
                                ...
                                <font> (含运费:￥${quotation.freightTotalCost})</font>
            ...
            <li>
                <div class="order-box">
                    <div class="order-width">
                        ...
                        <p>附件：<div style="max-width: 100%;overflow: hidden">${quotation.replenishExplain}</div></p>
                        <p>资质：<div style="max-width: 100%;overflow: hidden">${quotation.accessory}</div></p>
                    </div>
                </div>
            </li>
        </ul>
