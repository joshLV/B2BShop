...
<#--分类修改样式  zyf 11-5-->
    <style>
        ...
        .hide{display: none;}
        .mui-content{padding-bottom:0!important;}
    </style>
...
<div class="mui-content" style="margin-top:15px;background: #f3f4f6;">
    ...
    <#--<div id="sliderProgressBar" class="mui-slider-progress-bar mui-col-xs-4"></div>-->
        ...
        <div class="mui-slider-group">
            <div id="item1mobile" class="mui-slider-item mui-control-content2 mui-active">
                <div  class="ghj-category-tab"  id="rootList">
                    <div style="overflow: hidden;" id="category8">
                        <ul>
                        <#list catelogList as grandfather>
                            <li>
                                <a link="#content${grandfather_index}">
                ...
                <div>
                    <#list catelogList as grandfather>
                    <ul class="mui-table-view mui-table-view-chevron hide right-content" id="content${grandfather_index}" >
                    <#--<#if grandfather.catelogType == "agricultural">-->
                        ...
                        <#-- <#list catelogChildrenMap["${grandfather.id}"] as father>
                            ...
                            <!--列表-->
                            <#list catelogChildrenMap["${grandfather.id}"] as father>
                                <ul class="mui-table-view mui-table-view-chevron mui-right-view" style=" padding-top:10px;margin-left: 0px;  margin-right: 10px;padding-bottom: 5px;margin-bottom: 10px; background: #fff!important;">
                                    <!--一级列表-->
                                    <li class="mui-table-view-cell" style=" margin-bottom: 10px;">
                                        <a class="mui-navigate-right" href="${base}/list/whichapp/${grandfather.id}-${father.id}.html" style="font-size: 15px; color: #333!important;">${father.name}</a>
                                    </li>
                                    <!--一级列表-->
                                    <!--二级列表-->
                                    <#list catelogChildrenMap["${father.id}"] as catelog>
                                        <li class="mui-table-view-cell"style="padding-bottom:8px; padding-top:6px; width:33%;float: left;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;box-sizing: border-box;
" >
                                            <a href="${base}/list/whichapp/${grandfather.id}-${father.id}-${catelog.id}.html" class="mui-navigate-menu" >${catelog.name}</a>
                                        </li>
                                    </#list>
                                    <!--二级列表-->
                                </ul>
...
<script type="text/javascript">
    ...
    $("#rootList").attr("style","height:"+(screenheight-45)+"px;")
    $(function(){
        $("#category8>ul>li:first").addClass("selected");
        $(".right-content:first").show();
        $("#category8>ul>li>a").click(function(){
            $("#category8>ul>li").removeClass("selected");
