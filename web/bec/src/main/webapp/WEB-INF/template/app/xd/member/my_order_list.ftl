        ...
        <dl title="${order.orderStatus}">
            <div class="bh">
                <div style="float:left;">
                    <label><#--<#if order.orderType == 1>众筹订单:<#else>普通订单:</#if>-->订单编号:</label>
                ...
                <div class="tools">
                    <#if '${order.isRefund }'== 'N'>
                        ...
                        <#elseif '${order.orderStatus}' == 'wait_buyer_validate_goods'>
                            <a href="javascript:void(0)" onclick="validateGoods('${order.id}','${order.handleResultStatu}')" class="JS_order_btn ">确认收货</a>

                           <#-- <#if '${order.orderType}'!= '1'><a href="javascript:void(0)" onclick="complainGoods('${order.orderSn}')" class="JS_order_btn ">申诉</a></#if>-->
