        ...
        <div class="mui-content">
            <div class="about_bg" style="padding:10px;">
                ...
                <div style="padding:10px; line-height: 26px; margin: 10px; border: 1px solid #d8d8d8;">
                    ...
                    <p style="text-indent: 2em;">“喜都”---是一个F2B（厂家对商家）电子商务交易平台。以厂家、一级代理商为供货主体，大、中型商超为采购主体，以现金结算为基础，专业化团队运营，同时提供以信用贷款、资金池担保的金融服务，保姆式物流为配送体系，厂家直接对商超的电子商务交易平台。</p>
                    <p style="text-indent: 2em;">该项目为解决传统商贸行业的账期问题、中间商问题、拓宽采购和销售渠道的问题而产生。“喜都”以交易现结为基础，降低商品进货成本，打通采购与销售对接、贷款渠道、仓储物流一体化环节，让厂家、一级供应商与商超之间形成无缝链接的业务流程，建设供应商和超市可持续的高盈利运营模式。</p>

                </div>
            </div>

            <p style="font-size: 12px;text-align: center; background-color: #fff;">&nbsp;&nbsp;Copyright&nbsp;©&nbsp;2015-2016&nbsp;&nbsp;<br>喜都有限责任公司&nbsp;&nbsp;版权所有<br>陕ICP备16001873号</p>
        </div>
    </div>
    </div>
    <!--页面主内容区结束-->
