...
<nav class="mui-bar mui-bar-tab"<#-- style="box-shadow: 0px -3px 5px #cbcbcb;"-->>
...
<#--    <a class="mui-tab-item" id="app_zcjs">
        <span class="mui-icon iconfont icon-zhongchou"></span>
    ...
    <script>
        ...
        jQuery("#app_zs").bind('tap', function() {
	...
	//购物车
        ...
        jQuery("#app_zcjs").bind('tap', function() {
            var url=fullpath +  '/zcgoods/list';
            jumpto(url);
        });
...
-->
        (function(mui, doc) {
            ...
            if(pagename!=''){
                ...
                if(pagename=='zcgoods_list'){
                    jQuery("#app_zcjs").addClass('mui-active');
                }
