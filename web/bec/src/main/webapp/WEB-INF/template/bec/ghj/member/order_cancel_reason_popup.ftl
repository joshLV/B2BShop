...
<div id="container">
	<#-- 20151130 dzz <!-- <#include "bec/ghj/top.ftl"/> -->
<div class="mflex">
	<p>
		<table>
			<tr>
			...
			<tr>
				<td>*其他原因：</td>
				<td><textarea rows="5" cols="10" maxlength="50" id="otherReason" disabled style="border: 1px solid #E6E6E6; margin-top: 15px;"></textarea></td>
...
$(function(){
	...
	<#-- 20151130 dzz <!-- <#include "bec/ghj/foot.ftl"/> &ndash;&gt;-->
</#escape>