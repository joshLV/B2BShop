                ...
                <div class="pro_info_l">
                    <div id="preview">
                        ...
                        <div class="jqzoom" id="spec-n1" onClick="window.open('#')">
                                <IMG height="420" src="${firstImg.pic}@420w_420h.png" jqimg="${firstImg.pic}@420w_420h.png" alt="${firstImg.title}"width="420">
                        </div>
                        <#else>
                        ...
                        <#--<#else>-->
                            <div class="pfj" id="staticBId">
                                <div class="pfj_t"><span>商&nbsp;城&nbsp;价</span>
                                    ...
                                    <#--<#else >-->
                                        <em class="red f-fs2" id="staticB2Id">￥${goods.price}&nbsp;</em>
                                    <#--</#if>-->
                                </div>
        ...
        <div class="mr">
            <div id="tabsbox" class="tabsbox">
                <ul class="tab_nav">
                    ...
                    <li><a href="#tab3">用户评价<span class="red" id="reviewSizeId"></span></a></li>
