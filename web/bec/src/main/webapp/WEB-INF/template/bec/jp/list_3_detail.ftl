...
<script src="${base}/static/bec/project/jp/js/list3/ajaxGetListGoods.js" type="text/javascript"></script>
...
//                $(".xj-path").val(path);
    ...
    function searchGoodsInfo(){
        ...
        window.location.href = "${base}/list/${ids}.html?listStyle=${listStyle}&goodsShortName="+goodsShortName+"&shopName="+shopName+"&goodsCategory="+goodsCategory+"&orderBy="+$("#cur_orderBy").val()+"&order="+$("#cur_orderType").val()+"&price=${priceFlag}&brand=${brandFlag}";
