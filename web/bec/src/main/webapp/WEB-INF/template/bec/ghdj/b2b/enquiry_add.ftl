...
<head>
    ...
    <link href="${base}/static/bec/project/ghdj/css/header.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/ghdj/css/inquiry_sheet.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/ghdj/css/footer.css" rel="stylesheet" type="text/css" media="all"/>
   ...
   <#-- <link href="${base}/static/bec/project/ghdj/css/header.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/ghdj/css/footer.css" rel="stylesheet" type="text/css" media="all"/>-->
    <link rel="stylesheet" type="text/css" href="${base}/static/bec/project/ghdj/css/common.css">
    ...
    <form action="${base}/enquiry/save" id="enquiryForm" >
        ...
        <div class="xj-box">
            ...
            <div class="xj-table">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <#if goods??>
                        ...
                        <tr class="xj-table-con2" id="good_col_${good_index}">
                            <td>
                                ...
                                <img class="col_del" src="${base}/static/bec/project/ghdj/images/inquiry/jian_icon.jpg" onclick="removeColumn('good_col_${good_index}')" ></img>
                            </td>
                            <td>
                    ...
                    <tr class="xj-table-con2" id="good_col_0">
                        <td>
                            <span class="col_del_span">&nbsp;</span>
                            <img class="col_del" src="${base}/static/bec/project/ghdj/images/inquiry/jian_icon.jpg" onclick="removeColumn('good_col_0')" ></img>
                        </td>
            ...
            <div class="xj-operate">
                <img src="${base}/static/bec/project/ghdj/images/inquiry/add_icon.jpg"><span id="btn"><a href="javascript:void(0)" id="addNewColumn">添加产品</a><#-- | <a href="#">批量导入</a>--></span>
            </div>
        </div>
        <div class="xj-box">
...
//        $("#areaSelect_div .areaSelect")[0].attr("required","required");
        ...
        $("#addNewColumn").click(function(){
            ...
            html += '<td style="vertical-align: middle;"><span class="col_del_span">&nbsp;</span><img class="col_del" src="${base}/static/bec/project/ghdj/images/inquiry/jian_icon.jpg" onclick="removeColumn(\'good_col_'+colIndex+'\')"></img></td>';
            html += '<td>';
