...
<div class="head f-cb">
    <div class="f-fl logo"><a href="${base}/index"><img src="${base}/static/bec/project/ghdj/img/logo.png" width="290" height="73" alt="广货街交易平台"></a></div>
    <div class="f-fl main">
    ...
    <div class="f-fr cart">
        ...
        <div id="cartinfo">
            <div class="nogoods">
                <img src="${base}/static/bec/project/ghdj/img/cart.png" width="57" height="49" alt="">购物车中还没有商品，赶紧选购吧！
            </div>
            <div class="goodslist">
