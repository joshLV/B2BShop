...
<head>
    ...
    <link href="${base}/static/bec/project/gdnz/images/favicon.ico" rel="shortcut icon" />
    ...
    <style>
        ...
        #login .btn-entry {width: 149px;height: 34px;font-family: "微软雅黑";line-height: 34px;/*text-indent: -9999px;*/background: #db0000;overflow: hidden; color: #ffffff; font-size: 16px; border-radius: 3px;}
        #login .btn-register{width: 149px;height: 34px;font-family: "微软雅黑";line-height: 32px;/*text-indent: -9999px;*/background: #ffeded;overflow: hidden; color: #db0000; font-size: 16px; border-radius: 3px; border: 1px solid #db0000; margin-left:10px;}
        #login .btn-register:hover{background: #ffe2e2;}
