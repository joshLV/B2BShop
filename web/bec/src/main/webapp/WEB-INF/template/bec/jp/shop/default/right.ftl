...
.cart_btn_img{
     width: 18px;
     height: 18px;
     background: url(${base}/static/bec/project/jp/images/search.ele.png) no-repeat 0 -273px;
 }
</style>
...
<style>
 ...
 .goodsList .mc{color: #666;height:auto;/*border-top:2px solid #C30000;*/  }
 ...
 .goodsList .mc li{border: 1px solid #FFFFFF;background: none repeat scroll 0 0 #FFFFFF;float: left;overflow: hidden;padding: 8px; margin-top:15px;margin-left:14px;z-index: 1;border:solid 1px #eaeaea;}
 ...
 .goodsList .mc .item .pic {overflow: hidden;position: relative;height:208px;background: rgba(0, 0, 0, 0) url("${base}/static/bec/project/jp/images/default_logo.jpg") no-repeat scroll 50% 50%; }
