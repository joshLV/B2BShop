...
<link href="${base}/static/bec/project/gwq/css/supplier_list.css" rel="stylesheet" type="text/css" media="all"/>
...
<div class="supplier_main">
    <div class="supplier_left">
      <#include "bec/gwq/member/menu.ftl"/>
    </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="480">
                        ...
                        <p><em>经营模式：</em>--</p>
                        <p><em>主营产品：</em>--</p>
                        <p><em>联系方式：</em>${merchant.head}<a href="#"><img src="${base}/static/bec/project/gwq/images/supplier_list/wangwang_icon_grey.png" class="sup_wangwang_icon"></a></p>
                    </td>
