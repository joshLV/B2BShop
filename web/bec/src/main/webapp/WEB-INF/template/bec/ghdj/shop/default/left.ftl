...
.shopInfo .mt h2{margin-bottom:15px; font-size: 16px; color: #e9314a;}
.shopInfo .mc{padding:10px 10px 0px 10px; line-height: 20px;}
.shopInfo .mc ul {width:190px;}
.shopInfo .mc ul li{overflow: hidden;padding: 6px 0 0 6px;}
.shopInfo .mc .address{height:36px;overflow:hidden;margin-bottom:6px; padding-bottom: 10px;}

.catelog{border:1px solid #ddd; border-top: none;}
.catelog a, .catelog a:hover, .catelog a:visited, .catelog a:link{outline: 0;text-decoration: none;}
.catelog .mc .oneLevel {font-size: 14px;height: 40px;line-height: 40px;overflow: hidden;background: #ffffff;}
