...
<style>
    /*购物车结算 2-19*/
    .shopping_total { width:953px; height:72px; z-index:10;  padding:0 20px; background:#fafafa; position:relative;    border: 1px solid #e6e6e6; border-left: 0;border-right: 0; }
    .shopping_total .shopping_total_left { float:left; line-height:72px; width:400px; position:relative;}
    ...
    .shopping_total .shopping_total_right { float:right; margin:18px 0 0; width:450px; position:relative;}
    ...
    .my_order2{ border: 0; width: 100%; float: none;}
    .shopping_cart_box1 table,.shopping_cart_box2 table{ width: 993px;}
    .shopping_cart_box1{ margin-top: 0;border:0; border-bottom:1px solid #E6E6E6; height: 40px; line-height: 40px; }
    .s_checkbox{margin-top: 15px;margin-right: 10px; margin-left: 10px;}
    .shopping_cart_box1 td{font-size: 14px; font-weight: bold; color: #555;}
    .shopping_cart_box2 table td{ padding-left: 19px;}
    .shopping_cart_box2{ border: 0; margin-top: 0;}
    .shopping_cart_main{ margin-top: 0;}
...
<div id="container" class="f-cb">
    ...
    <div class="member_content f-cb">
        <div class="breadcrumbs">
            <span>您当前的位置：</span><strong><a href="${base}/member/index.html">会员中心</a> > <a href="${base}${base}/cart/list.html?cartType=menu">订单中心</a></strong><span>&nbsp;&gt;&nbsp;我的购物车<span></span></span>
        </div><!--breadcrumb end-->
        ...
        <div class="member_right">
            ...
            <div id="container">
                <div class="shopping_cart_main">
                    ...
                    <div id="show" <#if cartItemList?? && cartItemList?size &gt; 0><#else>style="display:none;"</#if>>
                        <div class="shopping_cart_box1">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" >
                                <tr>
                                    <td width="90"><input type="checkbox" id="allcheck" class="s_checkbox">全选</td>
                            ...
                            <form id="cartListForm" action="${base}/member/ordercheck" method="POST">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" >
                                    <#list cartItemList as map>
                                        <tr class="shopping_shopnames" id="shop_tr_${map.shopId}">
                                            ...
                                            <td colspan="6"><a style="font-size: 14px;font-weight: bold;line-height: 40px;">陕西帮商乐信息技术有限公司</a></td>
                                        </tr>
                    ...
                    <div style="position: fixed; bottom: 0; z-index: 101; width: 100%;">
                        <div class="shopping_total" id="shopping_total">
                            <div class="shopping_total_right">
                                <a class="total_btn fn-checkout" href="javascript:;" id="checkout_btn" onclick="judgeAuth('${base}','goOrder',goToOrder.bind({}));" dd_name="结算">结&nbsp;&nbsp;算</a>
                                <div class="subtotal">
                            ...
                            <div class="shopping_total_left" id="J_leftBar">
                                ...
                                全选
                                <a id="j_removeproducts" href="javascript:void(0)" onclick="judgeAuth('${base}','addCarts',deleteChecked.bind({}));" class="fn-batch-remove" dd_name="批量删除按钮">批量删除</a> <span>已选择<font color="red" id="selectedCount">0</font>件商品</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.status=='success'){
                            //刷新本页面
                            location.replace("${base}/cart/list?cartType=menu");
                        }else{
                            clickAllow = "true";
                        }
                    }
    ...
    function change(cartItemid){
        ...
        if($("#"+cartItemid).val()>9999) {
            $("#"+cartItemid).attr("style", "width:40px;")
        }
        //包装系数
