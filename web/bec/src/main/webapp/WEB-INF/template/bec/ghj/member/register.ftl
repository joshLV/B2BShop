                ...
                <#--接收采购商所在地区的 ID PATH  以及默认给采购商一个采购商类型值-->
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                            ...
                            <td align="left">
                                <input type="text" name="openingBank" id="openingBank" value="" class="inp_text"  ignore="ignore"   datatype="*5-50" nullmsg="请填写开户行(银行及支行名称)" errormsg="请输入5-50位字符"/>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="text" name="bankNumber" id="bankNumber" value="" class="inp_text" ignore="ignore" datatype="n10-30" nullmsg="请填写帐号" errormsg="请输入10-30位数字" />
                                <span id="picError4" class="error"></span>
                            </td>
                        </tr>
                      <tr>
