...
<style>
    ...
    .star{
        width: 68px;
        height: 12px;background: url(${base}/static/bec/project/ghj/img/goods.jpg) no-repeat;
        float: left;
        margin-top: 8px;
        margin-left: 5px;
    }
    .my_order2{ border: 0;width: 993px;}
     .star .bar{background: url(${base}/static/bec/project/ghj/img/goods.jpg) no-repeat;background-position: 0px -13px; display:inline-block;height: 12px;}
