...
<head>
    ...
    <link href="${base}/static/bec/project/gdnz/css/price_details.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/gdnz/css/header.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/gdnz/css/footer.css" rel="stylesheet" type="text/css" media="all"/>
    <script src="${base}/static/bec/project/gdnz/js/laydate.js"></script>
