...
<style>
    ...
    .r_menu ul{ height:250px; margin-bottom:10px; right:0px; position:relative; z-index:10; overflow:hidden; background:url(${base}/static/bec/project/xd/images/bg_0.8.png) repeat;
    ...
    .r_menu ul .up i{ background:url(${base}/static/bec/project/xd/images/icons.png) -63px -150px no-repeat;}
    .r_menu ul .qq i{ background:url(${base}/static/bec/project/xd/images/icons.png) -63px -20px  no-repeat;}
    .r_menu ul .tel i{ background:url(${base}/static/bec/project/xd/images/icons.png) -63px -108px  no-repeat;}
    .r_menu ul .wx i{ background:url(${base}/static/bec/project/xd/images/icons.png) -59px -66px  no-repeat;}
    .r_menu ul .down i{ background:url(${base}/static/bec/project/xd/images/icons.png) -63px -190px  no-repeat;}
    .r_menu .sliBox{ top:50px; right:-150px; width:150px; height:150px;border-radius:10px; background:url(${base}/static/bec/project/xd/images/bg_0.5.png) repeat;
    ...
    .r_menu .close{ cursor:pointer; opacity:0.8; width:26px; height:26px; display:block; margin-left:15px; transition:transform 0.5s; background:url(${base}/static/bec/project/xd/images/icons.png) 0px -640px no-repeat;}
...
<div class="foot_menu" id="footer">
    <div class="gray_box">
        ...
        <p>陕ICP备15014495号</p>
        <ul class="foot_rz">
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p32.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p33.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p34.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p35.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p36.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p37.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p38.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/xd/images/temp/p39.png"></a></li>
        </ul>
    </div>
</div>
...
<!--foot_info-->
<div class="foot_info">
    <p>Copyright (C) 2015-2016&nbsp;&nbsp;喜都云商城&nbsp;&nbsp;版权所有 </p>
</div>
<script type="text/javascript">
    <#if (isindex)>var isindex=true;<#else>var isindex=false;</#if>
</script>
<!--商品分类所用js（allSort.js）-->
<script type="text/javascript" src="${base}/static/bec/project/xd/js/allSort.js"></script>

<script type="text/javascript" src="${base}/static/bec/project/xd/js/rightMenu.js"></script>
...
<div class="r_menu">
    ...
    <div class="sliBox qqBox" style="right: -150px;">
        <p><a href="http://wpa.qq.com/msgrd?v=3&uin=1273793937&site=qq&menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:1273793937:4" alt="客服QQ" align="absmiddle" /><em>客服一</em></a></p>
    ...
    <div class="sliBox telBox" style="right: -150px;">
        <span>咨询热线<br><em>029-84411134</em>
		<br><em>185 8820 6866</em>
		</span>
    </div>
    <div class="sliBox wxBox" style="right: -150px;">
        <p>
            <img src="${base}/static/bec/project/xd/images/weixin_app.png">
            喜都云商城手机客户端
        </p>
    <#--   <p> <img src="${base}/static/bec/project/xd/images/weixin1.png">
           关注喜都云商城官方微信
       </p>-->
    </div>
    <span class="close" style="background:url(${base}/static/bec/project/xd/images/icons.png) 0px -640px no-repeat;"></span>
</div>
