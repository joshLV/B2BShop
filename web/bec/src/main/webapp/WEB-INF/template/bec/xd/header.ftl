...
<head>
    ...
    <link href="${base}/static/bec/project/xd/css/style.css" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="${base}/static/bec/project/xd/js/project_base.js"></script>
    <script type="text/javascript" src="${base}/static/bec/project/xd/js/system.js"></script>
</head>
<body>
</#escape>