            ...
            <div class="step-content checkout-steps">
                ...
                <table class="review-thead">
                    ...
                    <tr>
                        ...
                        <th class="fore4">数量</th>
                        <#--20160505 dzz 隐藏库存显示-->
                        <#--<th class="fore4">库存状态</th>-->
                    </tr>
                    <tr class="row-border">
                        <td></td>
                        <td></td>
                            ...
                            <table class="order-table">
                                ...
                                <tr>
                                    ...
                                    <td class="p-promotion">
                                        <#if quotation.freightTotalCost &lt; 0>
                                            <#assign hasDF = false>
                                            ERROR
                                        <#else>
                                        ￥${quotation.freightTotalCost?string('##0.00')}
                                        </#if>
                                    </td>
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.success) {
                                    ...
                                    var html = "<li class=\"radioitem items-border\" type=\"invoiceTitle\" id=\""+data.id+"\" value=\"" + $("#title").val() + "\"><a href=\"javascript:;\" title=\"双击修改\">" + $("#title").val() + "</a><b class=\"close-color\" onclick=\"deleteInvoice('" + data.id + "','" + $("#title").val() + "');\"><b></li>";
...
//					window.location.href = "${base}/order/view/" + data.orderId + ".html";
        ...
        function submit_Order_ERROR(){
            layer.alert("运费计算出现问题，请更换收货地址或与管理员联系！",{icon:7});
        }
    </script>
</#escape>