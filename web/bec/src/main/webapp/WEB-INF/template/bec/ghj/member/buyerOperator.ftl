    ...
    <div class="pop_win aptab_center_address">
        <ul class="newaddress">
                ...
                <b>
                  <#list map?keys as key>
                    <#if key_index==0>
                        ...
                        <#--<input type="checkbox" id="checkbox-1-${key_index+1}" class="regular-checkbox" name="buyerOperator_roleValue" value="${key}" datatype="need1" nullmsg="请至少分配一个角色!">-->
                        <#--<label for="checkbox-1-${key_index+1}" style="width: auto !important;" ></label> ${map[key]} &nbsp;&nbsp;-->

                        <input type="checkbox" id="checkbox-1-${key_index+1}" class="regular-checkbox"  name="buyerOperator_roleValue" value="${key}" datatype="need1" nullmsg="请至少分配一个角色!"/>
                        <label for="checkbox-1-${key_index+1}" style="width: auto !important;">&nbsp;${map[key]} &nbsp;&nbsp;</label>

                    <#else>


                        <input type="checkbox" id="checkbox-1-${key_index+1}" class="regular-checkbox"  name="buyerOperator_roleValue" value="${key}" />
                        <label for="checkbox-1-${key_index+1}" style="width: auto !important;">&nbsp;${map[key]} &nbsp;&nbsp;</label>
            ...
            <li>
               ...
               <#-- <input id="radio-1-1"  class="regular-radio" type="radio"  value="1" name="buyerOperator_isvalid" />
               <label for="radio-1-1" style="width: auto !important;"></label>启用&nbsp;&nbsp;-->

                <input tabindex="3" type="radio" id="radio-1-1" name="buyerOperator_isvalid">
                <label for="radio-1-1" style="width: auto !important;">启用&nbsp;&nbsp;</label>

                <input id="radio-1-2"  class="regular-radio" type="radio"  value="0" name="buyerOperator_isvalid" />
                <label for="radio-1-2" style="width: auto !important;"></label>未启用&nbsp;&nbsp;
                        ...
                        <b>
                            <#list map?keys as key>
                                <#if key_index==0>
                                    ...
                                    <input type="checkbox" id="checkbox-2-${key_index+1}" class="regular-checkbox" name="buyerOperator_roleValue_edit" value="${key}" datatype="need1" nullmsg="请至少分配一个角色!">
                                    <label for="checkbox-2-${key_index+1}" style="width: auto !important;"></label> ${map[key]} &nbsp;&nbsp;

                                <#else>
                                    <input type="checkbox" id="checkbox-2-${key_index+1}" class="regular-checkbox" name="buyerOperator_roleValue_edit" value="${key}" >
                                    <label for="checkbox-2-${key_index+1}" style="width: auto !important;"></label> ${map[key]} &nbsp;&nbsp;
...
<script src="${base}/static/bec/project/ghj/js/buyer_operator/ajaxBuyerOperator.js" type="text/javascript"></script>
...
<script>
    $(document).ready(function(){
        $('.popGeneral_address .aptab_center_address .newaddress li input').iCheck({
