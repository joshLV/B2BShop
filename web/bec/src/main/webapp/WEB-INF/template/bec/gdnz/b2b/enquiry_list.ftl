...
<div id="container">
    ...
    <div class="member_content f-cb">
        ...
        <link rel="stylesheet" type="text/css" href="${base}/static/bec/project/gdnz/css/xunjia_list.css">
        <script src="${base}/static/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
        <div class="member_right" style="overflow: visible;">
            <div class="zyf_xunjia_list" style="overflow: visible;">
                <h1>我的询价单列表</h1>
                <div id="zzjs_net_1">
                    <ul class="tab0" id="tab0">
                    ...
                    <div class="xj_con">
                        <table class="go-tab-frame manage-table" width="100%" cellpadding="0" cellspacing="0">
                            <tbody>
                            <tr class="go-tab-head">
                        ...
                        <table id="buyoffer-content" class="go-tab-frame manage-table" width="100%" cellpadding="0" cellspacing="0">
                            <tbody>
                                <#if enquiryList?? && enquiryList?size &gt; 0>
                                <#list enquiryList as enquiry>
                                <tr>
                                    <td class="cell-a title"><div class="quotation-name"> <a class="offer-name" target="_blank" href="${base}/enquiry/detail/${enquiry.id}" title="${enquiry.title}">${enquiry.title}</a> </div></td>
                                    ...
                                    <td class="cell-b cell-op"><dl>
                                        ...
                                        <#if enquiry.enquiryState == '4' || enquiry.enquiryState == '3' ><!-- 判断报价单状态,在已完成或者撤销报价单时删除报价单 -->
                                            <dd><a href="${base}/enquiry/popupDel.html?id=${enquiry.id}" class="enquiryDel">删除</a></dd>
                                        <#elseif enquiry.enquiryState != '2'>
                                ...
                                <#else>
                                    <tr>
                                        <td colspan="7" style="height: 44px;line-height: 44px;vertical-align: middle;">暂无数据！</td>
                                    </tr>
                                </#if>
                            </tbody>
                        </table>
