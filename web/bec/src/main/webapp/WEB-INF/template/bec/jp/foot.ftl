...
<style>
    ...
    .r_menu ul{ height:250px; margin-bottom:10px; right:0px; position:relative; z-index:10; overflow:hidden; background:url(${base}/static/bec/project/jp/images/bg_0.8.png) repeat;
    ...
    .r_menu ul .up i{ background:url(${base}/static/bec/project/jp/images/icons.png) -63px -150px no-repeat;}
    .r_menu ul .qq i{ background:url(${base}/static/bec/project/jp/images/icons.png) -63px -20px  no-repeat;}
    .r_menu ul .tel i{ background:url(${base}/static/bec/project/jp/images/icons.png) -63px -108px  no-repeat;}
    .r_menu ul .wx i{ background:url(${base}/static/bec/project/jp/images/icons.png) -59px -66px  no-repeat;}
    .r_menu ul .down i{ background:url(${base}/static/bec/project/jp/images/icons.png) -63px -190px  no-repeat;}
    .r_menu .sliBox{ top:50px; right:-150px; width:150px; height:150px;border-radius:10px; background:url(${base}/static/bec/project/jp/images/bg_0.5.png) repeat;
    ...
    .r_menu .close{ cursor:pointer; opacity:0.8; width:26px; height:26px; display:block; margin-left:15px; transition:transform 0.5s; background:url(${base}/static/bec/project/jp/images/icons.png) 0px -640px no-repeat;}
...
<div class="foot_menu" id="footer">
    <div class="gray_box">
        ...
        <p>陕ICP备15014495号</p>
        <ul class="foot_rz">
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p32.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p33.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p34.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p35.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p36.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p37.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p38.jpg"></a></li>
            <li><a href="#" target="_blank"><img src="${base}/static/bec/project/jp/images/temp/p39.png"></a></li>
        </ul>
    </div>
</div>
...
<!--foot_info-->
<div class="foot_info">
    <p>Copyright (C) 2015-2016&nbsp;&nbsp;西安锦鹏国际酒店用品城&nbsp;&nbsp;版权所有 </p>
</div>
<script type="text/javascript">
    <#if (isindex)>var isindex=true;<#else>var isindex=false;</#if>
</script>
<!--商品分类所用js（allSort.js）-->
<script type="text/javascript" src="${base}/static/bec/project/jp/js/allSort.js"></script>

<script type="text/javascript" src="${base}/static/bec/project/jp/js/rightMenu.js"></script>
...
<div class="r_menu">
    ...
    <div class="sliBox telBox" style="right: -150px;">
        <span>咨询热线<br><em>029-89601695</em>
		<br><em>187 4030 8391</em>
		</span>
    </div>
    <div class="sliBox wxBox" style="right: -150px;">
        <p>
            <img src="${base}/static/bec/project/jp/images/weixin_app.png">
            锦鹏手机客户端
        </p>
    <#--   <p> <img src="${base}/static/bec/project/jp/images/weixin1.png">
           关注锦鹏官方微信
       </p>-->
    </div>
    <span class="close" style="background:url(${base}/static/bec/project/jp/images/icons.png) 0px -640px no-repeat;"></span>
</div>
