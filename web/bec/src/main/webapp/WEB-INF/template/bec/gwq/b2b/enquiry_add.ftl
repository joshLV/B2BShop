    ...
    <form action="${base}/enquiry/save" id="enquiryForm" >
        ...
        <div class="xj-box">
            ...
            <div class="xj-table">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <#if goods??>
                        ...
                        <tr class="xj-table-con2" id="good_col_${good_index}">
                            <td>
                                ...
                                <img class="col_del" src="${base}/static/bec/project/gwq/images/inquiry/jian_icon.jpg" onclick="removeColumn('good_col_${good_index}')" ></img>
                            </td>
                            <td>
                    ...
                    <tr class="xj-table-con2" id="good_col_0">
                        <td>
                            <span class="col_del_span">&nbsp;</span>
                            <img class="col_del" src="${base}/static/bec/project/gwq/images/inquiry/jian_icon.jpg" onclick="removeColumn('good_col_0')" ></img>
                        </td>
            ...
            <div class="xj-operate">
                <img src="${base}/static/bec/project/gwq/images/inquiry/add_icon.jpg"><span id="btn" onclick="btn()"><a href="javascript:void(0)" id="addNewColumn">添加产品</a><#-- | <a href="#">批量导入</a>--></span>
            </div>
        </div>
        <div class="xj-box">
            ...
            <#-- 添加详细收货地址   hks modify end-->
                ...
                <div class="xj-box">
                    ...
                    <div class="submit-cell">
                        <p><input type="checkbox" class="input-r-c" id="iagree-checkbox" name="iagreeTK" checked="checked" onclick="submitDisable()"><label for="iagree-checkbox"> 我已经阅读并同意</label><a href="${base}/html/gwq/enquiry_agreement.html" class="col-017" id="enquiryAgreementId">《询价单发布以及违规处理规则》</a>
                        </p>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#buyerMerchant").colorbox({iframe:true, innerWidth:700, innerHeight:500, opacity: 0.15,overlayClose:false, scrolling: false});
...
//        $("#areaSelect_div .areaSelect")[0].attr("required","required");
        ...
        $("#addNewColumn").click(function(){
            ...
            html += '<td style="vertical-align: middle;"><span class="col_del_span">&nbsp;</span><img class="col_del" src="${base}/static/bec/project/gwq/images/inquiry/jian_icon.jpg" onclick="removeColumn(\'good_col_'+colIndex+'\')"></img></td>';
            html += '<td>';
