...
<footer>
    ...
    <#--<img src="${base}/static/bec/project/ghj/img/108_40_zZOKnl.gif" width="108" height="40" alt="">
    <img src="${base}/static/bec/project/ghj/img/112_40_WvArIl.png" width="112" height="40" alt="">
    <img src="${base}/static/bec/project/ghj/img/108_40_kxwz.gif" width="108" height="40" alt="">-->
</footer>
<style>

    /*右侧导航菜单*/
    .r_menu{ position:fixed; right:0px; top:32%; height:300px; z-index: 999;}
    .r_menu ul{ height:250px; margin-bottom:10px; right:0px; position:relative; z-index:10; overflow:hidden; background:url(${base}/static/bec/project/ghj/img/bg_0.8.png) repeat;
    ...
    .r_menu ul .up i{ background:url(${base}/static/bec/project/ghj/img/icons.png) -63px -150px no-repeat;}
    .r_menu ul .qq i{ background:url(${base}/static/bec/project/ghj/img/icons.png) -63px -20px  no-repeat;}
    .r_menu ul .tel i{ background:url(${base}/static/bec/project/ghj/img/icons.png) -63px -108px  no-repeat;}
    .r_menu ul .wx i{ background:url(${base}/static/bec/project/ghj/img/icons.png) -59px -66px  no-repeat;}
    .r_menu ul .down i{ background:url(${base}/static/bec/project/ghj/img/icons.png) -63px -190px  no-repeat;}
    .r_menu .sliBox{ top:50px; right:-150px; width:150px; height:150px;border-radius:10px; background:url(${base}/static/bec/project/ghj/img/bg_0.5.png) repeat;
    ...
    .r_menu .telBox span{ padding:0px 15px; margin-top:20px; font-size:16px; color:#fff; display:block; line-height:28px;}
    .r_menu .telBox span em{ font-style: normal; font-size: 17px; font-weight: normal; color: #fff; margin-right: 0;}
    .r_menu .close{ cursor:pointer; opacity:0.8; width:26px; height:26px; display:block; margin-left:15px; transition:transform 0.5s; background:url(${base}/static/bec/project/ghj/img/icons.png) 0px -640px no-repeat;}
    .r_menu .close:hover{ opacity:1; transform:rotate(180deg);}

</style>

<script type="text/javascript" src="${base}/static/bec/project/ghj/js/rightMenu.js"></script>
...
<div class="r_menu">
    ...
    <div class="sliBox telBox" style="right: -150px;">
        <span>客服电话<br><em>157 1929 1085</em><br><em>157 1929 1093</em><br><em>029-88814937</em></span>
    </div>
    <div class="sliBox wxBox" style="right: -260px;">
        <p>
           <#-- <img src="${base}/static/bec/project/ghj/img/weixin_app.jpg">-->
            <img src="${base}/static/bec/project/ghj/img/weixin_app.jpg">
            广货街移动客户端
        </p>
        <p> <img src="${base}/static/bec/project/ghj/img/weixin1.jpg">
            关注广货街官方微信
        </p>
    </div>
    <span class="close" style="background:url(${base}/static/bec/project/ghj/img/icons.png) 0px -640px no-repeat;"></span>
</div>
