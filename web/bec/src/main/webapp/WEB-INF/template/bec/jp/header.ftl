...
<head>
    ...
    <link href="${base}/static/bec/project/jp/css/style.css" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="${base}/static/bec/project/jp/js/project_base.js"></script>
    <script type="text/javascript" src="${base}/static/bec/project/jp/js/system.js"></script>
</head>
<body>
</#escape>