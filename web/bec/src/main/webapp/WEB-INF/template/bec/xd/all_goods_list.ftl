        ...
        <div class="list_search f-cb">
            ...
            <div class="f-fl">
                <form name="" action="">
                    ...
                    <input type="button" name="" value="搜&nbsp;索" class="inp_btn" onclick="allG('${mid}',$('#mn').val(),$('#sn').val(),'vt=list');">
                </form>
            </div>
                    ...
                    <ul class="pro_sort pro_sort2">
                        <li <#if pager.orderBy=="sales" && pager.orderType=="desc">class="on"<#elseif pager.orderBy=="sales" && pager.orderType=="asc">class="on"<#else></#if>>
                            <#if pager.orderBy=="sales" && pager.orderType=="desc">
                                <a class="" href="javascript:void(0)"  onclick="allG('${mid}','','','orderBy=sales&orderType=asc&pageNumber=${pager.pageNumber}&vt=list')">销量</a>
                        ...
                        <li <#if pager.orderBy=="price" && pager.orderType=="desc">class="on" <#elseif pager.orderBy=="price" && pager.orderType=="asc">class="on" <#else></#if>>
                            <#if pager.orderBy=="price" && pager.orderType=="desc">
                                <a href="javascript:void(0)"  onclick="allG('${mid}','','','orderBy=price&orderType=asc&pageNumber=${pager.pageNumber}&vt=list')">价格</a>
                        ...
                        <li <#if pager.orderBy=="becScoreCount" && pager.orderType=="desc">class="on" <#elseif pager.orderBy=="becScoreCount" && pager.orderType=="asc">class="on" <#else></#if>>
                            <#if pager.orderBy=="becScoreCount" && pager.orderType=="desc">
                                <a class="sort_3" href="javascript:void(0)"  onclick="allG('${mid}','','','orderBy=becScoreCount&orderType=asc&pageNumber=${pager.pageNumber}&vt=list')">评论数</a>
                            <#elseif pager.orderBy=="becScoreCount" && pager.orderType=="asc">
                                <a class="sort_3 sort_3_down" href="javascript:void(0)"  onclick="allG('${mid}','','','orderBy=becScoreCount&orderType=desc&pageNumber=${pager.pageNumber}&vt=list')">评论数</a>
                            <#else>
                                <a class="sort_3" href="javascript:void(0)"  onclick="allG('${mid}','','','orderBy=becScoreCount&orderType=desc&pageNumber=${pager.pageNumber}&vt=list')">评论数</a>
                            </#if>
                        </li>
...
<script src="${base}/static/bec/project/xd/js/allGoods/ajaxGetAllGoods.js" type="text/javascript"></script>
