...
.recommend .mt{height:30px;background:#f7f7f7; border-bottom: 2px solid #0171bc;}
.recommend .mt h2{height:30px;padding-left:10px;font:normal 15px/31px \5fae\8f6f\96c5\9ed1;color:#0171bc;}
...
<style>
 /*goodsList*/
.goodsList{border: 1px solid #E8E8E8; margin-top: 10px;}
.goodsList .mt{height:30px;background:#f7f7f7;}
.goodsList .mt h2{height:30px;padding-left:10px;font:normal 15px/31px \5fae\8f6f\96c5\9ed1;color:#0171bc;}
.goodsList .mc{color: #666;height:auto;border-top:2px solid #0171bc; padding-top: 20px; padding-bottom: 10px;}
