...
<script type="text/javascript" src="${base}/static/bec/project/ghdj/js/system.js"></script>
        ...
        <div class="zc_topright">
            <div class="zc_topr">
               ...
               <#-- <p class="p-price"><span class="f-fl">会员价：<em class="hyj">￥100元</em></span><span span class="f-fr">商城价：<em>￥130元</em></span></p>-->
                <p class="p-have"> <span class="f-fl">目标金额：<em>￥${mbje}万元</em></span> <span class="f-fr">众筹价格：<em>${goods.successPrice?string(priceCurrencyFormat)}元</em></span> </p>
                ...
                <p class="p-target"> 此商品众筹必须在
                    ...
                    众筹成功只需付款<span class="f_red"> ${goods.successPrice}元 </span>/件即可得到该众筹商品，众筹失败后系统将作废您的订单并且解冻您在下单时冻结的的保证金。
                </p>
            ...
            <#if orderList?? && orderList?size &gt; 0>
                <div class="rollBox">
                            ...
                            <div id="List1">
                                <ul>
                                    <#list orderList as order>
                                        <li class="item-li">
                                            <div class="item-img">
                                                <img src="${base}/static/bec/project/ghdj/images/tx.jpg">
                                            ...
                                            <div class="item-detail">
                                                ...
                                                <p class="item-num">订购数量：<span>${order.goodsTotalQuantity}件</span></p>
                    ...
                    <script src="${base}/static/bec/project/ghdj/js/honor.js" type="text/javascript"></script>
                </div>
            <#else>
                <div class="more">
                    <span>暂时没有支持者！</span>
