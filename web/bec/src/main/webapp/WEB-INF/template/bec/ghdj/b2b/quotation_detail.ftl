...
<head>
    ...
    <link href="${base}/static/bec/project/ghdj/css/price_details.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/ghdj/css/header.css" rel="stylesheet" type="text/css" media="all"/>
    ...
    <script src="${base}/static/bec/project/ghdj/js/laydate.js"></script>
    ...
    <div class="price_box">
        ...
        <div class="price_xjf">
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>联系人：${merchant.linkMan}</td>
                    <td style="display:none">主营行业：</td>
                    <td style="display:none">采购等级</td>
                </tr>
                <tr>
                    <td>联系电话：${merchant.linkMobel}</td>
                    <td style="display:none">注册资本：</td>
