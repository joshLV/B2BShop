...
<div id="container">
    ...
    <style type="text/css">
        ...
        .list-more i{width: 18px; height: 7px; margin-top: 3px; margin-left: 3px;  background: url(${base}/static/bec/project/xd/images/search.ele.png) no-repeat; float: left;}
        .list-less{float: left; border: 1px solid #E8E8E8; padding:3px 6px 3px 10px;}
        .list-less a{display: block; float: left;}
        .list-less i{width: 18px; height: 7px; margin-top: 3px; margin-left: 3px;  background: url(${base}/static/bec/project/xd/images/search.ele.png) no-repeat 0 -34px; float: left;}
        ...
        #filter .fore1 .order .zhuanhuanPT b{
            background: rgba(0, 0, 0, 0) url("${base}/static/bec/project/xd/images/wholesale.png") no-repeat scroll 0 0;
            float: right;
            height: 11px;
            margin-left: 5px;
            margin-right: 10px;
        ...
        #filter .fore1 .order .zhuanhuan b{
            background: rgba(0, 0, 0, 0) url("${base}/static/bec/project/xd/images/pt.gif") no-repeat scroll 0 0;
