...
<head>
    ...
    <link href="${base}/static/bec/base/css/reset.css" rel="stylesheet"/>
    <link href="${base}/static/bec/base/css/function.css" rel="stylesheet"/>
    <link href="${base}/static/bec/base/css/font-awesome.css" rel="stylesheet"/>
    <link href="${base}/static/bec/project/gdnz/css/style.css" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="${base}/static/bec/project/gdnz/js/project_base.js"></script>
    <script type="text/javascript" src="${base}/static/bec/project/gdnz/js/system.js"></script>
</head>
<body>
</#escape>