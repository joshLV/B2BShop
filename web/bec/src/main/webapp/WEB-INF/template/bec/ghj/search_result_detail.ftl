                ...
                <ul class="pro_sort pro_sort2">
                    <li <#if pager.orderBy=="sales" && pager.orderType=="desc">class="on"<#elseif pager.orderBy=="sales" && pager.orderType=="asc">class="on"<#else></#if>>
                        <#if pager.orderBy=="sales" && pager.orderType=="desc">
                            <a class="arr_down" class="" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=sales&order=asc&pageNumber=${pageNumber}')">销量</a>
                        <#elseif pager.orderBy=="sales" && pager.orderType=="asc">
                            <a href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=sales&order=desc')">销量</a>
                        <#else>
                            <a class="arr_down" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=sales&order=asc')">销量</a>
                        </#if>
                    </li>
                    <li <#if pager.orderBy=="minBatchPrice" && pager.orderType=="desc">class="on" <#elseif pager.orderBy=="minBatchPrice" && pager.orderType=="asc">class="on" <#else></#if>>
                        <#if pager.orderBy=="minBatchPrice" && pager.orderType=="desc">
                            <a class="arr_down" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=minBatchPrice&order=asc')">价格</a>
                        <#elseif pager.orderBy=="minBatchPrice" && pager.orderType=="asc">
                            <a class="" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=minBatchPrice&order=desc')">价格</a>
                        <#else>
                            <a class="arr_down" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=minBatchPrice&order=asc')">价格</a>
                        </#if>
                    </li>
                    <li <#if pager.orderBy=="becScoreCount" && pager.orderType=="desc">class="on" <#elseif pager.orderBy=="becScoreCount" && pager.orderType=="asc">class="on" <#else></#if>>
                        <#if pager.orderBy=="becScoreCount" && pager.orderType=="desc">
                            <a class="sort_3 sort_3_down" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=becScoreCount&order=asc')">评论数</a>
                        <#elseif pager.orderBy=="becScoreCount" && pager.orderType=="asc">
                            <a class="sort_3" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=becScoreCount&order=desc')')">评论数</a>
                        <#else>
                            <a class="sort_3 sort_3_down" href="javascript:void(0)"  onclick="searchResult('${keywordASCII}','orderBy=becScoreCount&order=asc')">评论数</a>
                        </#if>
                    </li>
...
<script src="${base}/static/bec/project/ghj/js/search_result/ajaxGetGoods.js" type="text/javascript"></script>
