...
<script type="text/javascript" src="${base}/static/bec/project/gdnz/js/product.js"></script>
<script type="text/javascript">
    ...
    function makeHtml(review,objHtml){
        var html="";
        html +='<tr>';
        html +='<td class="user-label"><div class="avatar"><img src="${base}/static/bec/project/gdnz/images/product_info/header.png" width="56" height="56"></div>';
