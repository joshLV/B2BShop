                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <span id="picError1" class="error">上传文件必须小于5MB</span>
                            </td>
                        </tr>
                        <#--<tr>
                            <td align="right" >
                            ...
                            <td align="left">
                                <input type="file" name="file" id="file2" value="" class="inp_text2" ignore="ignore" datatype="img" nullmsg="请选择开户许可证文件扫描件文件！" />
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="file" name="file" id="file3" value="" class="inp_text2"  ignore="ignore" datatype="img" nullmsg="请选择税务登记证文件扫描件文件！" />
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="file" name="file" id="file4" value="" class="inp_text2"  ignore="ignore"  datatype="img" nullmsg="请选择组织机构代码证文件扫描件文件！" />
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="text" name="bankNumber" id="bankNumber" value="" class="inp_text"  datatype="n15-30" nullmsg="请填写帐号" errormsg="请输入15-30位数字" />
                                <span id="picError4" class="error"></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td><input type="submit" value="资质提交" id="submit_btn" class="inp_sub inp_sub2" />
                            </td>
                        </tr>
                    </table>
                </form>
...
<link href="${base}/static/bec/project/ghdj/css/colorbox.css" rel="stylesheet" type="text/css" media="all"/>
        ...
        $("#reg2").Validform({
            ...
            datatype:{
                "img":function(gets,obj,curform,regxp) {
                    ...
                    var dom = document.getElementById("file"+index);
                    var fileSize =  dom.files[0].size;//文件的大小，单位为字节B
                    fileSize = fileSize/(1024*1024);//转换成MB
...
/*    $("#file2").uploadPreview({ Img: "image2", Width: 0, Height: 0 })
    ...
    function onLoadImage(index){
        if(!validTagImage(index)){
            layer.alert("图片不符合规格,建议规格小于5MB",{icon:2});
