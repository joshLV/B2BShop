...
<div class="head">
    <h1><a href="${base}/index"><img src="${base}/static/bec/project/xd/images/index/logo.png" width="362" height="83"></a></h1>
    <div class="headr">
        <div class="search">
        <#--<form name="search" id="search" action="" method="">-->
            <select  name="search_type" id="search_type" style=" width:81px; padding-left:10px;height:36px; float: left; text-align:center;line-height:36px;font-size:14px;font-family:'微软雅黑','宋体';border:3px solid #0171bc; border-right:0 ; background: url('${base}/static/bec/project/xd/images/s_line.gif') right top no-repeat; ">
