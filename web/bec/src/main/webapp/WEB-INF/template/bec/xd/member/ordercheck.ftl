                    ...
                    <div id="addressListDiv" class="addressListDiv">
                        ...
                        <ul class="adr_list" id="consignee-list">
                            <#list receiverList as receiver>
                                <li class="<#if receiver.isDefault==1>address_on hover_li</#if>" id = "consignee_radio_${receiver.id}" onclick="chooseCurrAddress('${receiver.id}',event)" isDefault="<#if receiver.isDefault==1>true<#else>false</#if>">
