...
<head>
    ...
    <link href="${base}/static/bec/project/ghj/css/price_details.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${base}/static/bec/project/ghj/css/header.css" rel="stylesheet" type="text/css" media="all"/>
    ...
    <script src="${base}/static/bec/project/ghj/js/laydate.js"></script>
