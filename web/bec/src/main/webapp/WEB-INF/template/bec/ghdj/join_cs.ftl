...
<link rel="stylesheet" type="text/css" href="${base}/static/bec/project/ghdj/css/join_us.css">

<div class="join_us_banner2">
</div>
<div class="join_us">
    <div class="join_us_in">
        <div class="join_us_tit"><img src="${base}/static/bec/project/ghdj/img/join_us_tit.png"></div>
...
<div class="join_process">
    <div class="join_process_in">
        <h2>入驻流程</h2>
        <div class="join_process_img"><img src="${base}/static/bec/project/ghdj/img/rzlc_img.png"></div>
    </div>
</div>
...
<div class="join_normal">
    <div class="join_normal_in">
        ...
        <div class="join_normal_img">
            <img src="${base}/static/bec/project/ghdj/img/rzbz_img.png">
        </div>
    </div>
</div>
