        ...
        <div class="f-cb w100 mt13">
            ...
            <div class="f-fl pinpai">
                <ul class="pro_sort f-cb">
                    <li>
                        <input type="checkbox" id="zhongChouStatus1" name="zhongChouStatus" class="chec_ys" value="1"/>
                        <label for="zhongChouStatus1"></label>
                        <span class="zt">即将开始</span>

                    </li>
                    <li>
                        <input type="checkbox" id="zhongChouStatus2" name="zhongChouStatus"  class="chec_ys" value="2"  class="chec_ys" />
                        <label for="zhongChouStatus2"></label>
                        <span class="zt">众筹中</span>
                    </li>
                    <li>
                        <input type="checkbox" id="zhongChouStatus3" name="zhongChouStatus" class="chec_ys" value="3"  class="chec_ys"/>
                        <label for="zhongChouStatus3"></label>
                        <span class="zt">众筹成功</span>
                    </li>
                    <li>
                        <input type="checkbox" id="zhongChouStatus4" name="zhongChouStatus" class="chec_ys" value="4"  class="chec_ys"/>
