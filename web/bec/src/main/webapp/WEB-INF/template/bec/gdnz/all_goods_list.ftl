        ...
        <div class="f-cb">
            <div class="f-fl">
                <form name="" action="">
                    ...
                    <input class="has_reset inp_search" type="text"  name="cl" id="cl" placeholder="分类" value="${cl}">
                    <input type="button" name="" value="搜&nbsp;索" class="inp_btn" onclick="allG('${mid}',$('#mn').val(),$('#sn').val(),$('#cl').val(),$('#bc').val(),'vt=list');">
                </form>
            </div>
                ...
                <ul class="pro_sort pro_sort2">
                    ...
                    <li <#if pager.orderBy=="scoreCount" && pager.orderType=="desc">class="on" <#elseif pager.orderBy=="scoreCount" && pager.orderType=="asc">class="on" <#else></#if>>
                        <#if pager.orderBy=="scoreCount" && pager.orderType=="desc">
                            <a class="sort_3" href="javascript:void(0)"  onclick="allG('${mid}','','','','','orderBy=scoreCount&orderType=asc&pageNumber=${pager.pageNumber}&vt=list')">评论数</a>
...
<script src="${base}/static/bec/project/gdnz/js/allGoods/ajaxGetAllGoods.js" type="text/javascript"></script>
