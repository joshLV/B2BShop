...
<div class="help_l">
        ...
        <li>
            ...
            <ul>
                <#list parentList as plMenu>
                    <li>
                        <h3 class="on" ><i>&nbsp;</i>${plMenu.name}</h3>
                        <ul style="">
    ...
    <#--<ul class="help_about">-->
        <#--<li>-->
            <#--<h2>关于港务区</h2>-->
            <#--<ul class="about_yyw">-->
                <#--<li id="left_navi21"><a href="help_about.html"><i>&nbsp;</i>了解我们</a></li>-->
                <#--<li id="left_navi22"><a href="#"><i>&nbsp;</i>诚征英才</a></li>-->
                <#--<li id="left_navi23"><a href="#"><i>&nbsp;</i>广告服务</a></li>-->
                <#--<li id="left_navi24"><a href="#"><i>&nbsp;</i>法律声明</a></li>-->
                <#--<li id="left_navi25"><a href="#"><i>&nbsp;</i>新闻中心</a></li>-->
                <#--<li id="left_navi26"><a href="#"><i>&nbsp;</i>联系我们 </a></li>-->
