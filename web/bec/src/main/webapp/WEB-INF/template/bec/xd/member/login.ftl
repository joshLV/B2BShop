...
<link type="text/css" href="${base}/static/bec/project/xd/css/login.css" rel="stylesheet">
<div id="container">
...
<div id="login">
	<div class="mc">
		<div id="bg" style="width: 511px; height: 355px; position: absolute; border-right: 1px solid #E8E8E8;">
	    	<img width="511" height="355" src="${base}/static/bec/project/xd/images/member/member_login.jpg">
	    </div>
	    <div class="form">
	    	<div class="title">
	    		<strong>采购商登录</strong>
