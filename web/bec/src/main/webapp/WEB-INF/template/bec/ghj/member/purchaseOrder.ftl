...
<div id="container">
    ...
    <style>
        .help{
            background: url("${base}/static/bec/project/ghj/images/question.png") no-repeat;
            width: 20px;
            height: 20px;
            /* line-height: 20px; */
            float: left;
...
<script src="${base}/static/bec/project/ghj/js/purchase_order/ajaxPurchaseOrder.js" type="text/javascript"></script>
