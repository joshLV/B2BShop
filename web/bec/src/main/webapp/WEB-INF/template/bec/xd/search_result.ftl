                        ...
                        <div class="search_content_box">
                            ...
                            <p>
                                ...
                                <span class="company_reputation">
                                    <#--<img src="static/bec/project/xd/images/search/list_icon_strength.png">-->
                                    <#--<img src="static/bec/project/xd/images/search/list_icon_sincerity.png">-->
                                    <#--<em>10年</em>-->
                                </span>
                            </p>
            ...
            <div class="clearfix">
                <div class="pagin fr" style="float: left;width: 100%;">
                    <#if (pager.list?size > 0)>
                        ...
                        <@p.pager pager = pager baseUrl = "/search/s/${keywordASCII}?order=${order}" />
                    <#else>
