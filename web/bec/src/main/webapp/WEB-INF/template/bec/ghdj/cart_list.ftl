        ...
        <div class="shopping_cart_box1">
            ...
            <table border="0" cellpadding="0" cellspacing="0" >
                <tr>
                    ...
                    <td width="90">金额</td>
                    <td width="140" style="text-align: center;">数量</td>
                    <#--<td width="105">库存</td>-->
                    <td width="100">操作</td>
                </tr>
            </table>
            ...
            <form id="cartListForm" action="${base}/member/ordercheck" method="POST">
                ...
                <#list cartItemList as map>
                   <#-- <tr class="shopping_shopnames" id="shop_tr_${map.shopId}">
                    ...
                    <tr class="shopping_shopnames" id="shop_tr_${map.shopId}">
                        <td><input type="checkbox" id="shopcheck_${map.shopId}" class="shopcheck" onclick="shopAllCheck('${map.shopId}');"/></td>
                        <td colspan="6"><a>陕西帮商乐信息技术有限公司</a></td>
                    </tr>
                        ...
                        <tr class="shopping_list" id="product_${cartItem.id}">
                            ...
                            <td width="140">
                                ...
                                <input type="text" name="textfield3" id="textfield3" value="+" class="shop_add" readonly="ture" onfocus="this.blur()"
                                       onclick="javascript:add('${cartItem.id}');">
                                    共&nbsp;
                                    <span id="calcBuyCountSpan_${cartItem.id}">${cartItem.quantity/cartItem.packageModulus}</span>
                                    &nbsp;件
                            </td>
                            <!-- 20160505 dzz 注销库存显示 -->
...
//购物车结算效果
    ...
    function reduce(cartItemid) {
        ...
        calcBuyCount(cartItemid,reduceGoodsNum,defPackageModulus);
    }
...
//                    clickAllow = "true";
        ...
        calcBuyCount(cartItemid,nowGoodsNum,defPackageModulus);
    }
    ...
    function add(cartItemid) {
        ...
        calcBuyCount(cartItemid,addGoodsNum,defPackageModulus);
    }
     ...
     */
    function calcBuyCount(cartItemid,num, packageModulus) {
        var  calcResult = "";
        ...
        $("#calcBuyCountSpan_"+cartItemid).text(calcResult);
    }
</script>
</#escape>