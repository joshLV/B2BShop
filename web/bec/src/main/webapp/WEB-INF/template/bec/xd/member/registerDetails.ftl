                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <label for="protocol">我已阅读并同意
                                    <a href="${base}/html/xd/protocol.html" class="blue" id="protocol">《采购商注册协议》</a>
                                </label>
...
<link href="${base}/static/bec/project/xd/css/colorbox.css" rel="stylesheet" type="text/css" media="all"/>
