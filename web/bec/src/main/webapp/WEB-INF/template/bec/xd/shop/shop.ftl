...
<div class="content">
    <div class="breadcrumb">
        ...
        <span>&nbsp;&gt;&nbsp;<a href="${base}/comn/${articlesCategory.id}.html">${merchant.name}</a></span>
    </div><!--breadcrumb end -->
    <div class="clr"></div>
</div>
<style>
...
#left { float: left; width: 208px;padding-left: 120px;margin-bottom: 50px; }
#right { float: left; width: 760px;padding-left: 15px;}
...
* -------------------------------------------------------
*/
.slide-center {float: left;height: 180px;overflow: hidden;padding-left: 0px;}
.slide {width: 740px;height: 200px;background-color: #F5F5F5;}
...
.slide-item {overflow:hidden;position:relative;height:400px;}
...
<div class="content">
        ...
        <div id="left">
            ...
            <div class="module_common">
                ...
                <div class="wrap">
                    <form id="myform" method="post" action="${base}/shop/search">
                        <div class="wrap_child">
                            <div class="web_search">
                                <input type="hidden" id="shopId" name="shopId" value="${merchant.id}"/>
                                <input id="keyword" class="text width4" type="text" name="keyword">
            ...
            <div class="module_common">
                ...
                <div class="wrap">
                    <div class="wrap_child">
                        <ul class="submenu">
                            <li><a class="none_ico" onclick="getAllGoods();" href="#">全部商品</a></li>
                            <li>
        ...
        <div id="right">
            <div id="center" style=" height: 180px; border: 8px solid rgb(238, 238, 238) ;">
                <div class="slide-center">
                    <div class="slide" id="adslide">
                        <div class="slide-items-wrap" style="top: 0px;">
                            <ul class="slide-items" id="J-slide-items">
                            <#list adslides as slideitem>
                                <li class="slide-item">
                                    <a class="brick"
                                       href="${slideitem.url}" style="top:0px;left:0px;" target="_blank">
                                        <img
                                                alt="${slideitem.description}" title="${slideitem.description}"
                                                src="${slideitem.pic}"/>
                                    </a>
                                </li>
                            </#list>
                    ...
                    <div class="hot-region" id="hot-region">
                        <div class="hot-region-hd">
                            <ul id="hot-region-nav" class="hot-region-nav
clearfix">
                            <#list tagList as tag>
                                <li class="<#if tag_index==0>cur<#elseif
                                tag_index==3>hide</#if>">${tag["name"]}</li>
                                <!--${tag["sign"]}-->
                            </#list>
                            </ul>
                        </div>
                        ...
                        <#list tagGoodsList as tagGoodsMap>
                            <ul class="products" style="display: <#if
                            tagGoodsMap_index==0>block<#else>none</#if>;">
                                <#list tagGoodsMap["goodsList"] as goods>
                                    <li class="fore${goods_index} <#if
                                    goods_index==3>hide</#if>">
                                        <p class="pic">
                                            <a href="${base}/item/
${goods.id}.html" target="_blank"><img alt="${goods.fullName}"
                                       src="${goods.pic}"></a>
                                        </p>

                                        <p class="name"><a
                                                href="${base}/item/${goods.id}.html" target="_blank"
                                                title="${goods.fullName}">${goods.name}</a></p>

                                        <p class="price">商城价:<strong>
                                        ${goods.price?string('currency')}</strong></p>
                                    </li>
                                </#list>
                            </ul>
                        </#list>
            ...
            <div class="module_special">
                <h2 class="common_title veins2">
                    <div class="ornament1"></div>
                    <div class="ornament2"></div>
                    <span class="ico1"><span class="ico2">热卖</span></span>
                </h2>
                <div class="wrap">
                    <div class="wrap_child">
                        <div class="major">
                            <ul class="list">
                            <#list goods_best as good>
                                <li>
                                    <div class="pic"><a href="http://msj.pw/index.php?app=goods&id=29" target="_blank"><img src="${good.pic}" width="150" height="150"></a></div>
                                    <h3><a href="http://msj.pw/index.php?app=goods&id=29" target="_blank">${good.name}</a></h3>
                                    <p>￥${good.price}</p>
                                </li>
                            </#list>
                            </ul>
...
<script type="text/javascript">
    ...
    function s() {
        ...
        if (key != undefined && key != "") {
            window.location.href = "${base}/shop/s/" + key+"&shopId="+$("#shopId").val();
        }
    }

    function getAllGoods(){
        var shopId = $("#shopId").val();
        window.location.href = "${base}/shop/shopGoods/" + shopId;
    }
