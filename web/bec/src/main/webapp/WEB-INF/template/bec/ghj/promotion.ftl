...
<link rel="stylesheet" type="text/css" href="${base}/static/bec/project/ghj/css/cuxiao.css">

<script type="text/javascript" src="${base}/static/bec/project/ghj/js/jquery.fly.min.js"></script>
<!--商品分类所用js（allSort_head.js）-->
<script type="text/javascript" src="${base}/static/bec/project/ghj/js/allSort_head.js"></script>
<script type="text/javascript" src="${base}/static/bec/project/ghj/js/cuxiao.js"></script>
...
<div class="banner" id="kinMaxShow">
    <div><img alt="轮播图1" src="${base}/static/bec/project/ghj/img/cxbanner_ry.jpg" /></div>
    <div><img alt="轮播图2" src="${base}/static/bec/project/ghj/img/cxbanner_sp.jpg" /></div>
</div><#-- kinMaxShow end-->
<#--促销最顶部大图         End-->
