...
<div id="container">
    ...
    <div class="main f-cb" style="position: relative;">
        ...
        <div class="order_info">
            ...
            <#--<input type="hidden" id="order_deliveryTime" name="deliveryTime" value="${deliveryTimeList[0].introduce}">-->
                ...
                <input type="hidden" name="zcgoodsId" id="zcgoodsId" value="${zcgoods.id}"/>
            </form>
            ...
            <div class="step-content checkout-steps">
                            ...
                            <div class="order-review">
                                <!--商品清单展示-->
                                    ...
                                    <span id="span-skulist">
                                        <table class="review-thead">
                                            <tbody>
                                            <tr>
                                                <th class="fore1">众筹项目</th>
                                                <th class="fore2">购买数量</th>
                                                <th class="fore2">众筹价</th>
                                                <th class="fore3">起订数量</th>
                                                <th class="fore4">购买最大数量</th>
                                            </tr>
                                            <tr class="row-border">
                                                <td></td>
                                                <td></td>
                                        ...
                                        <div class="review-body">
                                            ...
                                            <#assign hasDF = true>
                                                <div class="sj-name">
                                                   <#-- <label for="shopcheck"><a href="${base}/shop/${zcgoods.shopUrlAddress}.html">商家：${zcgoods.shopName}</a></label>-->
                                                        ...
                                                        <table class="order-table">
                                                            <tbody>
                                                                <tr bgcolor="#fafeff" style=" padding-top:15px;">
                                                                    <td class="fore1" style=" padding-bottom: 15px; width: 60%;">
                                                                        <div class="p-goods">
                                                                            <div class="p-img">
                                                                                <#if zcgoods.id??>
                                                                                    <a href="${base}/zcgoods/detail/${zcgoods.id}.html?whichclient=whichpc" target="_blank">
                                                                                        <img height="50" width="50" alt="" src="${zcgoods.pic}">
                                                                                    </a>
                                                                                <#else>
                                                                                    ${zcgoods.name}
                                                                                </#if>
                                                                    ...
                                                                    <td class="p-sp" style="width: 10%;">
                                                                        <div class="quantity-wrapper customize-qua">
                                                                            <input type="tel" pattern="[0-9]*" id="dealNum" class="spinnerExample" value="<#if dealNum??> ${dealNum} <#else> ${zcgoods.buyMinNum} </#if>"/>
                                                                        </div>
                                                                    </td>
                                                                    <td class="p-sp" style="width: 10%;">
                                                                        ${zcgoods.successPrice?string(priceCurrencyFormat)}
                                                                    </td>
                                                                    <td class="p-price" style="width: 10%;">
                                                                        ${zcgoods.buyMinNum}
                                                                        <#if zcgoods.unit?exists>
                                                                            ${zcgoods.unit}
                                                                        <#else>
                                                                            件
                                                                        </#if>
                                                                ...
                                                                <tr>
                                                                    <td class="sj-ps" colspan="6" ><font style=" margin-left: 15px;vertical-align:20px; color:#999; ">给卖家留言：</font>
                                                                        <textarea id="ps_${zcgoods.id}" name="ps_${zcgoods.id}" style="width: 1000px;height: 30px; padding:5px 0 0 5px; border:1px solid #e6e6e6;resize: none;margin-top: 10px; color: #999;" maxlength="100" placeholder="选填：对本次交易的说明（建议填写已经和卖家达成一致的说明）"></textarea>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="fore1">
                                                                    ...
                                                                    <span id="allFee2">
                                                                        <#if dealNum??>
                                                                            ${(goodsTotal)?string(priceCurrencyFormat)}
                                                                        <#else>
                                                                            ${(minGoodsTotal)?string(priceCurrencyFormat)}
                                                                        </#if>
                                                                    </span>
                                                                </td>
                                                                <td style="text-align: right;width: 150px;">
                                                                    运费：
                                                                    <span id="deliveryFee2">
                                                                        <#if deliveryFee &lt; 0 >
                                                                            <#assign hasDF = false>
                                                                            ERROR
                                                                        <#else>
                                                                            ${deliveryFee?string(priceCurrencyFormat)}
                                                                        </#if>
                                                                    </span>
                                                                </td>
                                                               <#-- <td>
                                                                    ...
                                                                    <em id="prepaymentFee">
                                                                        <#if dealNum??>
                                                                            ${(goodsTotal * zcgoods.prepaymentRatio / 100)?string(priceCurrencyFormat)}
                                                                        <#else>
                                                                            ${(minGoodsTotal * zcgoods.prepaymentRatio / 100)?string(priceCurrencyFormat)}
                                                                        </#if>
                                                                    </em>
                                                                </td>-->
                                                            </tr>
                                ...
                                <div class="order-summary">
                                    <div class="statistic f-fr">
                                        <div class="list">
                                            <span>
                                                <em id="z-skuNum" style="width: 50px;">
                                                    <#if dealNum??> ${dealNum} <#else> ${zcgoods.buyMinNum} </#if>
                                                </em>
                                                件商品，总商品金额：
                                            </span>
                                            <em class="price" id="allFee"
                                                    v="v="<#if dealNum??>
                                                                ${(goodsTotal)?string(priceCurrencyFormat)}
                                                            <#else>
                                                                ${(minGoodsTotal)?string(priceCurrencyFormat)}
                                        ...
                                        <div class="list" id="showFreightPrice" style="padding-left:140px;">
                                            ...
                                            <em class="price" id="deliveryFee">${deliveryFee?string(priceCurrencyFormat)}</em>
                                        </div>
                                        <#--<div class="list" id="showFee">
                                            <span>保证金：</span>
                                            <em class="price" id="prepaymentFee">
                                                <#if dealNum??>
                                                    ${(goodsTotal * zcgoods.prepaymentRatio / 100)?string(priceCurrencyFormat)}
                                                <#else>
                                                    ${(minGoodsTotal * zcgoods.prepaymentRatio / 100)?string(priceCurrencyFormat)}
                                        ...
                                        <#if hasInsuranceFee == 'yes'>
                                            <div class="list" id="showInsuranceFee">
                                                <span>保价费：</span>
                                                <em class="price" id="insuranceFee_span">${insuranceFee?string('currency')}</em>
                                            </div>
                                        </#if>
                                        <div class="list">
                                            <span>应付总额：</span>
                                            <em id="payAll" class="price">
                                                <#if dealNum??>
                                                    ${(goodsTotal  + deliveryFee + insuranceFee)?string(priceCurrencyFormat)}
                                                <#else>
                                                    ${(minGoodsTotal + deliveryFee + insuranceFee)?string(priceCurrencyFormat)}
                                                </#if>
                                            </em>
                                        </div>
                                    </div>
                ...
                <div id="checkout-floatbar" class="checkout-buttons group">
                    <div class="sticky-wrap">
                        <div class="inner">
                            <#if hasDF>
                                <button type="button" class="checkout-submit" id="order-submit" onclick="submit_Order();">提交订单<b></b></button>
                            <#else>
                                <button type="button" class="checkout-submit" id="order-submit" onclick="submit_Order_ERROR();">提交订单<b></b></button>
                            </#if>
                            <span class="total">应付总额：
                                <strong id="payAll2">
                                    <#if dealNum??>
                                        <#--${(dealNum * zcgoods.successPrice  + deliveryFee + insuranceFee)?string(priceCurrencyFormat)}-->
                                        ${(goodsTotal  + deliveryFee + insuranceFee)?string(priceCurrencyFormat)}
                                    <#else>
                                        <#--${(zcgoods.buyMinNum * zcgoods.successPrice  + deliveryFee + insuranceFee)?string(priceCurrencyFormat)}-->
                                        ${(minGoodsTotal  + deliveryFee + insuranceFee)?string(priceCurrencyFormat)}
                                    </#if>
                                </strong>
                                元
    ...
    <div style="display:none;">
        <form action="${base}/zcorder/reloadZCOrderCheck/${zcgoods.id}.html?whichclient=whichpc" method="post" id="reloadForm">
    ...
    <script src="${base}/static/bec/project/ghdj/js/zcordercheck/zcOrder_new.js" type="text/javascript"></script>
    <script src="${base}/static/mall/js/base.js" type="text/javascript"></script>
    <script src="${base}/static/app/ghj/js/jquery.spinner.js"></script>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            recalculate = function(){
                ...
                jQuery('#deliveryFee2').html('¥'+fmoney(deliveryFee, 2));
                if( 1 == ${zcgoods.prepaymentType}){
                    ...
                    jQuery('#allFee2').html('¥'+fmoney(allFee, 2));
                    jQuery('#payAll').html('¥'+fmoney(payAll, 2));
                    jQuery('#payAll2').html('¥'+fmoney(payAll, 2));
                    jQuery('#prepaymentFee').html('¥'+fmoney(prepaymentFee, 2));
                    jQuery('#z-skuNum').html(jQuery('.spinnerExample').val());
            ...
            var sp = jQuery('.spinnerExample').spinner({
                ...
                max: <#if zcgoods.buyMaxNum &gt; sysl>${sysl}<#else>${zcgoods.buyMaxNum}</#if>,
                value:<#if dealNum??> ${dealNum} <#else> ${zcgoods.buyMinNum} </#if>
            ...
            submit_Order = function(){
                setTimeout( function(){
                    ...
                    var syslCalc = 0; //剩余数量
                    if(${zcgoods.buyMaxNum}>${sysl}) {
                        syslCalc = ${sysl}
                    } else {
                        syslCalc = ${zcgoods.buyMaxNum}
                    }
                    ...
                    if(dealNum.length==0){
                        ...
                        layer.alert("数量不能小于${zcgoods.buyMinNum}件!");
                        return;
                    }else if(dealNum > syslCalc){
                        layer.alert("数量不能大于${sysl}件!");
                        return;
                    }

                    //验证用户已购数量
                    var maxNum = #{zcgoods.buyMaxNum}; //允许购买最大数量,为0时为不限制
                    var hadBuyNum = ${zhongChouSumQuantity}; //当前用户已购买众筹
                    var beBuyNum = parseInt(dealNum) + parseInt(hadBuyNum); //用户即将购买总数
                    if(parseInt(maxNum)!=0) {
                        if(parseInt(beBuyNum)>parseInt(maxNum)) {
                            var acceptNum = parseInt(maxNum) - parseInt(hadBuyNum);
                            $("#dealNum").val(acceptNum);
                            layer.alert('亲, 您还可以购买 '+ acceptNum +'<#if zcgoods.unit?exists>${zcgoods.unit}<#else>件</#if> 商品！',{icon: 5});
                            return;
                        }
                    }

                    jQuery("#orderDealNum").val(dealNum);
                    var remark = document.getElementById("ps_${zcgoods.id}").value;
                    jQuery.ajax({
                        type: "post",
                        url: "${base}/zcorder/submit?zcgoodsId=${zcgoods.id}&orderDealNum="+dealNum+"&remark="+remark+"&whichclient=whichpc",
                        data:jQuery("#orderCheckInfo").formSerialize(),
                        dataType: "json",
                        success: function (data) {
                            if (data.status == "success") {
                                window.location.href="${base}/order/view/" + data.orderId + ".html?goodsId=${zcgoods.id}&goodsType=1&whichclient=whichpc";
                                ...
                                var layer_confrim = layer.open({
                                    ...
                                    yes: function(){
                                        ...
                                        window.location.href= '${base}/account/recharge?whichclient=whichpc';
                                    },
                                    no: function(){
                                    }
                                });
        ...
        function calcBuyZcGoods() {
            ...
            if(parseInt(maxNum)!=0) {
                if(parseInt(beBuyNum)>parseInt(maxNum)) {
                    ...
                    dealNum = acceptNum;
                    $("#dealNum").val(acceptNum);
                    jQuery('#z-skuNum').html(acceptNum);
                    var allFee = acceptNum * parseFloat(${zcgoods.successPrice});
                    jQuery('#allFee').html('¥'+fmoney(allFee, 2));
                    jQuery('#allFee2').html('¥'+fmoney(allFee, 2));
                    var prepaymentFee = acceptNum * parseFloat(${zcgoods.successPrice}) * parseInt(${zcgoods.prepaymentRatio}) / 100;
                    jQuery('#prepaymentFee').html('¥'+fmoney(prepaymentFee, 2));
                    layer.alert('亲, 您还可以购买 '+ acceptNum +'<#if zcgoods.unit?exists>${zcgoods.unit}<#else>件</#if> 商品！',{icon: 5});
                    //return;
                }
            ...
            $.ajax({
                type: "post",
                url: "${base}/zcorder/ajax/calcBuyZcGoods?zcgoodsId=${zcgoods.id}&dealNum="+dealNum+"&whichclient=whichpc",
                data:jQuery("#orderCheckInfo").formSerialize(),
                dataType: "json",
                success: function (data) {
                    $('#deliveryFee').html('¥'+fmoney(data.deliveryFee, 2));//运费
                    $('#deliveryFee2').html('¥'+fmoney(data.deliveryFee, 2));
                    $('#payAll').html('¥'+fmoney(data.zcgoodsTotal, 2));
                    $('#payAll2').html('¥'+fmoney(data.zcgoodsTotal, 2));
                    $("#insuranceFee_span").html('¥'+fmoney(data.insuranceFee, 2));
                },
                error : function(error) {
...
//            $("#tips_"+index).show();
    ...
    <script type="text/javascript">
        ...
        function submit_Order_ERROR(){
            layer.alert("您当前的配送地址不符合微货通的配送范围，请您与管理员联系！",{icon:7});
        }
    </script>
</#escape>