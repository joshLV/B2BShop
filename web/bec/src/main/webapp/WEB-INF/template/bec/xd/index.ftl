                    ...
                    <#list adslides as slideitem>
                        <div class="homeBook-body20 cWhite" style="z-index: -1;">
                            <a id="3503" href="${slideitem.url}" target="_blank">
                                <img alt="${slideitem.description}" title="${slideitem.description}" src="${slideitem.pic}@730w_375h.png"/>
                            </a>
                        </div>
                    </#list>
                </div>
        ...
        <div class="pro_show floor_${child_index+1}">
            <div class="pro_show_l">
                ...
                <ul>
                    ...
                    <#list child["brandchildList"] as brandchild>
                        ...
                        <li><a href="javascript:void(0)"  onclick="s('${brandchild.name}','')" ><img src="${brandchild.pic}@88w_49h.png" alt="${brandchild.name}" width="88" height="49"></a></li>
                    </#list>
                </ul>
            </div>
            <div class="pro_show_r">
                <div class="pro_show_r_top">
                    <ul>
                            <#list child["goodschildListNoSec"] as goodschild>
                            <#if (goodschild_index>2)><#break></#if>
                            <li <#if (goodschild_index==2)>class="lase"</#if>><a target="_blank" href="${base}/item/${goodschild.id}.html" title="${goodschild.fullName}"><img alt="${goodschild.fullName}"  src="${goodschild.pic}@150w_150h.png"></a> <a target="_blank" href="${base}/item/${goodschild.id}.html" title="${goodschild.fullName}" class="pro_info">${goodschild.name}</a>
                                <p>
                    ...
                    <div class="focus_img">
                        <div id="kinMaxShow${child_index+1}">
                            ...
                            <#list child["floor_right_${child_index+1}"] as frImg>
                             <div><a href="${frImg.link}" target="_blank"><img alt="${frImg.name}" src="${frImg.pic}@330w_234h.png" width="330" height="234"></a></div>
                            </#list>
                            </#if>
                        </div>
                    </div>
                ...
                <div class="pro_show_r_down">
                    <ul>
                        <#list child["goodschildListNoSec"] as goodschild>
                            ...
                            <li <#if (goodschild_index==7)>class="lase"</#if>> <a target="_blank" href="${base}/item/${goodschild.id}.html" title="${goodschild.fullName}"><img alt="${goodschild.fullName}"  src="${goodschild.pic}@150w_150h.png"></a> <a target="_blank" href="${base}/item/${goodschild.id}.html" title="${goodschild.fullName}" class="pro_info">${goodschild.name}</a>
                                <p>
                                    <span class="nologin_price">仅会员可见！</span>
                                    <span class="login_price" style="display: none;">
                                        <#if goodschild.batchPrice != null && goodschild.batchPrice != "0.00~0.00">
