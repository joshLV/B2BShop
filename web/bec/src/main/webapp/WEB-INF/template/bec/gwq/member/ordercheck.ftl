    ...
    <div class="main f-cb" style="position: relative;">
        ...
        <div class="order_info">
            ...
            <form id="orderCheckInfo">
                ...
                <input type="hidden" id="order_deliveryMethodId" name="deliveryMethodId" value="${deliveryMethodList[0].id}">
                                    ...
                                    <div>
                                        <ul class="items">
                                            ...
                                            <#list memberInvoicesList as invoice>
                                                <li class="radioitem invoiceTitel <#if invoice.invoiceTitle==memberInvoice.invoiceTitle>items-border</#if>" type="invoiceTitle" id="${invoice.id}" value="${invoice.invoiceTitle}">
            ...
            <h1>商品清单<a href="${base}/cart/list" style="float: right;padding-right: 20px;font-size: 12px;">返回修改购物车</a></h1>
                                    ...
                                    <table class="order-table">
                                        ...
                                        <tr bgcolor="#fafeff" style=" padding-top:15px;">
                                            <td class="fore1" style=" padding-bottom: 15px;"><div class="p-goods">
                                                <div class="p-img">
                                                    <#if cartItem.goodsId??>
                                                        <a href="${base}/item/${cartItem.goodsId}.html" target="_blank"><img height="50" width="50" alt="" src="${cartItem.pic}@50w_50h.png"></a>
                                                    <#else>
                                                    ${cartItem.goodsName}
                                                    </#if>
                                                </div>
                        ...
                        <div style="text-align: right;">
                            <table class="order-table">
                                ...
                                <tr>
                                    ...
                                    <td class="fore2 p-inventory"  style="text-align: right;width: 115px;padding-right: 20px;" >${map.shopTotal?string('currency')}</td>-->
                                </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <div class="order-summary">
                                    <div class="statistic f-fr">
                                        ...
                                        <div class="list"> <span>应付总额：</span><em id="sumPayPriceId" class="price"> ${(totalPrice + deliveryFee - discount)?string('currency')}</em> </div>
                                    </div>
                ...
                <div id="checkout-floatbar" class="checkout-buttons group">
                    <div class="sticky-wrap">
                        <div class="inner">
                            ...
                            <span class="total">应付总额：<strong id="payPriceId">${(totalPrice + deliveryFee - discount)?string('currency')}</strong>元 </span> </div>
                    </div>
                </div>
            </div>
        </div>
