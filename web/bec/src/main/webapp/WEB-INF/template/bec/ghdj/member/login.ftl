...
<link type="text/css" href="${base}/static/bec/project/ghdj/css/login.css" rel="stylesheet">
<div id="container">
...
<div id="login">
	<div class="mc">
		<div id="bg" style="width: 511px; height: 355px; position: absolute; border-right: 1px solid #E8E8E8;">
	    	<img width="511" height="355" src="${base}/static/bec/project/ghdj/images/member/member_login.jpg">
	    </div>
	    <div class="form">
	    	<div class="title">
	    		<strong>采购商登录</strong>
	    	...
	    	<div class="items" style="z-index: 10;">
	            ...
	            <div class="item-ifo">
	            	...
	            	<input type="text" id="userName" name="userName" tabindex="1" class="text has_reset" autocomplete="off">
	        ...
	        <div class="items" style="z-index: 8;">
                <span>密码</span>
                <div class="item-ifo">
                    <input type="password" id="password" name="password" class="text has_reset" tabindex="2" autocomplete="off" sta="0">
