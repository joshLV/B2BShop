    ...
    <div class="headr">
        <div class="search">
            <#--<form name="search" id="search" action="" method="">-->
                <select class="fl" name="search_type" id="search_type" style="display:none;width:85px;height:35px;line-height:35px;font-size:14px;font-family:'微软雅黑','宋体';border:3px solid #0171bc;">
