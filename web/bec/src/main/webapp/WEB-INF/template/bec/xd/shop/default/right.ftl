...
<style>
 ...
 .recommend .mc .item .pic {overflow: hidden;position: relative;height:208px;background: rgba(0, 0, 0, 0) url("${base}/static/bec/project/xd/images/default_logo.jpg") no-repeat scroll 50% 50%;}
...
.cart_btn_img{
     width: 18px;
     height: 18px;
     background: url(${base}/static/bec/project/xd/images/search.ele.png) no-repeat 0 -273px;
 }
</style>
...
<style>
 ...
 .goodsList .mc .item .pic {overflow: hidden;position: relative;height:208px;background: rgba(0, 0, 0, 0) url("${base}/static/bec/project/xd/images/default_logo.jpg") no-repeat scroll 50% 50%; }
