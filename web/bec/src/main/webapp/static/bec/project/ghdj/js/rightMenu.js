...
$(function(){
	...
	rClose.click(function(){
		if(rBox.css("right")=="0px"){
			...
			rClose.css("background","url("+base+"/static/bec/project/ghj/img/icons.png) -32px -640px no-repeat")
		}else{
			rBox.stop().animate({right:"0px"});
			rClose.css("background","url("+base+"/static/bec/project/ghj/img/icons.png) 0px -640px no-repeat")
		}
