...
function sendCitiesAjax() {
	$.ajax({
		type: "get",
		url: 'static/bec/project/ghj/js/menu_js/queryAllCities.js',
		async: false,
		dataType: "json",
...
function sendAllProvinceAjax() {
	$.ajax({
		type: "get",
		url: 'static/bec/project/ghj/js/menu_js/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() {
	$.ajax({
		type: "get",
		url: 'static/bec/project/ghj/js/menu_js/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 {
	$.ajax({
		type: "get",
		url: "static/bec/project/ghj/js/menu_js/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
