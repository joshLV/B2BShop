...
(function($) {
    $.fn.jqueryzoom = function(options) {
        ...
        $(this).hover(function() {
                ...
                $("div.zoomdiv").width(450);
                $("div.zoomdiv").height(450);
                $("div.zoomdiv").show();
                if (!settings.lens) {
                ...
                $(document.body).mousemove(function(e) {
                    ...
                    if (isNaN(scalex) | isNaN(scaley)) {
                        ...
                        $("div.jqZoomPup").width(170);
                        $("div.jqZoomPup").height(170);
                        if (settings.lens) {
...
(function($) {
    $.fn.jdMarquee = function(option, callback) {
        ...
        if (s.deriction == "up" || s.deriction == "down") {
            ...
            var step = s.step * subObject.eq(0).outerHeight(true);
            object.css({
                width: s.width + "px",
                overflow: "hidden"
            });
        ...
        if (s.deriction == "left" || s.deriction == "right") {
            var width = subObject.length * subObject.eq(0).outerWidth(true);
            object.css({
                width: width + "px",
                overflow: "hidden"
            });
