 ...
 * 表代码：sys_bec_log
*/
@Alias(net.deepdragon.constant.weipu.Weipu.SIGN+"BecLog")
public class BecLog extends BaseEntity {

	private static final long serialVersionUID = 1729805747302603577L;
