...
public class StringUtil {
	...
	private static Pattern tableNamePattern = Pattern.compile("[^a-zA-z0-9_]*");
	...
	public static List<String> sortAndJudgeTableName(List<String> list){
	 ...
	 * @return
	 */
	public static String formatExcelData(Object s){
		return (s + "").replaceAll("'", "").replaceAll("\\n","").trim();
	}

	public static void main(String[] args) {
		/*try {
			String s = new String("田彧".getBytes(),"utf-8");
			System.out.println(s+ ":" +getEncoding(s)  );
			
			s = new String("田彧".getBytes(),"ISO-8859-1");
			System.out.println(s+ ":" +getEncoding(s)  );
			
			s = new String("田彧".getBytes(),"GB2312");
			System.out.println(s+ ":" +getEncoding(s)  );
		...
		System.out.println(numberHalfAdjust(3.30 * 0.95,2));
...
//		System.out.println("encode---->"+str);
	...
	public static Map<String, Object> beanToMap(Object obj) {
		...
		try {
			...
			for (int i = 0; i < descriptors.length; i++) {
				...
				if (!"class".equals(name) && isNotEmpty(propertyUtilsBean.getNestedProperty(obj, name))) {
	 ...
	 * @param decimalLength  小数位位数
	 * @return
	 */
	public static Double numberHalfAdjust(Double number, int decimalLength) {
		/*BigDecimal bg = new BigDecimal(number);
		double f1 = bg.setScale(decimalLength, BigDecimal.ROUND_HALF_UP).doubleValue();*/
		NumberFormat nf = NumberFormat.getNumberInstance();
		nf.setMaximumFractionDigits(decimalLength);
		nf.setGroupingUsed(false);
		double f1 = Double.parseDouble(nf.format(number));
