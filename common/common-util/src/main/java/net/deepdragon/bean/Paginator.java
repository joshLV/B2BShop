...
public class Paginator implements java.io.Serializable {
	...
	private static final long serialVersionUID = 5809383729352069613L;
	...
	public boolean isDisabledPage(int page) {
		return ((page < 1) || (page > getTotalPages()) || (page == this.pageNumber));
	}
	...
	public Integer[] slider(int slidersCount) {
		return generateLinkPageNumbers(getPageNumber(), (int) getTotalPages(),
				slidersCount);
	}
