...
public class HTTPRequest {
	...
	private final HashMap<String, List<String>> queryParams = new HashMap<String, List<String>>();
	
	private final HashMap<String, String> pathParams = new HashMap<String, String>();
